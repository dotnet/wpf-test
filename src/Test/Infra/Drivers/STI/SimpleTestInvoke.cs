...
namespace Microsoft.Test
{
    ...
    public sealed class SimpleTestInvoke
    {
        ...
        //private static void ExecuteTestCasesInAppDomain()
        //{
        //    StiDriverParameters driverParameters = new StiDriverParameters(DriverState.DriverParameters);
        //    CrossAppDomainDelegate crossAppDomainDelegate = new CrossAppDomainDelegate(ExecuteTestCase);
        //    // Every test is being run in the same AppDomain, which means
        //    // the same security level. It is ExecutionEngine's responsibility
        //    // to partiton the set of tests to have the same requested security level.
        //    AppDomain appDomain = StiUtilities.CreateAppDomain(driverParameters.SecurityLevel);
