...
namespace Microsoft.Test.Execution.StateManagement
{
    ...
    //      derived types. If this were to be resolved, we could use specialized types directly
                ...
                if (stateImplementation == null)
                {
                    ...
                    switch (type)
                    {
                        ...
                        case StateModuleType.DefaultWebBrowser:
                            throw new NotSupportedException("XBAPs are not supported on .NET Core.");
                        ...
                        default:
                            ...
                            // this allows infra to run without ----ing up, without having to change all deployments
