...
namespace DRT
{
    public class StrokeErasePerfTest : InkCanvasPerfTestBase
    {
        #region Constructor

        public StrokeErasePerfTest()
            : base("StrokeErasePerfTest")
        {
        }
