...
{
    public partial class OpenFileDialogWindowTest : Page
    {
        ...
        private void OnLoadedShowOpenFileDlg(object sender, RoutedEventArgs e)
        {
            ...
            GlobalLog.LogEvidence("Displaying OpenFileDialog with ShowDialog(Window win)");
            _ofd.ShowDialog(Application.Current.MainWindow); 
        }
