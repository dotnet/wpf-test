...
namespace WindowTest
{
    /// <summary>
    /// 
    /// Test for setting ResizeMode.CanResizeWithGrip property in code
    ///
    /// </summary>
    public partial class ResizeMode_CanResizeWithGrip_Code
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
        void OnContentRendered(object sender, EventArgs e)
        {
            // Expected Value
            ResizeMode expectedValue = ResizeMode.CanResizeWithGrip;
            ...
            // Set expectedValue to ResizeMode.CanMinimize
            expectedValue = ResizeMode.CanMinimize;
            Logger.Status("Expected ResizeMode = " + expectedValue.ToString());
