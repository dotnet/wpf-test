...
namespace WindowTest
{
    /// <summary>
    /// 
    /// Test for SizeToContent.Width in markup
    ///
    /// </summary>
    public partial class SizeToContent_Width_Markup
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
        ...
        void OnContentRendered(object sender, EventArgs e)
        {
            ...
            SizeToContent expectedSTC = SizeToContent.Width;
            double expectedWindowWidth=btn.Width+borderLength*2;
            double expectedWindowHeight=this.Height;
