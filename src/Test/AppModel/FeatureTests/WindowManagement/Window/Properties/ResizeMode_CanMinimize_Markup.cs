...
namespace WindowTest
{
    /// <summary>
    /// 
    /// Test for setting ResizeMode.CanMinimize property in markup
    ///
    /// </summary>
    public partial class ResizeMode_CanMinimize_Markup
    {                                                                                                                                                                                                                                                                                                                                                                                                                 
        void OnContentRendered(object sender, EventArgs e)
        {
            // Expected Value
            ResizeMode expectedValue = ResizeMode.CanMinimize;
