...
namespace WindowTest
{
    /// <summary>
    /// 
    /// Test for SizeToContent.Height in code
    ///
    /// </summary>
    public partial class SizeToContent_Height_Code
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
        ...
        void OnContentRendered(object sender, EventArgs e)
        {
            ...
            expectedWindowWidth = this.Width;
            expectedWindowHeight = btn.Height + captionHeight + borderLength;           
