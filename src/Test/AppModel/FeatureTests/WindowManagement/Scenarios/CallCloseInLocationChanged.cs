...
namespace WindowTest
{
    ...
    /// <summary>
    /// Test for calling Window.Close() method in LocationChanged Event
    /// </summary>
    public partial class CallCloseInLocationChanged
    {        
        ...
        {
            Logger.Status("[OnLocationChanged] Calling Close()");
            this.Close();
        }
