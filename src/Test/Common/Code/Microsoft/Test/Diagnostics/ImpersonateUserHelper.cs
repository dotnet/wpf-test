    ...
    public class ImpersonateUserHelper
    {
        ...
        private class ImpersonateUser : IDisposable
        {
            ...
            void IDisposable.Dispose()
            {
                ...
                // Unload the user profile which was loaded earlier.
                // Skiping UnloadUserProfile step since we skipped LoadUserProfile
                //bool isProfileUnloaded = UnloadUserProfile(userTokenHandle, profileInfo.hProfile);
                //if (!isProfileUnloaded)
                //{
                //    int errorCode = Marshal.GetLastWin32Error();
                //    eventLogContent += "UnloadUserProfile returned false. ErrorCode: [" +
                //        errorCode + "]" + Environment.NewLine;
                //}  
