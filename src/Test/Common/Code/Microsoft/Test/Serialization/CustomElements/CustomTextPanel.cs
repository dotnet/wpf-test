...
/******************************************************************* 
 * Purpose: Implements custom Avalon type CustomTextPanel, which 
 *          derives from FlowDocumentScrollViewer and implements ICustomElement so
 *          it may be displayed in round-trip serialization testing.
 *
********************************************************************/
using System;
