...
namespace Microsoft.Test.Serialization
{
    ...
    internal static class WrapperUtil
    {
        ...
        internal static Assembly FindAssemblyInDomain(string assemblyName)
        {
            ...
            //{
            //    AssemblySW assembly = assemblies[i];
            //    if (String.Compare(assembly.FullName, assemblyName, false, CultureInfo.GetCultureInfo(DOTNETCULTURE)) == 0 ||
            //        String.Compare(assembly.GetName().Name, assemblyName, false, CultureInfo.GetCultureInfo(DOTNETCULTURE)) == 0)
            //    {
            //        returnAssembly = assembly.InnerObject;
            //        break;
            //    }
            //}
