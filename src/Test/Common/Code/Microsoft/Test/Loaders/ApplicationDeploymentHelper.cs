...
namespace Microsoft.Test.Loaders 
{
    ...
    {        
        ...
        {
            //TODO: Need to rethink whether this should be an explicit list of processes or implicitly assume any new processes
        ...
        /// <summary>
        /// Resets the state of the ClickOnce App store.
        /// </summary>
