...
namespace Microsoft.Test.Win32
{
    ...
    public static class NativeMethods
    {
        ...
        public static bool SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter,
                int x, int y, int cx, int cy, int flags)
        {
            bool result = IntSetWindowPos(hWnd, hWndInsertAfter, x, y, cx, cy, flags);

            // sleep a short time, to dissuade the OS from coalescing window-position
            // message.  Tests expect immediate reaction.
