...
namespace Microsoft.Test.CompilerServices.Projects
{
    public class ProjectGenerator
    {
        ...
        private BuildItemGroup currentBuildItemGroup;
        private BuildPropertyGroup currentBuildPropertyGroup;
        ...
        private void CreateProject()
        {
            ...
            {
                //In 4.0, it's no longer necessary to set msBuildEngine.BinPath to msBuildDirectory, removed the code.

                currentProject = msBuildEngine.CreateNewProject();
            }
        }
        ...
        private void CreateBuildPropertyGroup(string condition)
        {
            ...
            currentBuildPropertyGroup = currentProject.AddNewPropertyGroup(false);

            if (String.IsNullOrEmpty(condition) == false)
            {
                currentBuildPropertyGroup.Condition = condition;
            }
        ...
        private void CreateBuildItemGroup(string condition)
        {
            ...
            currentBuildItemGroup = currentProject.AddNewItemGroup();

            if (String.IsNullOrEmpty(condition) == false)
            {
                currentBuildItemGroup.Condition = condition;
            }
        }
        ...
        private void AddProperty(string propertyName, string propertyValue, string condition)
        {
            ...
            BuildProperty prop = currentBuildPropertyGroup.AddNewProperty(propertyName, propertyValue);
        ...
        {
            currentBuildPropertyGroup.RemoveProperty(propertyName);
        }
        ...
        private void AddItem(string itemType, string includeValue, string exclude, string condition, string name, string hintpath, string fileStorage, string copyToOutputDirectory)
        {
            ...
            BuildItem item = null;
            item = currentBuildItemGroup.AddNewItem(itemType, includeValue);
        ...
        private void AddReference(string includeValue, string name, string hintpath, string condition, bool privatereference)
        {
            ...
            if (privatereference)
            {
                currentBuildItem.SetMetadata("Private", "True");
            }
            else
            {
                currentBuildItem.SetMetadata("Private", "False");
            }
        }
        ...
        private void AddImport(string includeValue)
        {
            ...
            currentProject.AddNewImport(includeValue, null);
        }
        ...
        private void GenerateAppManifest()
        {
            ...
            if (!FileSW.Exists(appManifest))
            {
                WriteStringToFile(PathSW.Combine(localPath, appManifest), appManifestString);
            }
        }        
