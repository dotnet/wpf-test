...
/***********************************************************
*
*   Program:   Tests for DoubleCollectionConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        DoubleCollectionConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        private void            TestCanConvertTo()
        {
            ...
            TestCanConvertToWith( typeof( double ), false );
            TestCanConvertToWith( typeof( Int32Collection ), false );
        ...
        private void            TestCanConvertFrom()
        {
            ...
            TestCanConvertFromWith( typeof( double ), false );
            TestCanConvertFromWith( typeof( Int32Collection ), false );
        ...
        private void            TestConvertTo()
        {
            ...
            TestConvertToWith( Const2D.doubleCollection, typeof( double ), true );
            TestConvertToWith( Const2D.intCollection, typeof( double ), true );
            TestConvertToWith( null, typeof( double ), true );
        }
        ...
        private void            TestConvertToWith( object value, Type destinationType, bool shouldThrow )
        {
            ...
            try
            {
                ...
                //  individual DoubleCollection tests.
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( "-0.1"+_sep+"0"+_sep+"1.1", false );
            TestConvertFromWith( null, true );
            TestConvertFromWith( Const2D.intCollection, true );
        ...
        private void            TestConvertFromWith( object value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by DoubleCollection.Parse( string )
        ...
        private DoubleCollectionConverter _converter;
    }
}