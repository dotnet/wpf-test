...
/***********************************************************
*
*   Program:   Tests for PointCollectionValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        PointCollectionValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new PointCollectionValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const2D.pCollection2, true );
            TestCanConvertToStringWith( "0,0 1,1 2,2", false );
            TestCanConvertToStringWith( Const2D.p0, false );
            TestCanConvertToStringWith( Const2D.vCollection, false );
            TestCanConvertToStringWith( Const.pCollection, false );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const2D.pCollection2, false );
            TestConvertToStringWith( "0,0 1,1 2,2", true );
            TestConvertToStringWith( Const2D.p0, true );
            TestConvertToStringWith( Const2D.vCollection, true );
            TestConvertToStringWith( Const.pCollection, true );
        ...
        private void            TestCanConvertFromString()
        {
            ...
            TestCanConvertFromStringWith( "0,0 1,1 -2,-2", true );
            TestCanConvertFromStringWith( "-1.078e15,Infinity -Infinity,NaN", true );
        ...
        private void            TestConvertFromString()
        {
            ...
            TestConvertFromStringWith( "0,0 1,1 -2,-2", false );
            TestConvertFromStringWith( "-1.078e15,Infinity -Infinity,NaN", false );
        ...
        private PointCollectionValueSerializer _serializer;
    }
}
