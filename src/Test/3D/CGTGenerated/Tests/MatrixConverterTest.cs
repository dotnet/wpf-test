...
/***********************************************************
*
*   Program:   Tests for MatrixConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        MatrixConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        private void            TestCanConvertTo()
        {
            ...
            TestCanConvertToWith( typeof( Rect ), false );
        ...
        private void            TestCanConvertFrom()
        {
            ...
            TestCanConvertFromWith( typeof( Rect ), false );
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( "-2.1"+_sep+"-0.1"+_sep+"0"+_sep+"0.1"+_sep+"1.1"+_sep+"2.2", false );
            TestConvertFromWith( "Identity", false );
            TestConvertFromWith( "0"+_sep+"0"+_sep+"0"+_sep+"0"+_sep+"0", true );
            TestConvertFromWith( "0"+_sep+"0"+_sep+"0"+_sep+"0"+_sep+"0"+_sep+"0"+_sep+"0", true );
            TestConvertFromWith( null, true );
            TestConvertFromWith( Const2D.rect1, true );
        ...
        private MatrixConverter _converter;
    }
}
