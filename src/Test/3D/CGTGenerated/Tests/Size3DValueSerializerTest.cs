...
/***********************************************************
*
*   Program:   Tests for Size3DValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Size3DValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new Size3DValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const.s0, true );
            TestCanConvertToStringWith( Const.sInf, true );
            TestCanConvertToStringWith( Size3D.Empty, true );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const.s0, false );
            TestConvertToStringWith( Const.sInf, false );
            TestConvertToStringWith( Size3D.Empty, false );
        ...
        private void            TestCanConvertFromString()
        {
            ...
            TestCanConvertFromStringWith( "1.078e15,Infinity,1.078e-15", true );
        ...
        private void            TestConvertFromString()
        {
            ...
            TestConvertFromStringWith( "1.078e15,Infinity,1.078e-15", false );
        ...
        private Size3DValueSerializer _serializer;
    }
}
