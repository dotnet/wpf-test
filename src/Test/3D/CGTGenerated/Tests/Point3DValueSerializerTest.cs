...
/***********************************************************
*
*   Program:   Tests for Point3DValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Point3DValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new Point3DValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const.p0, true );
            TestCanConvertToStringWith( Const.p10, true );
            TestCanConvertToStringWith( Const.pInf, true );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const.p0, false );
            TestConvertToStringWith( Const.p10, false );
            TestConvertToStringWith( Const.pInf, false );
        ...
        private void            TestConvertFromStringWith( string value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by Point3D.Parse( string )
        ...
        private Point3DValueSerializer _serializer;
    }
}
