...
/***********************************************************
*
*   Program:   Tests for VectorCollectionConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        VectorCollectionConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _converter = new VectorCollectionConverter();
        }
        ...
        private void            TestCanConvertTo()
        {
            ...
            TestCanConvertToWith( typeof( Vector ), false );
            TestCanConvertToWith( typeof( PointCollection ), false );
        ...
        private void            TestCanConvertFrom()
        {
            ...
            TestCanConvertFromWith( typeof( Vector ), false );
            TestCanConvertFromWith( typeof( PointCollection ), false );
        ...
        private void            TestConvertToWith( object value, Type destinationType, bool shouldThrow )
        {
            ...
            try
            {
                ...
                //  individual VectorCollection tests.
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( "0"+_sep+"0 1"+_sep+"-1 0.2"+_sep+"-0.2", false );
            TestConvertFromWith( "0", true );
            TestConvertFromWith( "0"+_sep+"0"+_sep+"0", true );
            TestConvertFromWith( null, true );
            TestConvertFromWith( Const2D.pCollection, true );
            TestConvertFromWith( false, true );
            TestConvertFromWith( Const2D.v0, true );
        }
        ...
        private void            TestConvertFromWith( object value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by VectorCollection.Parse( string )
        ...
        private VectorCollectionConverter _converter;
    }
}
