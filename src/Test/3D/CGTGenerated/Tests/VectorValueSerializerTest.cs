...
/***********************************************************
*
*   Program:   Tests for VectorValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        VectorValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new VectorValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const2D.v0, true );
            TestCanConvertToStringWith( Const2D.v10, true );
            TestCanConvertToStringWith( Const2D.vInf, true );
            TestCanConvertToStringWith( Const2D.vMaxMin, true );
            TestCanConvertToStringWith( Const2D.vNan, true );
            TestCanConvertToStringWith( Const2D.vEpsilon, true );
            ...
            TestCanConvertToStringWith( Const2D.vCollection, false );
            TestCanConvertToStringWith( Const.v0, false );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const2D.v0, false );
            TestConvertToStringWith( Const2D.v10, false );
            TestConvertToStringWith( Const2D.vInf, false );
            TestConvertToStringWith( Const2D.vMaxMin, false );
            TestConvertToStringWith( Const2D.vNan, false );
            TestConvertToStringWith( Const2D.vEpsilon, false );
            TestConvertToStringWith( "0,0", true );
            TestConvertToStringWith( Const2D.p0, true );
            TestConvertToStringWith( Const2D.size1, true );
            TestConvertToStringWith( Const2D.vCollection, true );
            TestConvertToStringWith( Const.v0, true );
        ...
        private void            TestConvertFromStringWith( string value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by Vector.Parse( string )
        ...
        private VectorValueSerializer _serializer;
    }
}
