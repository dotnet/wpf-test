...
/***********************************************************
*
*   Program:   Tests for Point3DCollectionConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Point3DCollectionConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _converter = new Point3DCollectionConverter();
        }
        ...
        private void            TestCanConvertTo()
        {
            ...
            TestCanConvertToWith( typeof( Vector3DCollection ), false );
        ...
        private void            TestCanConvertFrom()
        {
            ...
            TestCanConvertFromWith( typeof( Vector3DCollection ), false );
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( Const.vCollection, true );
        ...
        private Point3DCollectionConverter _converter;
    }
}
