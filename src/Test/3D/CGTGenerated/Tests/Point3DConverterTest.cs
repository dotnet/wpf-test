...
/***********************************************************
*
*   Program:   Tests for Point3DConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Point3DConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _converter = new Point3DConverter();
        }
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( "1.029e-17"+_sep+"1.38e+200"+_sep+"-1.38e+200", false );
        ...
        private Point3DConverter _converter;
    }
}
