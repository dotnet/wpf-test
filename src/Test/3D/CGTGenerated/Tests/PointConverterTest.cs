...
/***********************************************************
*
*   Program:   Tests for PointConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        PointConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        private void            TestConvertTo()
        {
            ...
            TestConvertToWith( Const2D.p0, typeof( string ), false );
            TestConvertToWith( Const2D.v0, typeof( string ), false );
            TestConvertToWith( null, typeof( string ), false );
            TestConvertToWith( Const2D.p0, typeof( InstanceDescriptor ), true );
            TestConvertToWith( Const2D.v0, typeof( InstanceDescriptor ), true );
            TestConvertToWith( null, typeof( InstanceDescriptor ), true );
            TestConvertToWith( Const2D.p0, null, true );
            TestConvertToWith( Const2D.v0, null, true );
            TestConvertToWith( null, null, true );
            TestConvertToWith( Const2D.p0, typeof( bool ), true );
            TestConvertToWith( Const2D.v0, typeof( bool ), true );
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( "0"+_sep+"0", false );
            TestConvertFromWith( "1.029e-17"+_sep+"1.38e+200", false );
        ...
        private PointConverter _converter;
    }
}
