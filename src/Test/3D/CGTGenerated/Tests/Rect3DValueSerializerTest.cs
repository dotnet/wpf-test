...
/***********************************************************
*
*   Program:   Tests for Rect3DValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Rect3DValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new Rect3DValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const.rOrigin0, true );
            TestCanConvertToStringWith( Const.rInfInf, true );
            TestCanConvertToStringWith( Rect3D.Empty, true );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const.rOrigin0, false );
            TestConvertToStringWith( Const.rInfInf, false );
            TestConvertToStringWith( Rect3D.Empty, false );
        ...
        private void            TestCanConvertFromString()
        {
            ...
            TestCanConvertFromStringWith( "0,0,0, 0,0,0", true );
            TestCanConvertFromStringWith( "-1.078e15,Infinity,-Infinity, -1.078e-15,Infinity,1000", true );
            ...
            TestCanConvertFromStringWith( "0,0,0,0,0,0,0", true );
        ...
        private void            TestConvertFromString()
        {
            ...
            TestConvertFromStringWith( "0,0,0, 0,0,0", false );
            TestConvertFromStringWith( "-1.078e15,Infinity,-Infinity, 1.078e-15,Infinity,1000", false );
            TestConvertFromStringWith( "Empty", false );
            TestConvertFromStringWith( "1 2 3 4 5 6", false );
            TestConvertFromStringWith( "0,0,0,0,0", true );
            TestConvertFromStringWith( "0,0,0,0,0,0,0", true );
            TestConvertFromStringWith( "-1.078e15,Infinity,-Infinity, 1.078e-15,Infinity,-1000", true );
        ...
        private void            TestConvertFromStringWith( string value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by Rect3D.Parse( string )
        ...
        private Rect3DValueSerializer _serializer;
    }
}
