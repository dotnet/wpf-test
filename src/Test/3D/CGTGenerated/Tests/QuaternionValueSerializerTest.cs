...
/***********************************************************
*
*   Program:   Tests for QuaternionValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        QuaternionValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new QuaternionValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const.q0, true );
            TestCanConvertToStringWith( Const.q1, true );
            TestCanConvertToStringWith( Const.qInf, true );
            TestCanConvertToStringWith( "0,0,0", false );
            TestCanConvertToStringWith( Const.p4_0, false );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const.q0, false );
            TestConvertToStringWith( Const.q1, false );
            TestConvertToStringWith( Const.qInf, false );
            TestConvertToStringWith( "0,0,0", true );
            TestConvertToStringWith( Const.p4_0, true );
        ...
        private void            TestCanConvertFromString()
        {
            ...
            TestCanConvertFromStringWith( "-1.078e15,-1.078e-15,Infinity,-Infinity", true );
        ...
        private void            TestConvertFromString()
        {
            ...
            TestConvertFromStringWith( "-1.078e15,-1.078e-15,Infinity,-Infinity", false );
        ...
        private QuaternionValueSerializer _serializer;
    }
}
