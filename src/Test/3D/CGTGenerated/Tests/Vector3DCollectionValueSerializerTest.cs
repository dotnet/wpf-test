...
/***********************************************************
*
*   Program:   Tests for Vector3DCollectionValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Vector3DCollectionValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new Vector3DCollectionValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const.vCollection, true );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const.vCollection, false );
        ...
        private Vector3DCollectionValueSerializer _serializer;
    }
}
