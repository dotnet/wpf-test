...
/***********************************************************
*
*   Program:   Tests for Rect3DConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Rect3DConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _converter = new Rect3DConverter();
        }
        ...
        private void            TestCanConvertTo()
        {
            ...
            TestCanConvertToWith( typeof( Size3D ), false );
        ...
        private void            TestCanConvertFrom()
        {
            ...
            TestCanConvertFromWith( typeof( Size3D ), false );
        ...
        private void            TestConvertTo()
        {
            ...
            TestConvertToWith( Rect3D.Empty, typeof( string ), false );
            ...
            TestConvertToWith( Rect3D.Empty, typeof( InstanceDescriptor ), true );
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( "0"+_sep+"0"+_sep+"0"+_sep+" 0"+_sep+"0"+_sep+"0", false );
            TestConvertFromWith( "1.029e-17"+_sep+"1.38e+200"+_sep+"-1.38e+200"+_sep+" 1.029e17"+_sep+"1.38e+200"+_sep+"1000", false );
        ...
        private Rect3DConverter _converter;
    }
}
