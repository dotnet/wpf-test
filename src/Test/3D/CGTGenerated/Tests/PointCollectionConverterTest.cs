...
/***********************************************************
*
*   Program:   Tests for PointCollectionConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        PointCollectionConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        private void            TestCanConvertTo()
        {
            ...
            TestCanConvertToWith( typeof( Point ), false );
            TestCanConvertToWith( typeof( VectorCollection ), false );
        ...
        private void            TestCanConvertFrom()
        {
            ...
            TestCanConvertFromWith( typeof( Point ), false );
            TestCanConvertFromWith( typeof( VectorCollection ), false );
        ...
        private void            TestConvertTo()
        {
            ...
            TestConvertToWith( Const2D.pCollection, typeof( string ), false );
            TestConvertToWith( Const2D.vCollection, typeof( string ), false );
            TestConvertToWith( null, typeof( string ), false );
            TestConvertToWith( Const2D.pCollection, null, true );
            TestConvertToWith( Const2D.vCollection, null, true );
            TestConvertToWith( null, null, true );
            TestConvertToWith( Const2D.pCollection, typeof( bool ), true );
            TestConvertToWith( Const2D.vCollection, typeof( bool ), true );
            TestConvertToWith( null, typeof( bool ), true );
            TestConvertToWith( Const2D.pCollection, typeof( InstanceDescriptor ), true );
            TestConvertToWith( Const2D.vCollection, typeof( InstanceDescriptor ), true );
            TestConvertToWith( null, typeof( InstanceDescriptor ), true );
            TestConvertToWith( Const2D.pCollection, typeof( Point ), true );
            TestConvertToWith( Const2D.vCollection, typeof( Point ), true );
            TestConvertToWith( null, typeof( Point ), true );
        }
        ...
        private void            TestConvertToWith( object value, Type destinationType, bool shouldThrow )
        {
            ...
            try
            {
                ...
                //  individual PointCollection tests.
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( "0"+_sep+"0 1"+_sep+"1 2"+_sep+"2", false );
            TestConvertFromWith( "0", true );
            TestConvertFromWith( "0"+_sep+"0"+_sep+"0", true );
            TestConvertFromWith( null, true );
            TestConvertFromWith( Const2D.vCollection, true );
        ...
        private void            TestConvertFromWith( object value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by PointCollection.Parse( string )
        ...
        private PointCollectionConverter _converter;
    }
}
