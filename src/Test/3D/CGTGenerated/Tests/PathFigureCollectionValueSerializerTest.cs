...
/***********************************************************
*
*   Program:   Tests for PathFigureCollectionValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        PathFigureCollectionValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new PathFigureCollectionValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const2D.pathFigureCollection1, true );
            TestCanConvertToStringWith( Const2D.pathFigureCollection2, true );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const2D.pathFigureCollection1, false );
            TestConvertToStringWith( Const2D.pathFigureCollection2, false );
        ...
        private void            TestConvertToStringWith( object value, bool shouldThrow )
        {
            try
            {
                ...
                //  individual PathFigureCollection tests.
        ...
        private void            TestCanConvertFromString()
        {
            ...
            TestCanConvertFromStringWith( "M0,0M100,33z", true );
        ...
        private void            TestConvertFromString()
        {
            ...
            TestConvertFromStringWith( "M0,0M100,33z", false );
        ...
        private void            TestConvertFromStringWith( string value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by PathFigureCollection.Parse( string )
        ...
        private PathFigureCollectionValueSerializer _serializer;
    }
}
