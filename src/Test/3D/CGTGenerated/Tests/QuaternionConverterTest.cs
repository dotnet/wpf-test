...
/***********************************************************
*
*   Program:   Tests for QuaternionConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        QuaternionConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _converter = new QuaternionConverter();
        }
        ...
        private void            TestCanConvertTo()
        {
            ...
            TestCanConvertToWith( typeof( Point4D ), false );
        ...
        private void            TestCanConvertFrom()
        {
            ...
            TestCanConvertFromWith( typeof( Point4D ), false );
        ...
        private void            TestConvertTo()
        {
            ...
            TestConvertToWith( Const.q0, typeof( string ), false );
            TestConvertToWith( Quaternion.Identity, typeof( string ), false );
            TestConvertToWith( Const.p4_0, typeof( string ), false );
            TestConvertToWith( null, typeof( string ), false );
            TestConvertToWith( Const.q0, typeof( InstanceDescriptor ), true );
            TestConvertToWith( Quaternion.Identity, typeof( InstanceDescriptor ), true );
            TestConvertToWith( Const.p4_0, typeof( InstanceDescriptor ), true );
            TestConvertToWith( null, typeof( InstanceDescriptor ), true );
            TestConvertToWith( Const.q0, null, true );
            TestConvertToWith( Quaternion.Identity, null, true );
            TestConvertToWith( Const.p4_0, null, true );
            TestConvertToWith( null, null, true );
            TestConvertToWith( Const.q0, typeof( bool ), true );
            TestConvertToWith( Quaternion.Identity, typeof( bool ), true );
        ...
        private void            TestConvertFrom()
        {
            ...
            TestConvertFromWith( "0"+_sep+"0"+_sep+"0"+_sep+"1", false );
            ...
            TestConvertFromWith( Const.p4_0, true );
        ...
        private void            TestConvertFromWith( object value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by Quaternion.Parse( string )
        ...
        private QuaternionConverter _converter;
    }
}
