...
/***********************************************************
*
*   Program:   Tests for Vector3DConverter (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Vector3DConverterTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _converter = new Vector3DConverter();
        }
        ...
        private Vector3DConverter _converter;
    }
}
