...
/***********************************************************
*
*   Program:   Tests for BitmapEffectCollection (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        BitmapEffectCollectionTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _collection      = NewBitmapEffectCollection();
            _list            = NewBitmapEffectCollection();
            _objects         = new List<BitmapEffect>();
            _bogusCollection = new ArrayList();

            _objects.Add( new BlurBitmapEffect() );
            _objects.Add( new BlurBitmapEffect() );
            _objects.Add( new DropShadowBitmapEffect() );
            _objects.Add( new DropShadowBitmapEffect() );
        ...
        private BitmapEffectCollection NewBitmapEffectCollection()
        {
        ...
        private BitmapEffectCollection NewBitmapEffectCollection( IEnumerable<BitmapEffect> collection )
        {
            return new BitmapEffectCollection( collection );
        }

        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

        private BitmapEffectCollection NewBitmapEffectCollection( int capacity )
        {
            return new BitmapEffectCollection( capacity );
        }
        ...
        {
            _collection = NewBitmapEffectCollection();
            foreach ( BitmapEffect obj in _objects )
            {
                _collection.Add( obj );
            }
        }
        ...
        private BitmapEffect[]  BitmapEffectArray
        {
            get
            {
                BitmapEffect[] array = new BitmapEffect[ _objects.Count ];
        ...
        private void            TestConstructor()
        {
            ...
            BitmapEffectCollection empty = NewBitmapEffectCollection();
            if ( empty.Count != 0 || failOnPurpose )
            {
                AddFailure( "BitmapEffectCollection.ctor() failed" );
                Log( "*** Expected: Default constructor creates empty collection" );
                Log( "*** Actual:   {0} objects in \"empty\" collection", empty.Count );
            }

            PopulateCollection();
            BitmapEffectCollection theirAnswer = NewBitmapEffectCollection( _collection );

            if ( theirAnswer.Count != _objects.Count || failOnPurpose )
            {
                AddFailure( "BitmapEffectCollection.ctor( IEnumerable<BitmapEffect> ) failed" );
            ...
            TestConstructorWith( new List<BitmapEffect>() );
        ...
        private void            TestConstructorWith( IEnumerable<BitmapEffect> e )
        {
            BitmapEffectCollection theirAnswer = NewBitmapEffectCollection( e );
        ...
        {
            BitmapEffectCollection theirAnswer = NewBitmapEffectCollection( capacity );

            if ( theirAnswer.Count != 0 || failOnPurpose )
            {
                AddFailure( "BitmapEffectCollection.ctor( int ) failed" );
                Log( "*** Expected: Count == 0" );
                Log( "*** Actual:   Count == {0}", theirAnswer.Count );
            }
        }
        ...
        private class           FakeEnumerable : IEnumerable<BitmapEffect>, ICollection<BitmapEffect>
        {
            public void         Add( BitmapEffect p )
            {
            }
            public void         Clear()
            {
            }
            public bool         Contains( BitmapEffect p )
            {
                return false;
            }
            public void         CopyTo( BitmapEffect[] points, int index )
            {
            }
            public bool         Remove( BitmapEffect p )
            {
                return false;
            }
            public int          Count
            ...
            public IEnumerator<BitmapEffect> GetEnumerator()
            {
            ...
            private class       Enumerator : IEnumerator<BitmapEffect>
            {
        ...
        private class           NonCollectionEnumerable : IEnumerable<BitmapEffect>
        {
            public IEnumerator<BitmapEffect> GetEnumerator()
            {
                return new Enumerator();
        ...
        {
            BitmapEffectCollection c = NewBitmapEffectCollection( null );
        }

        private void            ConstructWithNullInArray()
        {
            BitmapEffect[] array = new BitmapEffect[ _objects.Count+1 ];
            _objects.CopyTo( array );
            array[ _objects.Count ] = null;
            BitmapEffectCollection c = NewBitmapEffectCollection( array );
        }
        ...
        private void            TestAddWith( object o )
        {
            ...
            _collection.Add( (BitmapEffect)o );

            if ( oldCount+1 != _collection.Count || position != oldCount ||
                    !_collection[ position ].Equals( (BitmapEffect)o ) || failOnPurpose )
            {
                AddFailure( "BitmapEffectCollection.Add failed" );
                Log( "*** Expected: count = {0}, position = {1}, BitmapEffect added = {2}", oldCount+1, oldCount, o );
                Log( "***   Actual: count = {0}, position = {1}, BitmapEffect added = {2}", _collection.Count, position, _collection[ position ] );
            }
        }
        ...
        private void            TestAdd2()
        {
            ...
            foreach ( object o in _bogusCollection )
            {
                ...
                Type addType = typeof( BitmapEffect );
                try
                {
                    _list.Add( o );
            ...
            Log( "Testing BitmapEffectCollection.Add with bad parameters..." );
        ...
        {
            Log( "Testing BitmapEffectCollection.Changed..." );
        ...
        private void            TestChangedForConstructor()
        {
            ...
            BitmapEffectCollection temp = _collection.Clone();
            temp = NewBitmapEffectCollection( _collection );
            VerifyCallbacksProcessed();
        ...
        private void            TestContains()
        {
            ...
            Log( "Testing BitmapEffectCollection.Contains..." );
            PopulateCollection();
            ...
            foreach ( BitmapEffect obj in _objects )
            {
                ...
                {
                    AddFailure( "BitmapEffectCollection.Contains failed" );
                    Log( "Could not locate {0} in my collection", obj );
                }
            }
        ...
        private void            TestContains2()
        {
            ...
            {
                Type itemType = ( o == null ) ? null : o.GetType();
                Type listType = typeof( BitmapEffect );
        ...
        private void            TestCopyTo()
        {
            ...
            Log( "Testing BitmapEffectCollection.CopyTo..." );
            PopulateCollection();
            BitmapEffect[] typedArray = new BitmapEffect[ _objects.Count ];
            ...
            for ( int i = 0; i < _collection.Count; i++ )
            {
                ...
                {
                    AddFailure( "CopyTo( BitmapEffect[],int ) failed" );
        ...
        private void            TestCopyTo2()
        {
            ...
            Log( "Testing BitmapEffectCollection.CopyTo with bad parameters..." );
        ...
        {
            PopulateList();
            BitmapEffect[,] array = new BitmapEffect[ _objects.Count,_objects.Count ];
            _list.CopyTo( array, 0 );
        }
        ...
        {
            Log( "Testing BitmapEffectEnumerator..." );
            PopulateCollection();

            TestEnumeratorWith( NewBitmapEffectCollection() );
            TestEnumeratorWith( _collection );
        }

        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

        private void            TestEnumeratorWith( BitmapEffectCollection collection )
        {
        ...
        private void            TestMoveNextWith( IEnumerator enumerator, BitmapEffectCollection collection )
        {
            int count = 0;
            while ( enumerator.MoveNext() )
            {
                BitmapEffect current = (BitmapEffect)enumerator.Current;
        ...
        private void            TestEnumerator2()
        {
            ...
            try
            {
                foreach ( BitmapEffect o in _collection )
                {
            ...
            {
                PopulateCollection();
                enumerator = ((IEnumerable)NewBitmapEffectCollection()).GetEnumerator();
                object foo = enumerator.Current;
        ...
        private void            TestGetAsFrozen()
        {
            ...
            BitmapEffectCollection copy = _collection.Clone();
            ...
            BitmapEffectCollection frozen = (BitmapEffectCollection)copy.GetAsFrozen();
            ...
            copy.Freeze();
            frozen = (BitmapEffectCollection)copy.GetAsFrozen();
        ...
        private void            TestGetCurrentValueAsFrozen()
        {
            ...
            BitmapEffectCollection frozen = (BitmapEffectCollection)copy.GetCurrentValueAsFrozen();
            if ( object.ReferenceEquals( frozen, copy ) ||
                 !ObjectUtils.DeepEqualsToAnimatable( frozen, copy ) ||
                 failOnPurpose )
            {
            ...
            copy.Freeze();
            frozen = (BitmapEffectCollection)copy.GetCurrentValueAsFrozen();
            if ( !object.ReferenceEquals( frozen, copy ) || failOnPurpose )
            {
        ...
        private void            TestInsert()
        {
            ...
            Log( "Testing BitmapEffectCollection.Insert..." );
            PopulateCollection();
        ...
        private void            TestInsert2()
        {
            ...
            Log( "Testing BitmapEffectCollection.Insert with bad parameters..." );
            PopulateCollection();
        ...
        private void            TestItem()
        {
            ...
            Log( "Testing BitmapEffectCollection.get/set_Item..." );
            PopulateCollection();

            _collection[ 0 ] = _objects[ 3 ];
            if ( !_collection[ 0 ].Equals( _objects[ 3 ] ) || failOnPurpose )
            {
                AddFailure( "BitmapEffectCollection.get/set_Item failed" );
                Log( "*** Expected: item[0] = {0}", _objects[ 3 ] );
        ...
        private void            TestItem2()
        {
            ...
            Log( "Testing BitmapEffectCollection.get/set_Item with bad parameters..." );
            PopulateCollection();
        ...
        {
            BitmapEffect item = _collection[ -1 ];
        }

        private void            CollectionGetItemIndexTooLarge()
        {
            BitmapEffect item = _collection[ _objects.Count ];
        }

        private void            CollectionSetItemNegativeIndex()
        {
            _collection[ -1 ] = (BitmapEffect)_objects[ 0 ];
        }

        private void            CollectionSetItemIndexTooLarge()
        {
            _collection[ _objects.Count ] = (BitmapEffect)_objects[ 0 ];
        }


        private void            CollectionSetItemNull()
        {
            _collection[ 0 ] = (BitmapEffect)null;
        }
        ...
        private void            TestRemove()
        {
            ...
            Log( "Testing BitmapEffectCollection.Remove..." );
            PopulateCollection();
        ...
        private void            TestRemove2()
        {
            ...
            Log( "Testing BitmapEffectCollection.Remove with bad parameters..." );
        ...
        {
            PopulateCollection();
            _collection.Remove( (BitmapEffect)_objects[ 0 ] );
            _collection.Remove( (BitmapEffect)_objects[ 0 ] );
        }
        ...
        private void            RemoveFromEmptyCollection()
        {
            ...
            {
                AddFailure( "BitmapEffectCollection.Remove failed with empty collection" );
        ...
        {
            Log( "Testing BitmapEffectCollection.RemoveAt with bad parameters..." );
        ...
        private BitmapEffectCollection _collection;
        private IList _list;
        private List<BitmapEffect> _objects;
