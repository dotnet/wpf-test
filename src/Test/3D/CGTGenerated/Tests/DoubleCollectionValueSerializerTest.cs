...
/***********************************************************
*
*   Program:   Tests for DoubleCollectionValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        DoubleCollectionValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new DoubleCollectionValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const2D.doubleCollection, true );
            TestCanConvertToStringWith( "1,2,3,4,5,6", false );
            TestCanConvertToStringWith( 5, false );
            TestCanConvertToStringWith( Const2D.intCollection, false );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const2D.doubleCollection, false );
            TestConvertToStringWith( "1,2,3,4,5,6", true );
            TestConvertToStringWith( 5, true );
            TestConvertToStringWith( Const2D.intCollection, true );
        ...
        private DoubleCollectionValueSerializer _serializer;
    }
}