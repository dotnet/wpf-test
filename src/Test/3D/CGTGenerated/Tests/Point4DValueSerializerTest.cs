...
/***********************************************************
*
*   Program:   Tests for Point4DValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Point4DValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new Point4DValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const.p4_0, true );
            TestCanConvertToStringWith( Const.p4_10, true );
            TestCanConvertToStringWith( Const.p4_Inf, true );
            TestCanConvertToStringWith( "0,0,0", false );
            TestCanConvertToStringWith( Const.q1, false );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const.p4_0, false );
            TestConvertToStringWith( Const.p4_10, false );
            TestConvertToStringWith( Const.p4_Inf, false );
            TestConvertToStringWith( "0,0,0", true );
            TestConvertToStringWith( Const.q1, true );
        ...
        private Point4DValueSerializer _serializer;
    }
}
