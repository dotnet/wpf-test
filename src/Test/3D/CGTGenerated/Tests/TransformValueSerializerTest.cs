...
/***********************************************************
*
*   Program:   Tests for TransformValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        TransformValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new TransformValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const2D.identityTransform, true );
            TestCanConvertToStringWith( Const2D.matrixTransform10 , true );
            TestCanConvertToStringWith( Const2D.translate10, false );
            TestCanConvertToStringWith( Const2D.rotate10, false );
            TestCanConvertToStringWith( Const2D.scale10, false );
            TestCanConvertToStringWith( Const2D.skew10, false );
            TestCanConvertToStringWith( "1,2,3,4,5,6", false );
            TestCanConvertToStringWith( Const2D.matrix0, false );
            TestCanConvertToStringWith( Const.tt1, false );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const2D.identityTransform, false );
            TestConvertToStringWith( Const2D.matrixTransform10 , false );
            TestConvertToStringWith( "1,2,3,4,5,6", true );
            TestConvertToStringWith( Const2D.matrix0, true );
            TestConvertToStringWith( Const2D.translate10 , true );
            TestConvertToStringWith( Const2D.rotate10, true );
            TestConvertToStringWith( Const2D.scale10, true );
            TestConvertToStringWith( Const2D.skew10, true );
            TestConvertToStringWith( Const.tt1, true );
        ...
        private void            TestConvertFromStringWith( string value, bool shouldThrow )
        {
            ...
            catch ( Exception ex )
            {
                ...
                // Invalid operation exception is thrown by Transform.Parse( string )
        ...
        private TransformValueSerializer _serializer;
    }
}
