...
/***********************************************************
*
*   Program:   Tests for Int32CollectionValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        Int32CollectionValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new Int32CollectionValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const2D.intCollection, true );
            TestCanConvertToStringWith( "1", false );
            TestCanConvertToStringWith( 5, false );
            TestCanConvertToStringWith( Const2D.doubleCollection, false );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const2D.intCollection, false );
            TestConvertToStringWith( "1", true );
            TestConvertToStringWith( 5, true );
            TestConvertToStringWith( Const2D.doubleCollection, true );
        ...
        private void            TestCanConvertFromString()
        {
            ...
            TestCanConvertFromStringWith( "4 34, -5 10,-90", true );
        ...
        private void            TestConvertFromString()
        {
            ...
            TestConvertFromStringWith( "4 34, -5 10,-90", false );
        ...
        private Int32CollectionValueSerializer _serializer;
    }
}
