...
/***********************************************************
*
*   Program:   Tests for VectorCollectionValueSerializer (generated)
*
...
namespace                       Microsoft.Test.Graphics.Generated
{
    ...
    public partial class        VectorCollectionValueSerializerTest : CoreGraphicsTest
    {
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        public override void    Init( Variation v )
        {
            ...
            _serializer = new VectorCollectionValueSerializer();
        }
        ...
        private void            TestCanConvertToString()
        {
            ...
            TestCanConvertToStringWith( Const2D.vCollection2, true );
        ...
        private void            TestConvertToString()
        {
            ...
            TestConvertToStringWith( Const2D.vCollection2, false );
        ...
        private VectorCollectionValueSerializer _serializer;
    }
}
