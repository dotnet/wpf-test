...
sampler SampleTextureFromInterpolatorUV2_Sampler;
...
struct TransformVertexStageUV_VS2_VS_ConstData
{
    float4x2 mat3x2TextureTransform;
};
...
struct VertexShaderConstantData
{
    ...
    TransformVertexStageUV_VS2_VS_ConstData TransformVertexStageUV_VS2_ConstantTable;
...
void
TransformVertexStageUV_VS2(
    TransformVertexStageUV_VS2_VS_ConstData data,
    inout VS_STAGE_DATA vsStageData
    )
{
    float2 inputUV = vsStageData.UV;
...
void
MoveVertexStageUVToInterpolator_VS2(
    VS_STAGE_DATA vsStageData,
    inout float2 uv
    )
{
    ...
    )
{
    ...
    TransformVertexStageUV_VS2(
        Data_VS.TransformVertexStageUV_VS2_ConstantTable,
        vsStageData
        );
...
void
SampleTextureFromInterpolatorUV_PS2(
    sampler TextureSampler,
    float2 uv,
    inout PS_STAGE_DATA psStageData
    )
    ...
    ) : SV_Target
{
    ...
    SampleTextureFromInterpolatorUV_PS2(
        SampleTextureFromInterpolatorUV2_Sampler,
        UV_1,
        psStageData        );
