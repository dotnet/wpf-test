...
struct Ambient_Lighting_VS2_VS_ConstData
{
    float4 Color;
};
...
struct VertexShaderConstantData
{
    ...
    Ambient_Lighting_VS2_VS_ConstData Ambient_Lighting_VS2_ConstantTable;
};
...
void
Ambient_Lighting_VS2(
    Ambient_Lighting_VS2_VS_ConstData Data,
    ...
    )
{
    ...
    Ambient_Lighting_VS2(
        Data_VS.Ambient_Lighting_VS2_ConstantTable,
        Output
        );
