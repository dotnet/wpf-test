...
namespace Test.Uis.TestTypes
{
    ...
    public abstract class CustomModelTestCase : CustomTestCase
    {
        ...
        ///// <param name="parameters"></param>
        ///// <param name="result"></param>
        //public delegate void CallCompletedHandler(ModelAction action, ModelParameters parameters, object result);

        //private void AfterCallHandler(ModelAction action, ModelParameters parameters, object result)
        //{
        //    //make sure that the Avalon queue is at idle state.
            
        //    QueueHelper.Current.QueueDelegate(new CallCompletedHandler(DoVerification), new object[] { action, parameters, result });
        //}
    }
}
