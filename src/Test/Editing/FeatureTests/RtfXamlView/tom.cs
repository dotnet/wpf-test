...
namespace RtfXamlView
{
    ...
    internal interface ITextRange
    {
        ...
        int Delete(TomUnit unit, int count);
        ...
        void Placeholder_GetEmbeddedObject();
    }
    ...
    internal interface ITextSelection : ITextRange
    {
        ...
        new int Delete(TomUnit unit, int count);
        ...
        new void Placeholder_GetEmbeddedObject();
        #endregion ITextRange
    ...
    internal interface ITextFont
    {
        ...
        //The high word is either zero or it contains the high word 
        //of the locale identifier (LCID).
    ...
    internal interface ITextPara
    {
        ...
        TomBool KeepTogether { get; set; }
        //[propget]GetKeepWithNext([retval][out]long *pValue)
        TomBool KeepWithNext { get; }
    ...
    internal enum TomLineSpacing : int
    {
