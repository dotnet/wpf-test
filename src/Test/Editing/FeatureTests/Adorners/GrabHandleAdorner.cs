...
namespace Test.Uis.TextEditing
{
    ...
    public class GrabHandleAdorner : Adorner
    {
        ...
        public GrabHandleAdorner(UIElement element)
            : base(element)
        {
        ...
        public GrabHandleAdorner(UIElement element, GrabHandleAnchor anchor, GrabHandles grabHandles)
            : base(element)
        {
            _children = new VisualCollection(this);             
            _anchor = anchor;
        ...
        public GrabHandleAdorner(UIElement element, GrabHandleAnchor anchor, GrabHandles grabHandles, Size size, Pen pen, Brush brush)
            : base(element)
        {
            _children = new VisualCollection(this);             
            if (pen == null)
        ...
        //private Rect _adornerBounds = new Rect();
