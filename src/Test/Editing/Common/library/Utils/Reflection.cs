...
namespace Test.Uis.Utils
{
    ...
    public static class ReflectionUtils
    {
        ...
        {
            return ActivatorSW.CreateInstance(type);
        }
        ...
        public static string[] DescribeProperties(object o)
        {
            ...
            {
                TypeSW type = TypeSW.Wrap(o.GetType());
                PropertyInfoSW[] props = type.GetProperties(
        ...
        public static Type FindType(string typeName)
        {
            ...
            if (typeName.IndexOf(',') != -1)
                return TypeSW.GetType(typeName, true).InnerObject;
        ...
        public static Type[] SafeGetTypes(Assembly assembly)
        {
            ...
            try
            {
                TypeSW[] typesSW = assemblySW.GetTypes();
                testTypes = new Type[typesSW.Length];
                for (int i = 0; i < typesSW.Length; i++)
                {
                    testTypes[i] = typesSW[i].InnerObject;
                }
            }
            ...
            catch(Exception exception)
            {
                Logger.Current.Log(
                    ...
                    assemblySW.FullName, Environment.NewLine,
                    exception.ToString());
            }
            return testTypes;
        }
