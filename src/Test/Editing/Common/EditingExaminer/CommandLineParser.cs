...
/*******************************************************************************
 *
 * Description: commandLineParser.cs implement the immediate window with the following
 * features:
 *      1. Parse the command line 
 *      2. support scripting Syntax
 *          assignment =
 *          Function invoking  foo()
 *          Creating new object. new myobject()
 *      3. Use the basic C# syntax
 * 
 *******************************************************************************/
