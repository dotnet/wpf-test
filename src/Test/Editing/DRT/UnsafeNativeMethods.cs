...
*/
        ...
        [DllImport("user32.dll", ExactSpelling=true, EntryPoint="mouse_event", CharSet=CharSet.Auto)]
...
/*
        ...
        [DllImport(ExternDll.User32, CharSet=CharSet.Auto)]
        public static extern bool GetClassInfo(HandleRef hInst, string lpszClass, [In, Out] MS.Win32.NativeMethods.WNDCLASS wc);
        [DllImport(ExternDll.User32, CharSet=CharSet.Auto)]
        ...
        [DllImport(ExternDll.User32, CharSet=CharSet.Auto)]
        public static extern bool GetClassInfoEx(HandleRef hInst, string lpszClass, [In, Out] NativeMethods.WNDCLASSEX_I wc);
...
*/       
        ...
        public static extern IntPtr SetWindowLong(IntPtr hWnd, int nIndex, NativeMethods.WndProc dwNewLong);
...
/*
        ...
        private static extern IntPtr IntCreateIC(String lpszDriverName, String lpszDeviceName, String lpszOutput, int lpInitData);
        public static IntPtr CreateIC(String lpszDriverName, String lpszDeviceName, String lpszOutput, int lpInitData) {
        ...
        // Return an int, rather than a bool as in the docs, because -1 can be returned.
        [DllImport(ExternDll.User32, ExactSpelling=true, CharSet=CharSet.Ansi)]
        public static extern int GetMessageA([In, Out] ref NativeMethods.MSG msg, HandleRef hWnd, int uMsgFilterMin, int uMsgFilterMax);
        [DllImport(ExternDll.User32, ExactSpelling=true, CharSet=CharSet.Unicode)]
        public static extern int GetMessageW([In, Out] ref NativeMethods.MSG msg, HandleRef hWnd, int uMsgFilterMin, int uMsgFilterMax);
        [DllImport(ExternDll.User32, CharSet=CharSet.Auto)]
        ...
        [DllImport(ExternDll.User32, CharSet=CharSet.Auto, SetLastError=true)]
        public static extern IntPtr RegisterClassEx(NativeMethods.WNDCLASSEX_D wc_d);
        [DllImport(ExternDll.User32, ExactSpelling=true, CharSet=CharSet.Auto)]
        ...
        public class OCPFIPARAMS {
            ...
            public int x = 0;
            public int y = 0;
            public string lpszCaption = null;
            public int cObjects = 1;
            public IntPtr ppUnk = IntPtr.Zero;
            public int pageCount = 1;
            public IntPtr uuid = IntPtr.Zero;
            public int lcid = Thread.CurrentThread.CurrentCulture.LCID;
            public int dispidInitial = 0;
        }
        ...
        public interface IOleMessageFilter {
            ...
            int HandleInComingCall(
                ...
                IntPtr hTaskCaller,
                int dwTickCount,
                IntPtr lpInterfaceInfo); // LPINTERFACEINFO
        ...
        /// </devdoc>
        [PreserveSig]
        void OnComponentEnterState(int dwComponentID,
                                                    int uStateID,
                                                    int uContext,
                                                    int cpicmExclude,
        ...
        /// </devdoc>
        [PreserveSig]
        bool FPushMessageLoop(int dwComponentID,
                                            int uReason,
        ...
        public interface IRichTextBoxOleCallback {
            ...
            [PreserveSig]
            int QueryAcceptData(IOleDataObject lpdataobj, 
                                           IntPtr lpcfFormat, // CLIPFORMAT*
                                           int reco, 
                                           int fReally, 
                                           IntPtr hMetaPict);
...
[ComImport(), Guid("00020401-0000-0000-C000-000000000046"), InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown)]
    ...
    public sealed class tagQACONTAINER
    {
      ...
      public UnsafeNativeMethods.IOleClientSite pClientSite = null;

      [MarshalAs(UnmanagedType.Interface)]
      public object pAdviseSink = null;

      public UnsafeNativeMethods.IPropertyNotifySink pPropertyNotifySink = null;

      [MarshalAs(UnmanagedType.Interface)]
      public object pUnkEventSink = null;

      [MarshalAs(UnmanagedType.U4)]
      public int dwAmbientFlags = 0;

      [MarshalAs(UnmanagedType.U4)]
      public UInt32 colorFore = 0;

      [MarshalAs(UnmanagedType.U4)]
      public UInt32 colorBack = 0;

      [MarshalAs(UnmanagedType.Interface)]
      public object pFont = null;

      [MarshalAs(UnmanagedType.Interface)]
      public object pUndoMgr = null;

      [MarshalAs(UnmanagedType.U4)]
      public int dwAppearance = 0;
    ...
    public static void PtrToStructure(IntPtr lparam, object data) {
        ...
        {
            public IntPtr             hwndOwner = IntPtr.Zero;       //HWND        hwndOwner;            // HWND of the owner for the dialog
            public IntPtr             pidlRoot = IntPtr.Zero;        //LPCITEMIDLIST pidlRoot;           // Root ITEMIDLIST
    
            // For interop purposes, send over a buffer of MAX_PATH size. 
            public IntPtr             pszDisplayName = IntPtr.Zero;  //LPWSTR       pszDisplayName;      // Return display name of item selected.
    
            public string             lpszTitle = null;       //LPCWSTR      lpszTitle;           // text to go in the banner over the tree.
            public int                ulFlags = 0;         //UINT         ulFlags;             // Flags that control the return stuff
            public BrowseCallbackProc lpfn = null;            //BFFCALLBACK  lpfn;                // Call back pointer
            public IntPtr             lParam = IntPtr.Zero;          //LPARAM       lParam;              // extra info that's passed back in callbacks
            public int                iImage = 0;          //int          iImage;              // output var: where to return the Image index.
        }
