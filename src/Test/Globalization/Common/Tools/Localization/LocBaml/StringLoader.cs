...
namespace BamlLocalization 
{
    internal class StringLoader
    {
         ...
         {
             string message = s_resourceManager.GetString(id);
             if (message != null)
             {
        ...
        private static ResourceManager s_resourceManager = new ResourceManager("Resources.StringTable", typeof(StringLoader).Assembly);
