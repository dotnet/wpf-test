    ...
    {      
            ...
            )
        {
            ...
            for (int i = 0; i < s_wellKnownAssemblies.Length; i++)
            {
                ...
                {
                    s_wellKnownAssemblies[i] = Assembly.Load(
                        GetCompatibleAssemblyName(s_wellKnownAssemblyNames[i])
                        );
                }
            ...
            if (assembly == null)
            {
                   ...
                   )
                {
                    ...
                    if (s_wellKnownAssemblies[index] == null)
                    {
                        ...
                        s_wellKnownAssemblies[index] = Assembly.Load(assemblyName);
                    }         
        ...
        private static string GetCompatibleAssemblyName(string shortName)
        {
            ...
            {                
                if (s_wellKnownAssemblies[i] != null)
                {
                    ...
                    asmName = s_wellKnownAssemblies[i].GetName();
        ...
        private static readonly string[] s_wellKnownAssemblyNames = new string[] { 
                "presentationcore", 
        ...
        private static  Assembly[] s_wellKnownAssemblies = new Assembly[s_wellKnownAssemblyNames.Length]; 
