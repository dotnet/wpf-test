...
{
	public class TreeNodeSelectionProcessor : SelectionProcessor
	{
		...
		static TreeNodeSelectionProcessor() { InitializeStaticFields(staticstatic_DelegateAssembly, MethodBase.GetCurrentMethod().DeclaringType); }
		protected TreeNodeSelectionProcessor(Type[] types, object[] values) : base (types, values) { }
		protected TreeNodeSelectionProcessor(object delegateObject) : base (delegateObject) { }
		...
		{
			return "MS.Internal.Annotations.Anchoring.TreeNodeSelectionProcessor";
		}
