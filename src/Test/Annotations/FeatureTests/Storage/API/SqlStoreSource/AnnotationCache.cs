...
namespace Avalon.Test.Annotations.Storage
{
    ...
    /// </summary>
    internal class AnnotationCache
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        /// <summary>
        /// Constructor for AnnotationCache 
        ...
        internal AnnotationCache(AnnotationAuthorChangedEventHandler authorChanged, AnnotationResourceChangedEventHandler anchorChanged, AnnotationResourceChangedEventHandler cargoChanged)
        {
        ...
        private void MakeDirty(Annotation annot)
        {
            _dirty = true;
            _currentAnnotations[annot.Id].Dirty = true;
        }
        ...
        // Keeps track of whether Cache is dirty of not.
