...
namespace Microsoft.Test.Graphics
{
    ...
    /// </summary>
    public partial class TwoDGlobal1Test : Window
    {

        public TwoDGlobal1Test()
        {
            InitializeComponent();
        }
        ...
        public void RunTest(object sender, System.EventArgs e)
        {
            ...
            XamlTestHelper.AddStep(XamlTestHelper.TakeSnapshot, "TwoDGlobal1.bmp");
        ...
        {
            if ( XamlTestHelper.Compare("TwoDGlobal1Master.bmp") )
            {
