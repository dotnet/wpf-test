...
namespace Microsoft.Test.Graphics
{
    ...
    public partial class ShapeHitTest : Window
    {
    ...
    struct TestData
    {
        public TestData(Point h, UIElement e, bool er)
        {
            _offset = h;
            _element = e;
            _result = er;
        ...
        //It is the offset from the TopLeft point of the bounding box of the element.
        public Point OffSet { get { return _offset; } }

        public UIElement Element { get { return _element; } }
        public bool ExpectedResult { get { return _result; } }
