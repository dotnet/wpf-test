...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class UIElementCaptureToSubtreeApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Capture","HwndSource", @"Compile and Verify UIElement Capture works for subtree in window in HwndSource.")]
        [TestCase("2",@"CoreInput\Capture","Browser", @"Compile and Verify UIElement Capture works for subtree in window in Browser.")]
        [TestCase("2",@"CoreInput\Capture","Window", @"Compile and Verify UIElement Capture works for subtree in window in window.")]        
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1",@"CoreInput\Capture","HwndSource",  @"Verify UIElement Capture works for subtree in window in HwndSource.")]
        [TestCase("1",@"CoreInput\Capture","Window",  @"Verify UIElement Capture works for subtree in window in window.")]        
        public static void LaunchTest() 
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType),DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new UIElementCaptureToSubtreeApp(),"Run");
