...
{
    /// <summary>
    /// Verify KeyConverter ConvertTo method for Key.Down.
    /// </summary>
    /// <description>
    ...
    public class KeyConverterConvertToKeyDownApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\TypeConverter","Window",@"Compile and Vefiry KeyConverter ConvertTo method for Key.Down in window.")]        
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "KeyConverterConvertToKeyDownApp",
                "Run", 
                hostType,null,null );
        ...
        public static void LaunchTest() 
        {
            ...
            exe.Run(new KeyConverterConvertToKeyDownApp(),"Run");
