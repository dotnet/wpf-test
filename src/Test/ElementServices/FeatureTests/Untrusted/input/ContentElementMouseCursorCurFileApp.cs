...
{
    /// <summary>
    /// Verify Mouse cursor from custom cursor .CUR file on a mouse move for ContentElement.
    /// </summary>
    /// <description>
    ...
    public class ContentElementMouseCursorCurFileApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Cursor","HwndSource",@"Compile and Verify Mouse cursor from custom cursor .CUR file on a mouse move for ContentElement in HwndSource.")]
        [TestCase("2",@"CoreInput\Cursor","Browser",@"Compile and Verify Mouse cursor from custom cursor .CUR file on a mouse move for ContentElement in Browser.")]
        [TestCase("2",@"CoreInput\Cursor","Window",@"Compile and Verify Mouse cursor from custom cursor .CUR file on a mouse move for ContentElement in window.")]        
        ...
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "ContentElementMouseCursorCurFileApp",
                "Run", 
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1",@"CoreInput\Cursor","HwndSource",@"Verify Mouse cursor from custom cursor .CUR file on a mouse move for ContentElement in HwndSource.")]
        [TestCase("1",@"CoreInput\Cursor","Window",@"Verify Mouse cursor from custom cursor .CUR file on a mouse move for ContentElement in window.")]        
        [TestCaseSupportFile(@"star.cur")]        
        public static void LaunchTest() 
        {
            ...
            exe.Run(new ContentElementMouseCursorCurFileApp(),"Run");
