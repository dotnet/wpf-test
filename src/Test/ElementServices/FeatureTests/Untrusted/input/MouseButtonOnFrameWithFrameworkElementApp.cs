...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    /// MouseRightButtonDown, MouseLeftButtonUp, and MouseRightButtonUp on framework elements contained by frame 
    ...
    public class MouseButtonOnFrameWithFrameworkElementApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        ...
        public static void LaunchTestCompile()
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "MouseButtonOnFrameWithFrameworkElementApp",
                "Run",
                hostType);
        ...
        public static void LaunchTest()
        {
            ...
            exe.Run(new MouseButtonOnFrameWithFrameworkElementApp(), "Run");
        ...
        public override object DoValidate(object arg)
        {
            ...
            CoreLogger.LogStatus("Events found (expect 12): " + _buttonLog.Count);
            Assert(_buttonLog.Count == 12, "Button Count not correct");
            Assert(_stateLog.Count == 12, "State Count not correct");
