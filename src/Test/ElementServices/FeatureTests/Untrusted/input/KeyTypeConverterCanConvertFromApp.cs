...
{
    /// <summary>
    /// Verify KeyConverter CanConvertFrom method.
    /// </summary>
    /// <description>
    ...
    public class KeyConverterCanConvertFromApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("1", @"CoreInput\TypeConverter", "HwndSource", @"Verify KeyConverter CanConvertFrom in HwndSource.")]
        public static void LaunchTest()
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType), DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new KeyConverterCanConvertFromApp(), "Run");
        ...
        public override object DoSetup(object sender)
        {
            ...
            Debug.Assert(_converter is KeyConverter);
