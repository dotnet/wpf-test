...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    /// It also regresses Windows 




    [CoreTestsLoader(CoreTestsTestType.MethodBase)]
    public class UIElementReleaseMouseCaptureLostCaptureApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Capture","HwndSource",@"Compile and Verify UIElement ReleaseMouseCapture within LostCapture event handler works for element in HwndSource.")]
        [TestCase("2",@"CoreInput\Capture","Browser",@"Compile and Verify UIElement ReleaseMouseCapture within LostCapture event handler works for element in Browser.")]
        [TestCase("2",@"CoreInput\Capture","Window",@"Compile and Verify UIElement ReleaseMouseCapture within LostCapture event handler works for element in window.")]        
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "UIElementReleaseMouseCaptureLostCaptureApp",
                "Run", 
                hostType,null,null );
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Capture","HwndSource",@"Verify UIElement ReleaseMouseCapture within LostCapture event handler works for element in HwndSource.")]
        [TestCase("2",@"CoreInput\Capture","Window",@"Verify UIElement ReleaseMouseCapture within LostCapture event handler works for element in window.")]               
        public static void LaunchTest() 
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType),DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new UIElementReleaseMouseCaptureLostCaptureApp(),"Run");
        ...
        public override object DoSetup(object sender) 
        {
            ...
            
            {
                ...
                _rootElement.LostMouseCapture += new MouseEventHandler(OnLostCapture);
        ...
        protected override object DoExecute(object arg) 
        {
            ...
            _rootElement.ReleaseMouseCapture();
            base.DoExecute(arg);
        ...
        public override object DoValidate(object sender) 
        {
            ...
            bool actual = _bCaptureAPI && !bCaptureIM && !_bIsMouseCaptured && (_eventLog.Count==1);
            bool expected = true;
        ...
        private void OnLostCapture(object sender, MouseEventArgs args)
        {
            ...
            // Check here for IsMouseCaptured.
            _bIsMouseCaptured = _rootElement.IsMouseCaptured;
            CoreLogger.LogStatus("Capture lost via API?      " + (!_bIsMouseCaptured));
        ...
        /// </summary>
        private bool _bIsMouseCaptured = true;
