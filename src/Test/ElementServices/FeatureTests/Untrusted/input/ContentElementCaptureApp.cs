...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class ContentElementCaptureApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Capture","HwndSource",@"Compile and Verify ContentElement Capture works for element in HwndSource.")]
        [TestCase("1",@"CoreInput\Capture","Browser",@"Compile and Verify ContentElement Capture works for element in Browser.")]
        [TestCase("3",@"CoreInput\Capture","Window",@"Compile and Verify ContentElement Capture works for element in window.")]        
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1",@"CoreInput\Capture","HwndSource",@"Verify ContentElement Capture works for element in HwndSource.")]
        [TestCase("2",@"CoreInput\Capture","Window",@"and Verify ContentElement Capture works for element in window.")]        
        public static void LaunchTest() 
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType),DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new ContentElementCaptureApp(),"Run");
