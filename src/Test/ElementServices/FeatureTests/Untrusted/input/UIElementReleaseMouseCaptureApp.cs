...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class UIElementReleaseMouseCaptureApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Capture","HwndSource",@"Compile and Verify UIElement ReleaseMouseCapture works for element in HwndSource.")]
        [TestCase("2",@"CoreInput\Capture","Browser",@"Compile and Verify UIElement ReleaseMouseCapture works for element in Browser.")]
        [TestCase("2",@"CoreInput\Capture","Window",@"Compile and Verify UIElement ReleaseMouseCapture works for element in window.")]
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "UIElementReleaseMouseCaptureApp",
                "Run", 
                hostType,null,null );
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1",@"CoreInput\Capture","HwndSource",@"Verify UIElement ReleaseMouseCapture works for element in HwndSource.")]
        [TestCase("1",@"CoreInput\Capture","Window",@"Verify UIElement ReleaseMouseCapture works for element in window.")]               
        public static void LaunchTest() 
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType),DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new UIElementReleaseMouseCaptureApp(),"Run");
