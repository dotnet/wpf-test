...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class InputManagerProcessEventPushInputNullApp : TestApp
    {

        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCaseContainerAttribute("All","All","2",@"CoreInput\InputManager",TestCaseSecurityLevel.FullTrust,"Verify PushInput(null) puts null staging item into staging area for PostProcessInput.")]
        ...
        public override object DoValidate(object sender)
        {
            ...
            // First item is valid (non-null), but the last two aren't (null).
            // First null is return value from PreProcessInputEventArgs.PushInput.
            // Second null is return value from ProcessInputEventArgs.PeekInput.
            ...
            if (InputHelper.IsPreviewInputReport(reid))
            {
                ...
                if (ir.Name == "RawMouseInputReport")
                {
                    ...
                    if ((rkim.Actions & Microsoft.Test.Input.RawMouseActions.Button2Press) != 0)
                    {
                        ...
                        StagingAreaInputItem saiiPush = e.PushInput(null);
