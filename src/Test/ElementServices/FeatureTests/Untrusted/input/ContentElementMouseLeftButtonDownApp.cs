...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class ContentElementMouseLeftButtonDownApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        ...
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "ContentElementMouseLeftButtonDownApp",
                "Run", 
                hostType);
        ...
        public static void LaunchTest() 
        {
            ...
            exe.Run(new ContentElementMouseLeftButtonDownApp(),"Run");
        ...
        public override object DoSetup(object sender) 
        {
            ...
            _contentElement.PreviewMouseLeftButtonDown += new MouseButtonEventHandler(OnPreviewMouseButton);
            _contentElement.MouseLeftButtonDown += new MouseButtonEventHandler(OnMouseButton);
            _contentElement.PreviewMouseLeftButtonUp += new MouseButtonEventHandler(OnPreviewMouseButton);
            _contentElement.MouseLeftButtonUp += new MouseButtonEventHandler(OnMouseButton);
