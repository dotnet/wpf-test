...
{
    /// <summary>
    /// Verify ModifierKeysConverter ConvertFrom method for standard keys.
    /// </summary>
    /// <description>
    ...
    public class ModifierKeysConverterConvertFromApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("1", @"CoreInput\TypeConverter", "HwndSource", @"Verify ModifierKeysConverter ConvertFrom method for standard keys in HwndSource.")]
        public static void LaunchTest()
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType), DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new ModifierKeysConverterConvertFromApp(), "Run");
