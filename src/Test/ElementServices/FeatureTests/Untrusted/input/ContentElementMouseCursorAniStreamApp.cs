...
{
    /// <summary>
    /// Verify Mouse cursor from custom cursor .ANI stream on a mouse move for ContentElement.
    /// </summary>
    /// <description>
    ...
    public class ContentElementMouseCursorAniStreamApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        ...
        [TestCase("1", @"CoreInput\Cursor", "Browser", @"Compile and Verify Mouse cursor from custom cursor .ANI stream on a mouse move for ContentElement in Browser.")]
        [TestCase("3", @"CoreInput\Cursor", "Window", @"Compile and Verify Mouse cursor from custom cursor .ANI stream on a mouse move for ContentElement in window.")]
        ...
        public static void LaunchTestCompile()
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "ContentElementMouseCursorAniStreamApp",
                "Run",
        ...
        [TestCase("2", @"CoreInput\Cursor", "Window", @"Verify Mouse cursor from custom cursor .ANI stream on a mouse move for ContentElement in window.")]
        [TestCaseSupportFile(@"anitest.ani")]
        public static void LaunchTest()
        {
            ...
            exe.Run(new ContentElementMouseCursorAniStreamApp(), "Run");
