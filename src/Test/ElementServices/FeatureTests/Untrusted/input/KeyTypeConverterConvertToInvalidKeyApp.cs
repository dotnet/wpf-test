...
{
    /// <summary>
    /// Verify KeyConverter ConvertTo method for invalid Key.
    /// </summary>
    /// <description>
    ...
    public class KeyConverterConvertToInvalidKeyApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\TypeConverter","Window",@"Compile and Vefiry KeyConverter KeyConverter ConvertTo method for invalid Key in window.")]        
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "KeyConverterConvertToInvalidKeyApp",
                "Run", 
                hostType,null,null );
        ...
        public static void LaunchTest() 
        {
            ...
            exe.Run(new KeyConverterConvertToInvalidKeyApp(),"Run");
