...
{
    /// <summary>
    /// Verify Mouse cursor from custom cursor .ANI handle on a mouse move for ContentElement.
    /// </summary>
    /// <description>
    ...
    public class ContentElementMouseCursorAniHandleApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2", @"CoreInput\Cursor", "HwndSource", TestCaseSecurityLevel.FullTrust, @"Compile and Verify Mouse cursor from custom cursor .ANI handle on a mouse move for ContentElement in HwndSource.")]
        [TestCase("2", @"CoreInput\Cursor", "Window", TestCaseSecurityLevel.FullTrust, @"Compile and Verify Mouse cursor from custom cursor .ANI handle on a mouse move for ContentElement in window.")]
        ...
        public static void LaunchTestCompile()
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "ContentElementMouseCursorAniHandleApp",
                "Run",
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1", @"CoreInput\Cursor", "HwndSource", TestCaseSecurityLevel.FullTrust, @"Verify Mouse cursor from custom cursor .ANI handle on a mouse move for ContentElement in HwndSource.")]
        [TestCase("2", @"CoreInput\Cursor", "Window", TestCaseSecurityLevel.FullTrust, @"Verify Mouse cursor from custom cursor .ANI handle on a mouse move for ContentElement in window.")]
        [TestCaseSupportFile(@"anitest.ani")]
        public static void LaunchTest()
        {
            ...
            exe.Run(new ContentElementMouseCursorAniHandleApp(), "Run");
        }
