...
{
    /// <summary>
    /// Verify ModifierKeysConverter ConvertFrom method for two Modifier combination keys.
    /// </summary>
    /// <description>
    ...
    public class ModifierKeysConverterConvertFromCombination2KeyApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\TypeConverter","Window",@"Compile and Verify ModifierKeysConverter ConvertFrom method for two Modifier combination key in window.")]        
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "ModifierKeysConverterConvertFromCombination2KeyApp",
                "Run", 
                hostType,null,null );
        ...
        public static void LaunchTest() 
        {
            ...
            exe.Run(new ModifierKeysConverterConvertFromCombination2KeyApp(),"Run");
