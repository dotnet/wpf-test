...
{
    /// <summary>
    /// Verify Mouse cursor from custom cursor .CUR stream on a mouse move.
    /// </summary>
    /// <description>
    ...
    public class UIElementMouseCursorCurStreamApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Cursor","HwndSource",@"Compile and Verify Mouse cursor from custom cursor .CUR stream on a mouse move in HwndSource.")]
        [TestCase("2",@"CoreInput\Cursor","Browser",@"Compile and Verify Mouse cursor from custom cursor .CUR stream on a mouse move in Browser.")]
        [TestCase("2",@"CoreInput\Cursor","Window",@"Compile and Verify Mouse cursor from custom cursor .CUR stream on a mouse move in window.")]        
        ...
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "UIElementMouseCursorCurStreamApp",
                "Run", 
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1",@"CoreInput\Cursor","HwndSource",@"Verify Mouse cursor from custom cursor .CUR stream on a mouse move in HwndSource.")]
        [TestCase("1",@"CoreInput\Cursor","Window",@"Verify Mouse cursor from custom cursor .CUR stream on a mouse move in window.")]        
        [TestCaseSupportFile(@"star.cur")]        
        public static void LaunchTest() 
        {
            ...
            exe.Run(new UIElementMouseCursorCurStreamApp(),"Run");
