...
{
    /// <summary>
    /// Verify ModifierKeysConverter ConvertTo method for standard keys to invalid destination type.
    /// </summary>
    /// <description>
    ...
    public class ModifierKeysConverterConvertToInvalidDestinationTypeApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\TypeConverter","Window",@"Compile and Verify ModifierKeysConverter ConvertTo method for standard keys to invalid destination type in window.")]        
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "ModifierKeysConverterConvertToInvalidDestinationTypeApp",
                "Run", 
                hostType,null,null );
        ...
        public static void LaunchTest() 
        {
            ...
            exe.Run(new ModifierKeysConverterConvertToInvalidDestinationTypeApp(),"Run");
        ...
        public override object DoValidate(object arg) 
        {
            ...
            try
            {
                object convertedKey = (_converter.ConvertTo(_typeDescriptorContext, CultureInfo.InvariantCulture,
                    ModifierKeys.Shift, typeof(Array)));
            }
