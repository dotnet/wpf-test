...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class MouseEnterApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Mouse","HwndSource", @"Compile and Verify MouseEnter, MouseLeave, and Preview events fire on a mouse over / mouse out in HwndSource.")]
        [TestCase("1",@"CoreInput\Mouse","Browser", @"Compile and Verify MouseEnter, MouseLeave, and Preview events fire on a mouse over / mouse out in Browser.")]
        [TestCase("2",@"CoreInput\Mouse","Window", @"Compile and Verify MouseEnter, MouseLeave, and Preview events fire on a mouse over / mouse out in window.")]        
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1",@"CoreInput\Mouse","HwndSource",  @"Verify MouseEnter, MouseLeave, and Preview events fire on a mouse over / mouse out in HwndSource.")]
        [TestCase("2",@"CoreInput\Mouse","Window",  @"Verify MouseEnter, MouseLeave, and Preview events fire on a mouse over / mouse out in window.")]        
        public static void LaunchTest() 
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType),DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new MouseEnterApp(),"Run");
