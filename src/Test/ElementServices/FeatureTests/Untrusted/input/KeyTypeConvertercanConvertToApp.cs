...
{
    /// <summary>
    /// Verify KeyConverter CanConvertTo method.
    /// </summary>
    /// <description>
    ...
    public class KeyConverterCanConvertToApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("1", @"CoreInput\TypeConverter", "HwndSource", @"Verify KeyConverter CanConvertTo in HwndSource.")]
        public static void LaunchTest()
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType), DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new KeyConverterCanConvertToApp(), "Run");
