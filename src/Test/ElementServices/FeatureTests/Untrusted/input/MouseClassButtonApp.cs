...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class MouseClassButtonApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Mouse","HwndSource",@"Compile and Verify Mouse class button properties in HwndSource.")]
        [TestCase("2",@"CoreInput\Mouse","Browser",@"Compile and Verify Mouse class button properties in Browser.")]
        [TestCase("2",@"CoreInput\Mouse","Window",@"Compile and Verify Mouse class button properties in window.")]        
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Mouse","HwndSource",@"Verify Mouse class button properties in HwndSource.")]
        [TestCase("2",@"CoreInput\Mouse","Window",@"Verify Mouse class button properties in window.")]               
        public static void LaunchTest() 
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType),DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new MouseClassButtonApp(),"Run");
        ...
        public override object DoValidate(object arg) 
        {
            ...
            if (_stateLog.Count == 5)
            {
                ...
                bool actual0 = (ms.LeftButton == MouseButtonState.Pressed);
                ...
                bool actual1 = (ms.MiddleButton == MouseButtonState.Pressed);
                ...
                bool actual2 = (ms.XButton1 == MouseButtonState.Pressed);
                ...
                bool actual3 = (ms.XButton2 == MouseButtonState.Pressed);
                ...
                bool actual4 = (ms.RightButton == MouseButtonState.Pressed);
