...
{
    /// <summary>
    /// Verify MouseEnter event is raised for FrameworkContentElement in tree.
    /// </summary>
    /// <description>
    ...
    public class FrameworkContentElementIsMouseOverChangedApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("3", @"CoreInput\Mouse", "HwndSource", @"Compile and Verify MouseEnter event is raised for FrameworkContentElement in tree in HwndSource.")]
        [TestCase("2", @"CoreInput\Mouse", "Browser", @"Compile and Verify MouseEnter event is raised for FrameworkContentElement in tree in Browser.")]
        [TestCase("3", @"CoreInput\Mouse", "Window", @"Compile and Verify MouseEnter event is raised for FrameworkContentElement in tree in window.")]
        public static void LaunchTestCompile()
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "FrameworkContentElementIsMouseOverChangedApp",
                "Run",
                hostType, null, null);
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("2", @"CoreInput\Mouse", "HwndSource", @"Verify MouseEnter event is raised for FrameworkContentElement in tree in HwndSource.")]
        [TestCase("2", @"CoreInput\Mouse", "Window", @"Verify MouseEnter event is raised for FrameworkContentElement in tree in window.")]
        public static void LaunchTest()
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType), DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new FrameworkContentElementIsMouseOverChangedApp(), "Run");
        ...
        public override object DoSetup(object sender)
        {
            ...
            foreach (Canvas cvs in canvases)
            {
                ...
                _contentElement = new InstrFrameworkContentPanel("rootLeaf", "Sample", panel);
                ...
                // Construct child element
                _contentElement2 = new InstrFrameworkContentPanel("rootLeaf", "More", panel2);
        ...
        private FrameworkContentElement _contentElement2 = null;
