...
{
    /// <summary>
    /// Verify KeyConverter ConvertTo method for None key.
    /// </summary>
    /// <description>
    ...
    public class KeyConverterConvertToKeyNoneApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\TypeConverter","Window",@"Compile and Verify KeyConverter ConvertTo method for None key in window.")]        
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "KeyConverterConvertToKeyNoneApp",
                "Run", 
                hostType,null,null );
        ...
        public static void LaunchTest() 
        {
            ...
            exe.Run(new KeyConverterConvertToKeyNoneApp(),"Run");
        ...
        public override object DoValidate(object arg) 
        {
            ...
            try
            {
                object convertedKey = (_converter.ConvertTo(_typeDescriptorContext, CultureInfo.InvariantCulture,
                    Key.None, typeof(string)));
                sResult = convertedKey as string;
            }
            ...
            bool actual = (!bExceptionThrown) && (sResult=="");
            bool expected = true;
