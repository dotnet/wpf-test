...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class ContentElementMouseButtonApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2", @"CoreInput\Mouse", "HwndSource", @"Compile and Verify MouseEventArgs and MouseButtonEventArgs button properties on ContentElement in HwndSource.")]
        [TestCase("2", @"CoreInput\Mouse", "Browser", @"Compile and Verify MouseEventArgs and MouseButtonEventArgs button properties on ContentElement in Browser.")]
        [TestCase("2", @"CoreInput\Mouse", "Window", @"Compile and Verify MouseEventArgs and MouseButtonEventArgs button properties on ContentElement in window.")]
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1", @"CoreInput\Mouse", "HwndSource", @"Verify MouseEventArgs and MouseButtonEventArgs button properties on ContentElement in HwndSource.")]
        [TestCase("0", @"CoreInput\Mouse", "Window", @"Verify MouseEventArgs and MouseButtonEventArgs button properties on ContentElement in window.")]
        public static void LaunchTest()
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType), DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new ContentElementMouseButtonApp(), "Run");
        ...
        public override object DoValidate(object arg)
        {
            ...
            {
                MouseButton btn = _buttonLog[0];
                MouseButtonState state = _stateLog[0];
