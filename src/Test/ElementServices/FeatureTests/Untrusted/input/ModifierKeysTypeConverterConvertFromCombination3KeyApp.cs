...
{
    /// <summary>
    /// Verify ModifierKeysConverter ConvertFrom method for three or more Modifier combination keys.
    /// </summary>
    /// <description>
    ...
    public class ModifierKeysConverterConvertFromCombination3KeyApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\TypeConverter","Window",@"Compile and Verify ModifierKeysConverter ConvertFrom method for three or more Modifier combination key in window.")]        
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "ModifierKeysConverterConvertFromCombination3KeyApp",
                "Run", 
                hostType,null,null );
        ...
        public static void LaunchTest() 
        {
            ...
            exe.Run(new ModifierKeysConverterConvertFromCombination3KeyApp(),"Run");
        ...
        public override object DoValidate(object arg) 
        {
            ...
            for (int i = 0; i < _convertedKeys.Length; i++)
            {
                ...
                else
                {
                    ...
                    ModifierKeys k = (ModifierKeys)_convertedKeys[i];
