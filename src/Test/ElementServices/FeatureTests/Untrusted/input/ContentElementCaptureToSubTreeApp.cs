...
namespace Avalon.Test.CoreUI.CoreInput
{
    ...
    public class ContentElementCaptureToSubTreeApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2",@"CoreInput\Capture","HwndSource",@"Compile and Verify ContentElement Capture works for subtree in HwndSource.")]
        [TestCase("2",@"CoreInput\Capture","Browser",@"Compile and Verify ContentElement Capture works for subtree in Browser.")]
        [TestCase("2",@"CoreInput\Capture","Window",@"Compile and Verify ContentElement Capture works for subtree in window.")]
        public static void LaunchTestCompile() 
        {
            ...
            GenericCompileHostedCase.RunCase(
                ...
                "ContentElementCaptureToSubtreeApp",
                "Run", 
                hostType);
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1",@"CoreInput\Capture","HwndSource",@"Verify ContentElement Capture works for subtree in HwndSource.")]
        [TestCase("1",@"CoreInput\Capture","Window",@"and Verify ContentElement Capture works for subtree in window.")]        
        public static void LaunchTest() 
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType),DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new ContentElementCaptureToSubTreeApp(),"Run");
        ...
        public override object DoSetup(object sender) 
        {
            ...
            
            {
                ...
                // Add event handling
                _contentElement.LostMouseCapture += new MouseEventHandler(OnCapture);
