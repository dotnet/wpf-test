...
namespace Avalon.Test.CoreUI.PropertyEngine.DisjointTree
{
    ...
    /// </summary>  
    [Model(@"FeatureTests\ElementServices\DisjointTree_Xaml.xtc", 0, @"PropertyEngine\DisjointTree", TestCaseSecurityLevel.FullTrust, "DisjointTreeModel",
    ...
    [Serializable()]
    class DisjointTreeModelState : CoreState
    {
        public DisjointTreeModelState(CoreState state)
        {
            this.Dictionary = (PropertyBag)state.Dictionary.Clone();
        }

        public DisjointTreeModelState(State state) : base(state)
        {   
            //Kind = state["Kind"];
        ...
        public string MentorItem { get { return Dictionary["MentorItem"]; } }
        public string Link { get { return Dictionary["Link"]; } }
        public string HowLinked { get { return Dictionary["HowLinked"]; } }
        public string Service { get { return Dictionary["Service"]; } }
        public string ContextOrientation { get { return Dictionary["ContextOrientation"]; } }


        // These names are used in the test tree generation and verification 
        // routines so this is the best place for them.
        public string DynamicResourceKey = "testBrush";
        
        public string TestRootName = "TestRoot";

        public string FirstParentName = "firstParent";
        public string SecondParentName = "secondParent";

        public string FirstMentorName = "firstMentor";
        public string SecondMentorName = "secondMentor";

        public string FirstMenteeName = "firstMentee";
        public string SecondMenteeName = "secondMentee";
    }
