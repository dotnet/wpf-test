...
/*******************************************************************
 * Purpose: Common helper functions for manipulating Xaml in framework tests.
 *  
...
namespace Avalon.Test.CoreUI
{
    ...
    public class XamlTestDocument: XmlDocument
    {
        ...
        /// </summary>
        public XamlTestDocument(string xamlTemplateFilename, string xamlElementsFilename) : base()
        {
        ...
        public void SetVerifierRoutine(MethodInfo methodInfo)
        {
            ...
            attrib.Value = methodInfo.DeclaringType.Assembly.Location +
        ...
        public XmlElement GetSnippetByXPath(string xpath, bool verifySnippet)
        {
            ...
            {
                throw new Microsoft.Test.TestValidationException("Could not get snippet with xpath: " + xpath);
            }
        ...
        public XmlElement GetContainerNode(Type type)
        {
            ...
            if (containerNode == null)
            {
                throw new Microsoft.Test.TestValidationException("Could not find xaml container snippet for type '" + type.Name + "' in '" + _xamlElementsFilename + "'.");
            }
