...
namespace Avalon.Test.CoreUI.Serialization
{
    ...
    public class CustomDPOnAvalonComponent2 : SerializationBaseCase
    {
        ...
        override protected void DoTheTest(String filename)
        {
            ...
            filename = "CustomDPOnAvalonComponent2.xaml";
        ...
        private void TestFirstNodeProperties(object root)
        {
            ...
            _myButton = myChildren[0] as Button;

            VerifyElement.VerifyBool(null == _myButton, false);
        }
