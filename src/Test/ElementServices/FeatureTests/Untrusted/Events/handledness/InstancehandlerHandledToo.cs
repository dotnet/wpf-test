...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.ContentHost", "InstancehandlerHandledToo")]
    public class InstancehandlerHandledToo : EventHelper
    {
        #region Constructor
        public InstancehandlerHandledToo()
        {
        ...
        {
            CoreLogger.LogStatus ("This is a BVT scenario for Handledness: two instance handlers for base class are all invoked althogh handled has been set to be true is HandledEventToo is true");
            ...
            {
                myControl.AddHandler (routedEvent, new CustomRoutedEventHandler (EventHandler1), true);
                myControl.AddHandler (routedEvent, new CustomRoutedEventHandler (EventHandler2), true);
            }
