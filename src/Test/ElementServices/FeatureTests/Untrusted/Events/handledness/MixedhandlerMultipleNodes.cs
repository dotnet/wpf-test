...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.ContentHost", "MixedhandlerMultipleNodes")]
    public class MixedhandlerMultipleNodes : EventHelper
    {
        #region Data
        private class MyOwnCustomControl : CustomControl
        {
            public MyOwnCustomControl():base(){}
        }
        private int _classHandlerCalledCount = 0;
        #endregion


        #region Constructor
        public MixedhandlerMultipleNodes()
        {
        ...
        TestResult StartTest()
        {
            ...
            // Local Varables
            MyOwnCustomControl myControl1 = null;
            MyOwnCustomControl myControl2 = null;
            MyOwnCustomControl myControl3 = null;
            ...
            {
                myControl1 = new MyOwnCustomControl ();
                myControl2 = new MyOwnCustomControl ();
                myControl3 = new MyOwnCustomControl ();
            }
            ...
            using (CoreLogger.AutoStatus ("Attach Class Handlers"))
            {
                EventManager.RegisterClassHandler (typeof(MyOwnCustomControl), routedEvent, new CustomRoutedEventHandler (myClassHandler), false);
                EventManager.RegisterClassHandler (typeof(MyOwnCustomControl), routedEvent, new CustomRoutedEventHandler (myClassHandler), true);
            }
            ...
            using (CoreLogger.AutoStatus ("add handlers"))
            {
                ...
                myControl1.AddHandler (routedEvent, myHandler5);
            ...
            {
                if (6 != args.HandlersCalledCount || 6 != _classHandlerCalledCount)
                {
            ...
            using (CoreLogger.AutoStatus ("set Handledness and reset CalledCount"))
            {
                ...
                _classHandlerCalledCount = 0;
            }

            using (CoreLogger.AutoStatus ("Remove handlers to make sure correct sequence"))
            {
            ...
            using (CoreLogger.AutoStatus ("Validation for event"))
            {
                if (3 != args.HandlersCalledCount || 3 != _classHandlerCalledCount)
                {
                    throw new Microsoft.Test.TestValidationException ("Incorrect HandlersCalledCount");
                }
            }
        ...
        /// <param name="sender">Pass the object to it</param>
        /// <param name="args">Pass the CustomRoutedEventArgs to it</param>
        public void myClassHandler (object sender, CustomRoutedEventArgs args)
        {
            CoreLogger.LogStatus ("Class Handler called");


            _classHandlerCalledCount++;
        }
        #endregion
    }
}
