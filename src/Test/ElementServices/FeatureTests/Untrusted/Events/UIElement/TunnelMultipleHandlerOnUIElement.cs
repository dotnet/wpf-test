...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.UIElement", "TunnelMultipleHandlerOnUIElement")]
    public class TunnelMultipleHandlerOnUIElement : EventHelper
    {
        #region Constructor
        public TunnelMultipleHandlerOnUIElement()
        {
