...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Bubble", "BubblingEventRoutingFrameworkAvalonFig42")]
    public class BubblingEventRoutingFrameworkAvalonFig42 : EventHelper
    {
        #region Constructor
        public BubblingEventRoutingFrameworkAvalonFig42()
        {
        ...
        TestResult StartTest()
        {
            ...
            CoreLogger.LogStatus("Tests attach bubbling event to CustomAvalonControl");
