...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Bubble", "BubblingEventRoutingFrameworkAvalonFig45")]
    public class BubblingEventRoutingFrameworkAvalonFig45 : EventHelper
    {
        #region Constructor
        public BubblingEventRoutingFrameworkAvalonFig45()
        {
        ...
        TestResult StartTest()
        {
            ...
            CoreLogger.LogStatus("Tests attach bubbling event to CustomAvalonControl, CustomAvalonControl, CustomAvalonControl, CustomAvalonControl. Then Raise Events.");
            ...
            {
                routedEvent = BubblingEventRoutingFrameworkAvalonFig45.RoutedEvent1;
            }
