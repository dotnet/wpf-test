...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Bubble", "BubblingEventRoutingFrameworkFig43")]
    public class BubblingEventRoutingFrameworkFig43 : EventHelper
    {
        #region Constructor
        public BubblingEventRoutingFrameworkFig43()
        {
        ...
        TestResult StartTest()
        {
            ...
            CoreLogger.LogStatus("Tests attach bubbling event to CustomContentHost, CustomContentElement, CustomControl");
            ...
            {
                routedEvent = BubblingEventRoutingFrameworkFig43.RoutedEvent1;
            }
