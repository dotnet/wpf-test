...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Bubble", "BubblingEventRoutingFrameworkFig42")]
    public class BubblingEventRoutingFrameworkFig42 : EventHelper
    {
        #region Constructor
        public BubblingEventRoutingFrameworkFig42()
        {
        ...
        {
            CoreLogger.LogStatus("This is a BVT scenario for attaching bubble event to a simple tree with control1 model parent of control3, and control1 visual parent of control2 visual parent of control3");
            ...
            {
                routedEvent = BubblingEventRoutingFrameworkFig42.RoutedEvent1;
            }
