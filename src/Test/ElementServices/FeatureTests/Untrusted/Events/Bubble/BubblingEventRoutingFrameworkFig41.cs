...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Bubble", "BubblingEventRoutingFrameworkFig41")]
    public class BubblingEventRoutingFrameworkFig41 : EventHelper
    {
        #region Constructor
        public BubblingEventRoutingFrameworkFig41()
        {
        ...
        TestResult StartTest()
        {
            ...
            CoreLogger.LogStatus("Tests attach bubbling event to CustomControl1, CustomControl2, CustomControl3");
            ...
            {
                routedEvent = BubblingEventRoutingFrameworkFig41.RoutedEvent1;
            }
