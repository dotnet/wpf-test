...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Bubble", "AttachBubblingEventHandler")]
    public class AttachBubblingEventHandler : EventHelper
    {
        #region Constructor
        public AttachBubblingEventHandler()
        {
        ...
        TestResult StartTest()
        {
            ...
            CoreLogger.LogStatus("Tests attach bubbling event to customcontrols");
            ...
            {
                routedEvent = AttachBubblingEventHandler.RoutedEvent1;
            }
