...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.ContentElement", "BubblingSubclassClasshandlersSequence")]
    public class BubblingSubclassClasshandlersSequence : EventHelper
    {
        #region Constructor
        public BubblingSubclassClasshandlersSequence()
        {
        ...
        {
            CoreLogger.LogStatus ("This is a BVT scenario for Bubble Event: class handlers for subclass are invoke before classhandlers for base class");
