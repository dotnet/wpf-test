...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Bubble", "BubblingEventRoutingFrameworkFig44")]
    public class BubblingEventRoutingFrameworkFig44 : EventHelper
    {
        #region Constructor
        public BubblingEventRoutingFrameworkFig44()
        {
        ...
        TestResult StartTest()
        {
            ...
            CoreLogger.LogStatus("Tests attach bubbling event to CustomContentHost, CustomContentElement, CustomControl, CustomControl. Then Raise Events.");
            ...
            {
                routedEvent = BubblingEventRoutingFrameworkFig44.RoutedEvent1;
            }
