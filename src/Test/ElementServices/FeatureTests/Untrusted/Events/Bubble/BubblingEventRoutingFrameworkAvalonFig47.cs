...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Bubble", "BubblingEventRoutingFrameworkAvalonFig47")]
    public class BubblingEventRoutingFrameworkAvalonFig47 : EventHelper
    {
        #region Constructor
        public BubblingEventRoutingFrameworkAvalonFig47()
        {
        ...
        TestResult StartTest()
        {
            ...
            using (CoreLogger.AutoStatus ("Add event handlers for bubble event"))
            {
                ...
                ce2.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent1));
