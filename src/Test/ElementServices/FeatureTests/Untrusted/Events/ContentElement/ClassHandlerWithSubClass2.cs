...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.ContentElement", "ClassHandlerWithSubClass2")]
    public class ClassHandlerWithSubClass2 : EventHelper
    {
        #region Constructor
        public ClassHandlerWithSubClass2()
        {
        ...
        TestResult StartTest()
        {
            ...
            {
                EventManager.RegisterClassHandler (typeof(CustomContentElement1), routedEvent, new CustomRoutedEventHandler (OnRoutedEvent3));
                EventManager.RegisterClassHandler (typeof(CustomContentElement1), routedEvent, new CustomRoutedEventHandler (OnRoutedEvent4));
                EventManager.RegisterClassHandler (typeof(CustomContentElement2), routedEvent, new CustomRoutedEventHandler (OnRoutedEvent1));
                EventManager.RegisterClassHandler (typeof(CustomContentElement2), routedEvent, new CustomRoutedEventHandler (OnRoutedEvent2));
            }
        ...
        /// <param name="sender">Pass the object to it</param>
        /// <param name="args">Pass the CustomRoutedEventArgs to it</param>
        private void OnRoutedEvent4 (object sender, CustomRoutedEventArgs args)
        {
            CoreLogger.LogStatus ("Running OnRoutedEvent4");
        ...
        {
            CoreLogger.LogStatus ("Running OnRoutedEvent1");
