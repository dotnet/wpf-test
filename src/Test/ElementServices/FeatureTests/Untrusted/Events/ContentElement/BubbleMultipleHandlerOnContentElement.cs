...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.ContentElement", "BubbleMultipleHandlerOnContentElement")]
    public class BubbleMultipleHandlerOnContentElement : EventHelper
    {
        #region Constructor
        public BubbleMultipleHandlerOnContentElement()
        {
