...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "TunnelingEventRoutingFrameworkFig49")]
    public class TunnelingEventRoutingFrameworkFig49 : EventHelper
    {
        #region Constructor
        public TunnelingEventRoutingFrameworkFig49()
        {
        ...
        {
            CoreLogger.LogStatus ("This is a BVT scenario for tunnel event for Fig 49");
            ...
            {
                ch1.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent1));
                ce3.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent2));
                cc2.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent3));
                cc4.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent4));
                ch5.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent5));
                ce7.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent6));
                cc6.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent7));
                cc8.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent8));
            }

            using (CoreLogger.AutoStatus ("Raise the tunnel event on control8"))
            {
                targets[7].Source = cc8;
                targets[7].Sender = cc8;
                targets[6].Source = cc6;
                targets[6].Sender = cc6;
                targets[5].Source = cc8;
                targets[5].Sender = ce7;
                targets[4].Source = cc8;
                targets[4].Sender = ch5;
                targets[3].Source = cc8;
                targets[3].Sender = cc4;
                targets[2].Source = cc2;
                targets[2].Sender = cc2;
                targets[1].Source = cc8;
                targets[1].Sender = ce3;
                targets[0].Source = cc8;
                targets[0].Sender = ch1;
