...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "TunnelingEventRoutingFrameworkFig50")]
    public class TunnelingEventRoutingFrameworkFig50 : EventHelper
    {
        #region Constructor
        public TunnelingEventRoutingFrameworkFig50()
        {
        ...
        {
            CoreLogger.LogStatus ("This is a BVT scenario for tunnel event for Fig 50");
            ...
            using (CoreLogger.AutoStatus ("Add event handlers for tunnel event"))
            {
                ...
                ce5.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent3));
            ...
            using (CoreLogger.AutoStatus ("Raise the tunnel event on control6"))
            {
                targets[5].Source = cc6;
                targets[5].Sender = cc6;
                targets[4].Source = cc4;
                targets[4].Sender = cc4;
                targets[3].Source = cc4;
                targets[3].Sender = cc2;
                targets[2].Source = cc6;
                targets[2].Sender = ce5;
