...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "TunnelingEventRoutingFrameworkFig48")]
    public class TunnelingEventRoutingFrameworkFig48 : EventHelper
    {
        #region Constructor
        public TunnelingEventRoutingFrameworkFig48()
        {
        ...
        {
            CoreLogger.LogStatus ("This is a BVT scenario for tunnel event for Fig 48");
            ...
            {
                cc1.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent1));
                ch2.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent2));
                cc3.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent4));
                ce4.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent3));
                cc5.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent5));
                cc6.AddHandler (routedEvent, new CustomRoutedEventHandler (OnRoutedEvent6));
            ...
            using (CoreLogger.AutoStatus ("Raise the tunnel event on control3"))
            {
                ...
                targets[5].Sender = cc6;
                targets[4].Source = cc5;
                targets[4].Sender = cc5;
                targets[3].Source = cc3;
                targets[3].Sender = cc3;
                targets[2].Source = cc5;
                targets[2].Sender = ce4;
                targets[1].Source = cc5;
                targets[1].Sender = ch2;
