...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "TunnelingEventRoutingFrameworkFig45")]
    public class TunnelingEventRoutingFrameworkFig45 : EventHelper
    {
        #region Constructor
        public TunnelingEventRoutingFrameworkFig45()
        {
        ...
        {
            CoreLogger.LogStatus("This is a BVT scenario for attaching tunnel event to a simple tree with control1 visual parent of control4 visual parent of control3,");
            CoreLogger.LogStatus("and control1 model parent of control2 model parent of control3.");
            CoreLogger.LogStatus("Tests attach tunneling event to CustomControl, CustomControl, CustomControl, CustomControl. Then Raise Events.");
            ...
            {
                routedEvent = TunnelingEventRoutingFrameworkFig45.PreviewRoutedEvent1;
            }
