...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "TunnelingEventRoutingFrameworkFig42")]
    public class TunnelingEventRoutingFrameworkFig42 : EventHelper
    {
        #region Constructor
        public TunnelingEventRoutingFrameworkFig42()
        {
        ...
        {
            CoreLogger.LogStatus("This is a BVT scenario for attaching tunnel event to a simple tree with control1 model parent of control3, and control1 visual parent of control2 visual parent of control3");
            CoreLogger.LogStatus("Tests attach tunneling event to CustomControl");
            ...
            // Create size of three object array to contain three CustomControl
            ...
            {
                routedEvent = TunnelingEventRoutingFrameworkFig42.PreviewRoutedEvent1;
            }
