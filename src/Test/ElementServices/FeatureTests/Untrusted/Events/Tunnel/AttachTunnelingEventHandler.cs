...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "AttachTunnelingEventHandler")]
    public class AttachTunnelingEventHandler : EventHelper
    {
        #region Constructor
        public AttachTunnelingEventHandler()
        {
        ...
        TestResult StartTest()
        {
            ...
            CoreLogger.LogStatus("Tests attach tunneling event to customcontrols");
            ...
            {
                routedEvent = AttachTunnelingEventHandler.PreviewRoutedEvent1;
            }
