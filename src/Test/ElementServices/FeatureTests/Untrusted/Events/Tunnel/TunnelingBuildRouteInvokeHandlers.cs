...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "TunnelingBuildRouteInvokeHandlers")]
    public class TunnelingBuildRouteInvokeHandlers : EventHelper
    {
        #region Constructor
        public TunnelingBuildRouteInvokeHandlers()
        {
        ...
        TestResult StartTest()
        {
            ...
            {
                routedEvent = TunnelingBuildRouteInvokeHandlers.PreviewRoutedEvent1 ;
            }
