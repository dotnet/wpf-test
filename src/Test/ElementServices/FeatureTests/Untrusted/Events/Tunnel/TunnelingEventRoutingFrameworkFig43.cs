...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "TunnelingEventRoutingFrameworkFig43")]
    public class TunnelingEventRoutingFrameworkFig43 : EventHelper
    {
        #region Constructor
        public TunnelingEventRoutingFrameworkFig43()
        {
        ...
        {
            CoreLogger.LogStatus("This is a BVT scenario for attaching tunnel event to a simple tree with contentHost1 visual parent of control3, and contentHost1 model parent of contentElement2 model parent of control3");
            CoreLogger.LogStatus("Tests attach tunneling event to CustomContentHost, CustomContentElement, CustomControl");
            ...
            {
                routedEvent = TunnelingEventRoutingFrameworkFig43.PreviewRoutedEvent1;
            }
