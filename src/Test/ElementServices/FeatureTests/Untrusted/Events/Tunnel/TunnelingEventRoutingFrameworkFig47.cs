...
namespace Avalon.Test.CoreUI.Events
{
    ...
    [Test(0, "Events.Tunnel", "TunnelingEventRoutingFrameworkFig47")]
    public class TunnelingEventRoutingFrameworkFig47 : EventHelper
    {
        #region Constructor
        public TunnelingEventRoutingFrameworkFig47()
        {
        ...
        {
            CoreLogger.LogStatus ("This is a BVT scenario for attaching tunnel event to an CustomControl with VI parent of CustomControl and Model parent of ce");
