...
{
    #region Class MyUIElementWithCustomProperties
    /// <summary>
    /// This class defines custom clr class with various custom properties
    /// </summary>
    public class MyUIElementWithCustomProperties : UIElement
    {
        #region Constructor
        ...
        /// 
        /// </summary>
        public MyUIElementWithCustomProperties() : base()
        {
        ...
        public static DependencyProperty MyHiddenDPProperty = 
                                                  ...
                                                  "MyHiddenDP", 
                                                  typeof(String), 
                                                  typeof(MyUIElementWithCustomProperties), 
        ...
        /// </summary>
        public static DependencyProperty MyContentDPProperty = DependencyProperty.RegisterAttached("MyContentDP", typeof(String), typeof(MyUIElementWithCustomProperties), new FrameworkPropertyMetadata("0.0"));
        ...
        /// 
        /// </summary>
        public static readonly DependencyProperty MyShouldNotDPProperty = DependencyProperty.RegisterAttached("MyShouldNotDP", typeof(String), typeof(MyUIElementWithCustomProperties));
        ...
        /// </summary>
        /// <returns></returns>
        public bool ShouldSerializeMyShouleSerializeClrColor()
        {
            return true;
        }
        ...
        private static DependencyPropertyKey s_IListDPPropertyKey =
               DependencyProperty.RegisterReadOnly("IListDP", 
                                           typeof(ArrayList), 
                                           typeof(MyUIElementWithCustomProperties), 
        ...
        /// 
        /// </summary>
        public static DependencyProperty IListDPProperty = 
            s_IListDPPropertyKey.DependencyProperty;
        ...
        /// <value></value>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public ArrayList IListDP
        {
            get { return (ArrayList)GetValue(IListDPProperty); }
        }
