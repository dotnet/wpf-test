...
{
    /// <summary>
    /// This class represents an instrumented host for instrumented core content panels (InstrCoreContentPanel).
    /// An InstrPanelHost stores any number of content panels as children.
    ...
    /// </summary>
    /// <remarks>
    /// We assume there is at least one child element of type InstrCoreContentPanel.
    /// </remarks>
    [ContentProperty("ModelChildren")]
    public class InstrPanelHost : UIElement, IContentHost, ILogicalParent
    {
        ...
        IEnumerator<IInputElement> IContentHost.HostedElements
        {
            get
            {
                return _modelChildren.GetEnumerator() as IEnumerator<IInputElement>;
            }
        }
        ...
        /// <summary>
        /// Construct a InstrPanelHost.
        /// </summary>
        public InstrPanelHost()
        {
            // Initialize collection to nothing.
            _modelChildren = new LogicalChildCollection(this, false);
        ...
        public bool ChangeBackgroundOnMouseEnter
        {
            get
            {
                return _bChangeBackgroundOnMouseEnter;
            }
            set
            {
        ...
        internal void AddChild(object o)
        {
        ...
        IInputElement IContentHost.InputHitTest(Point p)
        {
            ...
            if (_modelChildren.Count > 0)
            {
                return _modelChildren[0] as IInputElement;
            }
        ...
        protected override void OnRender(DrawingContext ctx)
        {
            ...
            FormattedText text = new FormattedText(this.Caption, CultureInfo.CurrentCulture, FlowDirection.LeftToRight, new Typeface("Arial"), 8, Brushes.White);
        ...
        {
            Debug.WriteLine("Hello from InstrPanelHost + - " + msg);
        }
        ...
        private InstrCoreContentPanel _leaf = null;
