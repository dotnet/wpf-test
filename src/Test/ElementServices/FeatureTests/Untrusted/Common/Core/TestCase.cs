...
namespace Avalon.Test.CoreUI
{
    ...
    /// This is supported because it can provide different hosting scenarios with a lot of abstraction
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// This class provide a several ways to create test cases in a Common way
    /// <para/>
    ///     
    /// /////

    abstract public class TestCase : AvalonTest, IDisposable
    {
        /// <summary>
