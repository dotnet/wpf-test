...
namespace Avalon.Test.CoreUI.Common
{
    ...
    ******************************************************************************/
    ...
    /// </summary>
    public abstract class TestApp : AvalonTest, IHostedTest
    {
        /// <summary>
        ...
        ******************************************************************************/
        /// <summary>
        /// RunTestAction: retrieve data needed to run the test, then launch the test.
        /// </summary>
        public static void RunTestAction()
        {
            GlobalLog.LogStatus("In TestApp.RunTestAction...");
            
            string testName = DriverState.DriverParameters["CtorParams"];

            char[] delimiters = new char[] { '_' };
            String[] argArray = testName.Split(delimiters);            

            testName = argArray[0];

            if (testName == null)
            {
                throw new Microsoft.Test.TestSetupException("'TestName' could not be retrieved from DriverState.");
            }
            ...
            Type type = Utility.FindType(testName, false);

            GlobalLog.LogStatus("Running '" + type.Name + "'.");
        ...
        ******************************************************************************/
        ...
        /******************************************************************************
        * Function:          SetupExecuteAndValidate
        ******************************************************************************/
        /// <summary>
        ...
        ******************************************************************************/
        ...
        /******************************************************************************
        * Function:          GetDirectoryNameOfAssembly
        ******************************************************************************/
        /// <summary>
        ...
        ******************************************************************************/
        ...
        /******************************************************************************
        * Function:          ExecuteTestOperations
        ******************************************************************************/
        /// <summary>
        ...
        /******************************************************************************
        * Function:          ExecuteNextInputCallback
        ******************************************************************************/
        ...
        ******************************************************************************/
        ...
        /******************************************************************************
        * Function:          CommonTestAppDispatcherExceptionHandler
        ******************************************************************************/
