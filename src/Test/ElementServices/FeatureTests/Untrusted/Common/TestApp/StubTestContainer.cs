...
namespace Avalon.Test.CoreUI.Common
{
    ...
    public class StubTestContainer : ITestContainer
    {
        ...
        private bool _shouldLogUnhandledException = true;
        ...
        ******************************************************************************/
        ...
        {
            GlobalLog.LogStatus("In CreateTestContainer...");

            Controller controller = (Controller)CommonStorage.Current.Get("Controller");            
            HostType hostType = (HostType)Enum.Parse(typeof(HostType), DictionaryStore.Current["HostType"]);
        ...
        /******************************************************************************
        * Function:          StubTestContainer Constructor
        ******************************************************************************/
        /// <summary>
        /// </summary>
        ...
        ******************************************************************************/
        ...
        public Surface DisplayObject(object visual, int x, int y, int w, int h)
        {
            ...
            {
                GlobalLog.LogStatus("Creating '" + HostType.ToString() + "' surface...");
            ...
            else
            {
                ...
                {
                    GlobalLog.LogStatus("Creating 'Browser' surface...");
                ...
                {
                    GlobalLog.LogStatus("Creating 'Window' surface...");
        ...
        public void EndTest()
        {
            ...
            //if (Avalon.Test.CoreUI.Common.HostType.Browser != HostType)
            //{
            //    DispatcherHelper.ShutDownPriorityBackground(_currentDispatcher);
            //}
            //else
            //{
        ...
        public void EndTestNow()
        {
            ...
            //if (Avalon.Test.CoreUI.Common.HostType.Browser != HostType)
            //{
            //    DispatcherHelper.ShutDown(_currentDispatcher);
            //}
            //else
            //{
            //    ApplicationMonitor.NotifyStopMonitoring();
