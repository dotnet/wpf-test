...
{
    /// <summary>
    /// Verify KeyGestureConverter CanConvertFrom method.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify KeyGestureConverter CanConvertFrom.")]
    [TestCasePriority("1")]
    [TestCaseArea(@"Commanding\TypeConverter")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    public class KeyGestureConverterCanConvertFromApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new KeyGestureConverterCanConvertFromApp();
