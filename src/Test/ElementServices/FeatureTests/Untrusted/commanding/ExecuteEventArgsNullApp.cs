...
{
    /// <summary>
    /// Verify ExecutedRoutedEventArgs(null) works for element in window.
    /// </summary>
    /// <description>
    ...
    [TestCasePriority("2")]
    [TestCaseTitle("Verify ExecutedRoutedEventArgs(null) works for element in window.")]
    [TestCaseArea(@"Commanding\CoreCommanding")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.FullTrust)]
    public class ExecutedRoutedEventArgsNullApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new ExecutedRoutedEventArgsNullApp();
...
/*
            ...
            try
            {
                ...
                ExecutedRoutedEventArgs eCommand = new ExecutedRoutedEventArgs(sCommand);
            }
