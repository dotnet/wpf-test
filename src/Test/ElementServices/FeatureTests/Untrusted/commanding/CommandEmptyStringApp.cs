...
{
    /// <summary>
    /// Verify RoutedCommand can be created with an empty string ("")
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify RoutedCommand can be created with an empty string ("")")]
    [TestCasePriority("1")]
    [TestCaseArea(@"Commanding\Interfaces")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    public class CommandEmptyStringApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new CommandEmptyStringApp();
        ...
        public override object DoSetup(object sender)
        {
            ...
            try
            {
                _sampleCommand = new RoutedCommand("", this.GetType(), null);
            }
            ...
            try
            {
                RoutedCommand sampleCommand2 = new RoutedCommand("", this.GetType());
            }
            catch (ArgumentException)
            {
