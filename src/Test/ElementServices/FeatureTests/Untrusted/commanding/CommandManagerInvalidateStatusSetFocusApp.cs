...
namespace Avalon.Test.CoreUI.Commanding
{
    ...
    ******************************************************************************/
    /// <summary>
    /// Verify CommandManager StatusInvalidated works for element on set and lose focus.
    /// </summary>
    /// <description>
    ...
    [Test(0, "Commanding.CoreCommanding", TestCaseSecurityLevel.FullTrust, "CommandManagerInvalidateStatusSetFocusApp")]
    public class CommandManagerInvalidateStatusSetFocusApp : TestApp
    {
        #region Private Data
        ...
        /******************************************************************************
        * Function:          CommandManagerInvalidateStatusSetFocusApp Constructor
        ******************************************************************************/
        public CommandManagerInvalidateStatusSetFocusApp(string arg)
        {
            GlobalLog.LogStatus("In CommandManagerInvalidateStatusSetFocusApp constructor");
            _hostTypeStr = arg;
        ...
        ******************************************************************************/
        TestResult StartTest()
        {
            ...
            TestApp app = new CommandManagerInvalidateStatusSetFocusApp(_hostTypeStr);
        ...
        ******************************************************************************/
        ...
        {
            GlobalLog.LogStatus("Setting initial focus...");
            bool bFocus = _rootElement.Focus();
            GlobalLog.LogStatus("Custom element focused? (expect true) " + bFocus);

            GlobalLog.LogStatus("Setting new focus...");
            InstrPanel newEl = new InstrPanel();
            ((InstrPanel)_rootElement).AppendChild(newEl);
            IInputElement e = Keyboard.Focus(newEl);
            GlobalLog.LogStatus("New element focused? (expect yes) " + (e != _rootElement));
