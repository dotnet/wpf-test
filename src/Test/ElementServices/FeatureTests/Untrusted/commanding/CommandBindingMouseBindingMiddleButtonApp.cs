...
{
    /// <summary>
    /// Verify UIElement CommandBinding MouseBinding works for middle-mouse button on element in window.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify UIElement CommandBinding MouseBinding works for middle-mouse button on element in window.")]
    [TestCasePriority("2")]
    [TestCaseArea(@"Commanding\CoreCommanding")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.FullTrust)]
    public class CommandBindingMouseBindingMiddleButtonApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new CommandBindingMouseBindingMiddleButtonApp();
        ...
        public override object DoSetup(object sender) 
        {
            ...
            
            {
                ...
                _bCommandBindingEnabled = sampleCommand.CanExecute(null, null);
                CoreLogger.LogStatus("Command Binding constructed: Enabled? "+_bCommandBindingEnabled);

                // Set up mouse bindings
                MouseGesture gesture = new MouseGesture(MouseAction.MiddleClick);
        ...
        /// <summary>
        /// Store enabled-ness of command Binding.
        /// </summary>
        private bool _bCommandBindingEnabled;
    }
}
