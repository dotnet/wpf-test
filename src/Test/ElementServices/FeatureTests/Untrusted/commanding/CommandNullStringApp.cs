...
{
    /// <summary>
    /// Verify RoutedCommand can be created with a null string (null)
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify RoutedCommand can be created with a null string (null)")]
    [TestCasePriority("1")]
    [TestCaseArea(@"Commanding\Interfaces")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    public class CommandNullStringApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new CommandNullStringApp();
        ...
        public override object DoSetup(object sender)
        {
            ...
            try
            {
                _sampleCommand = new RoutedCommand(null, this.GetType(), null);
            }
            ...
            try
            {
                RoutedCommand sampleCommand2 = new RoutedCommand(null, this.GetType());
            }
            catch (ArgumentNullException)
            {
