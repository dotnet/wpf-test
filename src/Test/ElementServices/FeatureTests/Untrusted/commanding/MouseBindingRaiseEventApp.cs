...
{
    /// <summary>
    /// Verify MouseBinding can be executed by RaiseEvent on element.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify MouseBinding can be executed by RaiseEvent on element.")]
    [TestCasePriority("2")]
    [TestCaseArea(@"Commanding\CoreCommanding")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.FullTrust)]
    public class MouseBindingRaiseEventApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new MouseBindingRaiseEventApp();
        ...
        public override object DoSetup(object sender)
        {
            ...
            MouseGesture gesture = new MouseGesture(MouseAction.RightDoubleClick);
