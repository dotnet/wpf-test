...
{
    /// <summary>
    /// Verify RoutedCommand QueryEnabled fails for invalid input element.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify RoutedCommand QueryEnabled fails for invalid input element.")]
    [TestCasePriority("2")]
    [TestCaseArea(@"Commanding\CoreCommanding")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    public class QueryEnabledInvalidInputElementApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new QueryEnabledInvalidInputElementApp();
        ...
        protected override object DoExecute(object arg)
        {
            ...
            try
            {
                bool bQueryEnabledAPI = s_sampleCommand.CanExecute(null, null);
            }
            ...
            try
            {
                bool bQueryEnabledNonNullAPI = s_sampleCommand.CanExecute(null, dio);
            }
