...
{
    /// <summary>
    /// Verify MouseBinding from default gestures works for ContentElement in window.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify MouseBinding from default gestures works for ContentElement in window.")]
    [TestCasePriority("2")]
    [TestCaseArea(@"Commanding\CoreCommanding")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.FullTrust)]
    public class MouseBindingFromDefaultsContentElementApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new MouseBindingFromDefaultsContentElementApp();
        ...
        public override object DoSetup(object sender)
        {
            ...
            InputGestureCollection igc = new InputGestureCollection(new InputGesture[] 
            {
                gesture
            });
