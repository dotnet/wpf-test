...
{
    /******************************************************************************
    * CLASS:          InputGestureCollectionICollectionApp
    ******************************************************************************/
    /// <summary>
    /// Verify InputGestureCollection ICollection APIs work as expected.
    /// </summary>
    /// <description>
    ...
    /// <
    [Test(1, "Commanding.Collections", TestCaseSecurityLevel.FullTrust, "InputGestureCollectionICollectionApp")]
    public class InputGestureCollectionICollectionApp : TestApp
    {
        #region Private Data
        ...
        private InputGesture _firstItem;
        private object[] _objectArray;
        private InputGesture[] _itemArray;
        ...
        #region Constructor
        /******************************************************************************
        * Function:          InputGestureCollectionICollectionApp Constructor
        ******************************************************************************/
        public InputGestureCollectionICollectionApp() :base()
        {
            GlobalLog.LogStatus("In InputGestureCollectionICollectionApp constructor");
        ...
        ******************************************************************************/
        ...
        protected override object DoExecute(object sender) {
            ...
            GlobalLog.LogStatus("Adding gesture to collection...");
            _firstItem = new KeyGesture(Key.Add);
            ((InputGestureCollection)(_itemList)).Add(_firstItem);
        ...
        ******************************************************************************/
        ...
        {
            CoreLogger.BeginVariation("InputGestureCollectionICollectionApp");
