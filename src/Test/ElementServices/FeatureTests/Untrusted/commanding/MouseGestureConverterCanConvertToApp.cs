...
{
    /// <summary>
    /// Verify MouseGestureConverter CanConvertTo method.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify MouseGestureConverter CanConvertTo.")]
    [TestCasePriority("1")]
    [TestCaseArea(@"Commanding\TypeConverter")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.FullTrust)]
    public class MouseGestureConverterCanConvertToApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new MouseGestureConverterCanConvertToApp();
        ...
        public override object DoSetup(object sender) 
        {
            ...
            _typeDescriptorContext = new TestTypeDescriptorContext(pc, new MouseGesture(MouseAction.LeftClick));
            return null;
        }
