...
{
    /// <summary>
    /// Verify MouseBinding from default gestures works for UI Element in window.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify MouseBinding from default gestures works for UI Element in window.")]
    [TestCasePriority("2")]
    [TestCaseArea(@"Commanding\CoreCommanding")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.FullTrust)]
    public class MouseBindingFromDefaultsApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new MouseBindingFromDefaultsApp();
