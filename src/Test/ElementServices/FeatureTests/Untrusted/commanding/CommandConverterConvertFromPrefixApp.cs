...
namespace Avalon.Test.CoreUI.Commanding
{
    ...
    [TestCaseTitle(@"Verify CommandConverter ConvertFrom method for standard commands with prefix.")]
    [TestCasePriority("2")]
    [TestCaseArea(@"Commanding\TypeConverter")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("1")]
    public class CommandConverterConvertFromPrefixApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new CommandConverterConvertFromPrefixApp();
        ...
        public override object DoValidate(object arg) 
        {
            ...
            RoutedCommand actualCommand = (_converter.ConvertFrom( _typeDescriptorContext, CultureInfo.InvariantCulture,
                                     "cmd:ApplicationCommands.Copy")) as RoutedCommand;

            CoreLogger.LogStatus("Command found? " + (actualCommand!=null));

            RoutedCommand actual = (actualCommand);
            RoutedCommand expected = (ApplicationCommands.Copy);
