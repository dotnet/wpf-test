...
{
    /// <summary>
    /// Verify RegisterClassCommandBinding can be registered without type information.
    /// </summary>
    /// <description>
    ...
    [TestCaseDisabled("1")]
    [TestCaseTitle(@"Verify RegisterClassCommandBinding can be registered without type information.")]
    public class CommandManagerRegisterClassCommandBindingsGlobalApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new CommandManagerRegisterClassCommandBindingsGlobalApp();
        ...
        public override object DoSetup(object sender) 
        {
            ...
            
            {
                ...
                CommandManager.RegisterClassCommandBinding(null, _sampleCommandBinding);
                //CommandManager.RegisterClassCommandBinding(typeof(Object), _sampleCommandBinding).
