...
{
    /******************************************************************************
    * CLASS:          CommandManagerInvalidateStatusMouseInputApp
    ******************************************************************************/
    /// <summary>
    /// Verify CommandManager StatusInvalidated works for element on mouse input.
    /// </summary>
    /// <description>
    ...
    [Test(0, "Commanding.CoreCommanding", TestCaseSecurityLevel.FullTrust, "CommandManagerInvalidateStatusMouseInputApp")]
    public class CommandManagerInvalidateStatusMouseInputApp : TestApp
    {
        #region Private Data
        ...
        /******************************************************************************
        * Function:          CommandManagerInvalidateStatusMouseInputApp Constructor
        ******************************************************************************/
        public CommandManagerInvalidateStatusMouseInputApp(string arg)
        {
            GlobalLog.LogStatus("In CommandManagerInvalidateStatusMouseInputApp constructor");
            _hostTypeStr = arg;
        ...
        ******************************************************************************/
        TestResult StartTest()
        {
            ...
            TestApp app = new CommandManagerInvalidateStatusMouseInputApp(_hostTypeStr);
        ...
        ******************************************************************************/
        ...
        {
            GlobalLog.LogStatus("Invoking Click ...");
