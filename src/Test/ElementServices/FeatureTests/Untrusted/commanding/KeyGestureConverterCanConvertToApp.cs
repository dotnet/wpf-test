...
{
    /// <summary>
    /// Verify KeyGestureConverter CanConvertTo method.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify KeyGestureConverter CanConvertTo.")]
    [TestCasePriority("1")]
    [TestCaseArea(@"Commanding\TypeConverter")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    public class KeyGestureConverterCanConvertToApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new KeyGestureConverterCanConvertToApp();
        ...
        public override object DoSetup(object sender) 
        {
            ...
            _typeDescriptorContext = new TestTypeDescriptorContext(pc, new KeyGesture(Key.F8, ModifierKeys.Control));
            return null;
        }
