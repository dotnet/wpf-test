...
{
    /// <summary>
    /// Verify MouseActionConverter CanConvertFrom method.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify MouseActionConverter CanConvertFrom.")]
    [TestCasePriority("1")]
    [TestCaseArea(@"Commanding\TypeConverter")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    public class MouseActionConverterCanConvertFromApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new MouseActionConverterCanConvertFromApp();
