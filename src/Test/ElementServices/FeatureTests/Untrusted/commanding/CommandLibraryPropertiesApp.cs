...
{
    /// <summary>
    /// Verify properties of commands in command library are set correctly on initialization.
    /// </summary>
    /// <description>
    /// This is part of a collection of unit tests for commanding.
    /// </description>
    /// <remarks>
    /// NavigationWindow and Browser surfaces are not covered by this test.
    /// </remarks>
    /// <author>Microsoft</author>
 
    [CoreTestsLoader(CoreTestsTestType.MethodBase)]
    public class CommandLibraryPropertiesApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        [TestCase("2", @"Commanding\Library", "HwndSource", TestCaseSecurityLevel.FullTrust, @"Compile and Verify properties of commands in command library are set correctly on initialization in HwndSource.")]
        [TestCase("2", @"Commanding\Library", "Window", TestCaseSecurityLevel.FullTrust, @"Compile and Verify properties of commands in command library are set correctly on initialization in window.")]
        ...
        /// Launch our test.
        /// </summary>
        [TestCase("1", @"Commanding\Library", "HwndSource", TestCaseSecurityLevel.FullTrust, @"Verify properties of commands in command library are set correctly on initialization in HwndSource.")]
        [TestCase("1", @"Commanding\Library", "Window", TestCaseSecurityLevel.FullTrust, @"Verify properties of commands in command library are set correctly on initialization in window.")]
        public static void LaunchTest()
        {
            HostType hostType = (HostType)Enum.Parse(typeof(HostType), DriverState.DriverParameters["TestParameters"]);

            ExeStubContainerFramework exe = new ExeStubContainerFramework(hostType);
            exe.Run(new CommandLibraryPropertiesApp(), "Run");
        }
        ...
        public override object DoSetup(object sender)
        {
            ...
            // Get prepared to mark all these commands as enabled upon a query
        ...
        public override object DoValidate(object sender)
        {
            ...
            // CanExecute, DeclaringType, Name
            // CanExecute is true if element has the focus and command binding has an Execute handler, false otherwise.
