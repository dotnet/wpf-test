...
{
    /// <summary>
    /// Verify SecureUICommand does not throw exception when executed directly in partial trust.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify SecureUICommand does not throw exception when executed directly in partial trust.")]
    [TestCasePriority("1")]
    [TestCaseArea(@"Commanding\Security")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.PartialTrust)]
    public class SecureCommandExecutePartialTrustApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new SecureCommandExecutePartialTrustApp();
        ...
        public override object DoValidate(object sender)
        {
            ...
            // We expect attached command binding to be invoked successfully.
