...
{
    /// <summary>
    /// Verify UICommand does not throw exception when executed directly in partial trust.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify UICommand does not throw exception when executed directly in partial trust.")]
    [TestCasePriority("1")]
    [TestCaseArea(@"Commanding\Security")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.PartialTrust)]
    public class UICommandExecutePartialTrustApp : TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest()
        {
            ...
            TestApp app = new UICommandExecutePartialTrustApp();
