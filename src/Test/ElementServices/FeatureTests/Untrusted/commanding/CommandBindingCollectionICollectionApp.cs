...
{
    /******************************************************************************
    * CLASS:          CommandBindingCollectionICollectionApp
    ******************************************************************************/
    /// <summary>
    /// Verify CommandBindingCollection ICollection APIs work as expected.
    /// </summary>
    /// <description>
    ...
    /// <
    [Test(0, "Commanding.Collections", TestCaseSecurityLevel.FullTrust, "CommandBindingCollectionICollectionApp")]
    public class CommandBindingCollectionICollectionApp : TestApp
    {
        #region Private Data
        ...
        private CommandBinding[] _itemArray;
        ...
        #region Constructor
        /******************************************************************************
        * Function:          CommandBindingCollectionICollectionApp Constructor
        ******************************************************************************/
        public CommandBindingCollectionICollectionApp() :base()
        {
            GlobalLog.LogStatus("In CommandBindingCollectionICollectionApp constructor");
        ...
        ******************************************************************************/
        ...
        public override object DoSetup(object sender) 
        {
            ...
            CommandBindingCollection igc = new CommandBindingCollection();
        ...
        ******************************************************************************/
        ...
        protected override object DoExecute(object sender) {
            ...
            ((CommandBindingCollection)(_itemList)).Add(_firstItem);
            ...
            _itemArray = new CommandBinding[0];
            try
            {
                _itemList.CopyTo(_itemArray, 0);
            }
            ...
            _itemArray = new CommandBinding[1];
            _itemList.CopyTo(_itemArray, 0);
        ...
        ******************************************************************************/
        ...
        {
            CoreLogger.BeginVariation("CommandBindingCollectionICollectionApp");
        ...
        public static RoutedCommand SampleCommand
        {
            get
            {
                ...
                {
                    s_sampleCommand = new RoutedCommand("Sample", typeof(CommandBindingCollectionICollectionApp), null);
                }
