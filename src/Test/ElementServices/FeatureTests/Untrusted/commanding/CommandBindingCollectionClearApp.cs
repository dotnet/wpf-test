...
{
    /// <summary>
    /// Verify CommandBindingCollection Clear works for element with multiple CommandBindings to same Command.
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify CommandBindingCollection Clear works for element with multiple CommandBindings to same Command.")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.FullTrust)]
    public class CommandBindingCollectionClearApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new CommandBindingCollectionClearApp();
        ...
        public override object DoSetup(object sender) 
        {
            ...
            
            {
                ...
                {
                    // Create the link
                    sampleCommandBinding[i] = new CommandBinding(sampleCommand);
                    ...
                    CommandBindingCollection bindings = _rootElement.CommandBindings;
                    bindings.Add(sampleCommandBinding[i]);

                    // Re-insert element
                    bindings[bindings.Count-1] = sampleCommandBinding[i]; 
                }
            }
        ...
        private void DoBeforeExecute() 
        {
            ...
            _rootElement.CommandBindings.Clear();
        }
