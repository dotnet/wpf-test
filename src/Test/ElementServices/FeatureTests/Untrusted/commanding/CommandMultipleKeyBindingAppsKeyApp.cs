...
{
    /// <summary>
    /// Verify RoutedCommand with multiple command links with non-conflicting Apps key binding (no Defaults)
    /// </summary>
    /// <description>
    ...
    [TestCaseTitle(@"Verify RoutedCommand with multiple command links with non-conflicting Apps key binding (no Defaults)")]
    [TestCasePriority("2")]
    [TestCaseArea(@"Commanding\CoreCommanding")]
    [TestCaseMethod("LaunchTest")]
    [TestCaseDisabled("0")]
    [TestCaseSecurityLevel(TestCaseSecurityLevel.FullTrust)]
    public class CommandMultipleKeyBindingAppsKeyApp: TestApp
    {
        /// <summary>
        /// Launch our test.
        /// </summary>
        public static void LaunchTest() 
        {
            ...
            TestApp app = new CommandMultipleKeyBindingAppsKeyApp();
        ...
        public override object DoSetup(object sender) 
        {
            ...
            
            {
                ...
                igc.Add (new KeyGesture(Key.Apps, ModifierKeys.None));
                igc.Add (new KeyGesture(Key.F2, ModifierKeys.Control));
