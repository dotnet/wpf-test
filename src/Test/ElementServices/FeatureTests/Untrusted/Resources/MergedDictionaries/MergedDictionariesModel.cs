...
namespace Avalon.Test.CoreUI.Resources.MergedDictionaries
{
    ...
    SupportFiles = @"FeatureTests\ElementServices\MergedDictionariesModel_empty.xaml,
                    FeatureTests\ElementServices\MergedDictionariesModel_elements.xaml,
                    FeatureTests\ElementServices\MergedDictionariesModelExternal_empty.xaml",
    ...
    public class MergedDictionariesModel : CoreModel
    {
        ...
        private void _RunXamlBasedTest()
        {
            ...
            try
            {
                ...
                {
                    // Compile route.                    
                    CoreLogger.LogStatus("XamlCompile route disabled... ");
    ...
    [Serializable()]
    class MergedDictionariesModelState : CoreState
    {        
        public MergedDictionariesModelState(CoreState coreState)
        {
        ...
        {
            get { return Dictionary["ExternalDicts"]; }
        }
        public string InternalDicts
        {
            get { return Dictionary["InternalDicts"]; }
        }
        public string DuplicateKey
        {
            get { return Dictionary["DuplicateKey"]; }
        }
        public string ExternalKeys
        {
            get { return Dictionary["ExternalKeys"]; }
        }
        public string InternalKeys
        {
            get { return Dictionary["InternalKeys"]; }
        }
        public string ResourceLocation
        {
            get { return Dictionary["ResourceLocation"]; }
        }
        public string ResourceType
        {
            get { return Dictionary["ResourceType"]; }
        }
        public string KeyLookup
        {
            get { return Dictionary["KeyLookup"]; }
        }
    }
}
