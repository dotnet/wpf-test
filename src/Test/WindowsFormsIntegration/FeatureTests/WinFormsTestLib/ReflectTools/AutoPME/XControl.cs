    ...
    public abstract class XControl : XComponent
    {
        ...
        protected AccessibleRole GetDefaultAccessibleRoleForType(Type t)
        {
            ...
            //Note: these types are requirements in certain tests, and aren't in the libs.
                ...
                throw new ArgumentException("Type " + t.ToString() + " default role not defined.  Please add expected default to the XControl class. Contact Microsoft for details on what the correct default accessible role should be or see the control reference at http://www.msdn.microsoft.com/library/default.asp?url=/library/en-us/msaa/msaapndx_4erc.asp");
            return ar;
        }
        /**
         * ==================================================
...
//			new SecurityPermission(PermissionState.Unrestricted).Assert();
        ...
        protected virtual ScenarioResult get_AllowDrop(TParams p)
        {
			...
			try
			{
				...
				{
					// Make sure SecurityExceptions propagate up
...
#pragma warning disable 618 // 618 = Obsolete
        protected virtual void ScaleHelper(TParams p, ScaleMethod which, out ScenarioResult result)
        {
            ...
            // due to a bug resolution - "round-off impercision is by Design"
...
#pragma warning restore 618 // 618 = Obsolete
        ...
        protected virtual ScenarioResult get_UseWaitCursor(TParams p)
        {
            ...
            result.IncCounters(_c.Cursor.Equals(origCursor), p.log, BugDb.VSWhidbey, 142284, "Didn't preserve Cursor in process of changing UseWaitCursor ");
            ...
            result.IncCounters(_c.Cursor.Equals(Cursors.WaitCursor), p.log, BugDb.VSWhidbey, 142284, "Cursor didn't return WaitCursor after setting to random cursor when UseWaitCursor = true");
