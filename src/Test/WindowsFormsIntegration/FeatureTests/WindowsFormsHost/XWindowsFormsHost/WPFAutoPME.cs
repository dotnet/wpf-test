...
namespace ReflectTools
{
    ...
    //      ---------------------------------------------------
    //              WindowsFormsHost        XWindowsFormsHost
    //      extends HwndHost                XHwndHost
    //      extends FrameworkElement        XFrameworkElement
    //      extends UIElement               XUIElement
    //      extends Visual                  XVisual            
    //      extends DependencyObject        XDependencyObject                
    //      extends DispatcherObject        XDispatcherObject              
    //      extends Object                  XObject                 
    //      extends                         WPFAutoTest                **
    //      extends                         WPFAutoPME                 **
    //      extends                         WPFReflectBase             **
    //      extends                         Window
    //
    ...
    public abstract class WPFAutoPME : WPFReflectBase
    {
        ...
        // </desc>
        // </doc>
        protected static bool AddElementToForm = true;
        ...
        protected override void InitTest(TParams p)
        {
            ...
            System.Drawing.Size maxSize = new System.Drawing.Size(1024, 768);         // Max size of the form
        ...
        // </param>
        // <retvalue>
        //   Returns true if the target is a FrameworkElement, false otherwise.
        // </retvalue>
        // </doc>
        // SECURITY
        protected bool AddObjectToForm(TParams p)
        {
            if (!AddElementToForm || !(p.target is FrameworkElement))
                return false;

            FrameworkElement c = (FrameworkElement)p.target;

            //if (SafeMethods.GetParent(c) == null)
            if(true)
            {
                // figure out a random location for this control in the client area
                //System.Drawing.Point pLocation = c.;
        ...
        protected override ArrayList CreateScenarioGroups(MethodInfo[] scenarios)
        {
            ...
            while (currentTestType != null)
            {
                ...
                if (AutoTestOnly && currentTestType != typeof(WPFAutoTest))
                {
                    if (currentType != null)
        ...
        private bool IsChildOfThisForm(Object o)
        {
            ...
            {
                FrameworkElement c = (FrameworkElement)o;
        ...
        protected override void TestEngine(TParams p)
        {
            try
            {
                ...
                if ((!(p.target is Window)) && AddElementToForm)
                    AddObjectToForm(p);
