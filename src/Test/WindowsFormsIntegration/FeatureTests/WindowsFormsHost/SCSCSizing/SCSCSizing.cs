...
public class SCSCSizing : WPFReflectBase
{
    ...
    public class Win : Window
    {
        ...
        public Win()
        {
            ...
            {
                cal.CalendarDimensions = oof ? new SD.Size(1, 1) : new SD.Size(2, 2);
                oof ^= true;
            };
            ...
            host.SetValue(Canvas.LeftProperty, 25d);
            host.SetValue(Canvas.TopProperty, 30d);
            ...
            cal = new SWF.MonthCalendar();
            cal.AutoSize = false;
            cal.CalendarDimensions = new System.Drawing.Size(2, 2);
            wfh.Child = cal;
