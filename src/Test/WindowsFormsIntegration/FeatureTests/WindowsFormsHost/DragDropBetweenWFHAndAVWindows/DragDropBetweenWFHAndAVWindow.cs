...
namespace WindowsFormsHostTests
{
    public class DragDropBetweenWFHAndAVWindows : WPFReflectBase
    {
        ...
        private void TestSetup()
        {
            ...
            #region LayoutWindow
            _AVWindow.Title = _AVWindow.Name = AVWindowTitleName;
            _AVWindow.Content = _AVTextBox;
            _AVWindow.SizeToContent = SW.SizeToContent.WidthAndHeight;
            _AVWindow.Top = 0;
            _AVWindow.Left = 400;
            _AVWindow.Show();
