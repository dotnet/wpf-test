...
namespace WindowsFormsHostTests
{
    public class EventOrdering : WPFReflectBase
    {
        ...
        public ScenarioResult Scenario1(TParams p)
        {
            ...
            // Note about "ChangeUICues" message - Windows OS Regression_Bug26 "By Design"
        ...
        public ScenarioResult Scenario2(TParams p)
        {
            ...
            // Note: VSWhidbey Regression_Bug27 used to happen here
        ...
        [Scenario("WindowsOS Regression_Bug28 - Verify Winforms Controls can still get Validating/Validated messages")]
        ...
        // can remove if is no longer useful
...
//@ WindowsOS Regression_Bug28 - Verify Winforms Controls can still get Validating/Validated messages
