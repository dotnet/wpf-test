...
namespace WindowsFormsHostTests
{
    public class PropertyMappingsActiveX : WPFReflectBase
    {
        ...
        // class vars
        private DockPanel _dp;                        // our Dockpanel
        private Button _avBtn;                        // our Avalon button
        private WindowsFormsHost _wfh;                // our Windows Forms Host control
        ...
        private static SolidColorBrush s_brBlack = Brushes.Black;
        private static SolidColorBrush s_brWhite = Brushes.White;
        ...
        private void TestMappedProperty(ScenarioResult sr, TParams p, string prop, VerifyMappingDelegate VerFunc)
        {
            ...
            bool bExists = _wfh.PropertyMap.Contains(prop);
        ...
        private static MyBackgroundType[] s_myBackgroundList = {
            ...
            new MyBackgroundType("Solid Yellow", s_brYellow, System.Drawing.Color.Yellow, myBrushType.Solid),
            new MyBackgroundType("Solid Black", s_brBlack, System.Drawing.Color.Black, myBrushType.Solid),
            new MyBackgroundType("Solid White", s_brWhite, System.Drawing.Color.White, myBrushType.Solid),
        };
        ...
        private void VerifyMappingBackground(ScenarioResult sr, TParams p, WindowsFormsHost wfh, bool bIsMapped)
        {
            ...
            System.Windows.Media.Brush origBackBtn = _avBtn.Background;
            ...
            foreach (MyBackgroundType bt in s_myBackgroundList)
            {
                ...
                _avBtn.Background = bt.avalonBack;
                MyPause();
        ...
        checkedFonts.Add("Wingdings");
            ...
            _avBtn.FontFamily = origHostFamily;
            MyPause();
        ...
        private void VerifyMappingFontStyle(ScenarioResult sr, TParams p, WindowsFormsHost wfh, bool bIsMapped)
        {
            ...
            foreach (MyFontStyleType curStyle in s_myFontStyleList)
            {
                ...
                _avBtn.FontStyle = curStyle.avalon;
                MyPause();
            ...
            _avBtn.FontStyle = origHostStyle;
            MyPause();
        ...
        private void VerifyMappingFontWeight(ScenarioResult sr, TParams p, WindowsFormsHost wfh, bool bIsMapped)
        {
            ...
            foreach (MyFontWeightType curWeight in s_myFontWeightList)
            {
                ...
                _avBtn.FontWeight = curWeight.avalon;
                MyPause();
            ...
            _avBtn.FontWeight = origHostWeight;
            MyPause();
        ...
        private void VerifyMappingForeground(ScenarioResult sr, TParams p, WindowsFormsHost wfh, bool bIsMapped)
        {
            ...
            System.Windows.Media.Brush origForeBtn = _avBtn.Foreground;
            ...
            foreach (MyForegroundType bt in s_myForegroundList)
            {
                ...
                _avBtn.Foreground = bt.avalonFore;
                MyPause();
        ...
        private void VerifyMappingIsEnabled(ScenarioResult sr, TParams p, WindowsFormsHost wfh, bool bIsMapped)
        {
            ...
            _avBtn.IsEnabled = origIsEnabled;
            MyPause();
        ...
        private void VerifyMappingVisibility(ScenarioResult sr, TParams p, WindowsFormsHost wfh, bool bIsMapped)
        {
            ...
            _avBtn.Visibility = origVisibility;
            MyPause();
