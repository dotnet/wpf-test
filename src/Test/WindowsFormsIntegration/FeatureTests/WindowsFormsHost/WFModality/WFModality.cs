...
public class WFModality : WPFReflectBase
{
    ...
    {
        winForm1 = new WinForm();
        winForm1.Name = "WinForm2";
        winForm1.Text = "WinForm2";
        winForm1.Location = new System.Drawing.Point(300, 0);
        winForm1.ShowDialog();
    }
    ...
    public ScenarioResult Scenario1(TParams p)
    {
        ...
        Utilities.SleepDoEvents(20);
        WPFMiscUtils.IncCounters(sr, p.log, BitmapsColorPercent(bmp, 0, 0, 300, 300, SD.SystemColors.Control) >= 60,
            "Bitmap Failed at Color=" + SD.SystemColors.Control + ". Percent match: " +
            BitmapsColorPercent(bmp, 0, 0, 300, 300, SD.SystemColors.Control) + "%");
        ...
        bmp = Utilities.GetScreenBitmap(new Rectangle(0, 0, 300, 300));
        Utilities.SleepDoEvents(20);
        WPFMiscUtils.IncCounters(sr, p.log, BitmapsColorPercent(bmp, 0, 0, 300, 300, SD.SystemColors.Control) <= 40,
            "Bitmap Failed at Color=" + SD.SystemColors.Control + ". Percent match: " +
            BitmapsColorPercent(bmp, 0, 0, 300, 300, SD.SystemColors.Control) + "%");
    ...
    public ScenarioResult Scenario2(TParams p)
    {
        ...
        WPFMiscUtils.IncCounters(sr, p.log, BitmapsColorPercent(bmp, 0, 0, 300, 300, SD.SystemColors.Control) >= 60,
            ...
            ". Percent match: " + BitmapsColorPercent(bmp, 0, 0, 300, 300, SD.SystemColors.Control) + "%");
        ...
        bmp = Utilities.GetScreenBitmap(new Rectangle(0, 0, 300, 300));
        Utilities.SleepDoEvents(20);
        WPFMiscUtils.IncCounters(sr, p.log, BitmapsColorPercent(bmp, 0, 0, 300, 300, SD.SystemColors.Control) < 76,
    ...
    public class WinForm : SWF.Form
    {
        ...
        public WinForm()
        {
            ...
            // wfButton1
            // 
            this.wfButton1.Location = new System.Drawing.Point(95, 63);
            this.wfButton1.Name = "wfButton1";
            this.wfButton1.Text = "Close Window";
            this.wfButton1.AutoSize = true;
            this.wfButton1.Size = new System.Drawing.Size(100, 20);
            this.wfButton1.Click += new EventHandler(wfButton1_Click);
            // 
            // wfButton2
            // 
            this.wfButton2.Location = new System.Drawing.Point(95, 103);
            this.wfButton2.Name = "wfButton2";
            this.wfButton2.Text = "Launch WF Form";
            this.wfButton2.AutoSize = true;
            this.wfButton2.Size = new System.Drawing.Size(100, 20);
            this.wfButton2.Click += new EventHandler(wfButton2_Click);
            //
            // wfTextBox1
            //
            this.wfTextBox1.Name = "wfTextBox1";
            this.wfTextBox1.Location = new System.Drawing.Point(10, 150);
            this.wfTextBox1.Size = new System.Drawing.Size(250, 50);
            this.wfTextBox1.WordWrap = true;
            //
            // winform
            // 
            ...
            this.Controls.Add(this.wfButton1);
            this.Controls.Add(this.wfButton2);
