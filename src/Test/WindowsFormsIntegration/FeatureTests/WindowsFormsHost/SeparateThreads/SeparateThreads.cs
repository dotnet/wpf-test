...
namespace WindowsFormsHostTests
{
    public class SeparateThreads : WPFReflectBase {
        ...
        //==========================================
        #region Scenarios
        [Scenario("Verifty that an Avalon App can spawn a new thread with a new Avalon Window that contains a WFH and WF control - does it ---- up?")]
...
//
// [Scenarios]
//@ Verifty that an Avalon App can spawn a new thread with a new Avalon Window that contains a WFH and WF control - does it ---- up?
