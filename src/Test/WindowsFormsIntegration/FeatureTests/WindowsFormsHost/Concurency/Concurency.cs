...
public class Concurency : WPFReflectBase
{
    ...
    // class vars
    private CountObj co = new CountObj();
    private People ppl;
    private ListBox avLB;                           // used in Scenarios 2,3,4
    private System.Windows.Forms.ListBox wfLB;      // used in Scenarios 2,3,4
    private System.Windows.Forms.ListBox wfLB1;     // used in Scenarios 5,6,7
    private System.Windows.Forms.ListBox wfLB2;     // used in Scenarios 5,6,7
    ...
    public ScenarioResult Scenario1(TParams p)
    {
        ...
        wfTB.DataBindings.Add(new System.Windows.Forms.Binding("Text", co, "Count", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
    ...
    public ScenarioResult Scenario2(TParams p)
    {
        ...
        p.log.WriteLine("Before:");
        p.log.WriteLine("Winforms Listbox: '{0}'", GetWinformsListboxContents(wfLB));
        ...
        WPFMiscUtils.IncCounters(sr, expList, GetWinformsListboxContents(wfLB), 
    ...
    public ScenarioResult Scenario5(TParams p)
    {
        ...
        p.log.WriteLine("Before:");
        p.log.WriteLine("Winforms Listbox 1: '{0}'", GetWinformsListboxContents(wfLB1));
        p.log.WriteLine("Winforms Listbox 2: '{0}'", GetWinformsListboxContents(wfLB2));
        ...
        // verify results
        string expList = "Scott-56:Bill-81:Nate-106:";
        WPFMiscUtils.IncCounters(sr, expList, GetWinformsListboxContents(wfLB1),
            "WinForms ListBox 1 Items not as expected", p.log);
        WPFMiscUtils.IncCounters(sr, expList, GetWinformsListboxContents(wfLB2),
    ...
    private void SetupAvalonWinformsListboxes()
    {
        ...
        avLB = new ListBox();
        avLB.Name = "avLB";
        dp.Children.Add(avLB);

        // WinForms ListBox
        wfLB = new System.Windows.Forms.ListBox();
        wfLB.Name = "wfLB";
    ...
    private void SetupWinformsWinformsListboxes()
    {
        ...
        // WinForms ListBox 1
        wfLB1 = new System.Windows.Forms.ListBox();
        wfLB1.Name = "wfLB1";
        ...
        // WinForms ListBox 2
        wfLB2 = new System.Windows.Forms.ListBox();
        wfLB2.Name = "wfLB2";
        ...
        // add data binding for WF
        // bind datasource of ListBox to "ppl" list object
        wfLB1.DataSource = ppl;
        wfLB2.DataSource = ppl;
    ...
    private void CreateListData()
    {
        ...
        ppl = new People();
        ppl.Add(new Person("Scott", 55));
        ppl.Add(new Person("Bill", 80));
        ppl.Add(new Person("Nate", 105));
    }
    ...
    {
        string list = "";
        foreach (Person per in avLB.Items)
        {
            list += per.Name;
            list += "-";
            list += per.Speed;
    ...
    void Perform_Add()
    {
        ppl.Add(new Person("Bob" + ppl.Count.ToString(), ppl.Count * 10));
    }
