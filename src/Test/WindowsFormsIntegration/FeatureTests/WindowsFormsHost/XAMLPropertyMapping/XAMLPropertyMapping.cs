...
public class XAMLPropertyMapping : WPFReflectBase
{
    ...
    private static MyMapType[] MyAllowDropList = {
    ...
    private void CheckPropertyAllowDrop(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyAllowDropList)
        {
    ...
    private static MyMapType[] MyBackgroundList = {
    ...
    private void CheckPropertyBackground(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyBackgroundList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
        ...
        // Whew.  All that to get a part of a single Scenario working.  Sigh.  a-wboyde 3/27/06
    ...
    private static MyMapType[] MyCursorList = {
    ...
    private void CheckPropertyCursor(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyCursorList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyFlowDirectionList = {
    ...
    private void CheckPropertyFlowDirection(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyFlowDirectionList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyFontStyleList = {
    ...
    private void CheckPropertyFontStyle(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyFontStyleList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyFontWeightList = {
    ...
    private void CheckPropertyFontWeight(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyFontWeightList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyFontFamilyList = {
    ...
    private void CheckPropertyFontFamily(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyFontFamilyList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyFontSizeList = {
    ...
    private void CheckPropertyFontSize(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyFontSizeList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyForceCursorList = {
    ...
    private void CheckPropertyForceCursor(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyForceCursorList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    // (this is only valid for properties defined (in XAML) *not* using "Static Resources" - see below)
    private static MyMapType[] MyForegroundList = {
    ...
    private void CheckPropertyForeground(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyForegroundList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyIsEnabledList = {
    ...
    private void CheckPropertyIsEnabled(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyIsEnabledList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyIsVisibleList = {
    ...
    private void CheckPropertyIsVisible(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyIsVisibleList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyPaddingList = {
    ...
    private void CheckPropertyPadding(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyPaddingList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
    ...
    private static MyMapType[] MyVisibilityList = {
    ...
    private void CheckPropertyVisibility(TParams p, ScenarioResult sr, Window w)
    {
        ...
        foreach (MyMapType curType in MyVisibilityList)
        {
            p.log.WriteLine("Checking '{0}' for '{1}' ({2})",
                curType.hostName, curType.propValue.ToString(), curType.propValue.GetType());
