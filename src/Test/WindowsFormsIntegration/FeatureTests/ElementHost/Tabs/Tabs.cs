...
public class Tabs : ReflectBase {
    ...
    public ScenarioResult Scenario1(TParams p) {
        ...
        try
        {
            ...
            _sr.IncCounters(edAvTextBox1.HasKeyboardFocus, p.log, BugDb.WindowsOSBugs, 9, "AVTextBox1 did not receive keyboard focus");
            ...
            _sr.IncCounters(uiAvButton2.HasKeyboardFocus, p.log, BugDb.WindowsOSBugs, 9, "AVButton2 did not receive keyboard focus");
        }
        catch (Exception ex)
        {
