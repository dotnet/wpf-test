...
public class Tabs : ReflectBase {
    ...
    TabsUserControl.UserControl1 uc = new TabsUserControl.UserControl1();
    ElementHost host = new ElementHost();
    ScenarioResult sr = new ScenarioResult();
    System.Windows.Forms.TextBox wfTextBox1 = new TextBox();
    ...
    protected override bool BeforeScenario(TParams p, System.Reflection.MethodInfo scenario)
    {
        switch (scenario.Name)
        {
            case "Scenario1":
                ...
                uc.tb1.AcceptsTab = false;
                uc.tb1.IsTabStop = true;
                uc.tb2.IsTabStop = true;
                uc.bt2.IsTabStop = true;
            ...
            case "Scenario2":
                ...
                host.Child = uc;
                this.Controls.Add(host);
                this.Controls.Add(wfTextBox1);
                wfTextBox1.Name = "WFTextBox1";
                wfTextBox1.Text = "WFTextBox1";
                wfTextBox1.Top = 200;
                uc.tb1.AcceptsTab = false;
                uc.tb1.IsTabStop = true;
                uc.tb2.IsTabStop = true;
            ...
            case "Scenario4":
                ...
                uc.tb1.AcceptsTab = false;
                uc.tb1.IsTabStop = true;
                uc.tb2.IsTabStop = false;
                uc.bt2.IsTabStop = false;
                sr = new ScenarioResult();
                break;
    ...
    public ScenarioResult Scenario1(TParams p) {
        ...
        try
        {
            ...
            sr.IncCounters(edAvTextBox1.HasKeyboardFocus, p.log, BugDb.WindowsOSBugs, 1547068, "AVTextBox1 did not receive keyboard focus");
            ...
            sr.IncCounters(uiAvButton2.HasKeyboardFocus, p.log, BugDb.WindowsOSBugs, 1547068, "AVButton2 did not receive keyboard focus");
        }
        catch (Exception ex)
        {
    ...
    public ScenarioResult Scenario2(TParams p) {
        ...
        try
        {
            ...
            edAvButton2.SendKeys("{TAB}");
            sr.IncCounters(edWfTextBox1.HasKeyboardFocus, "(host.tabStop=false)WFTextBox1 did not receive keyboard focus", p.log);
    ...
    public ScenarioResult Scenario4(TParams p) {
        ...
        try
        {
            ...
            edAvTextBox1.SendKeys("{TAB}");
            sr.IncCounters(edAvButton1.HasKeyboardFocus, "AVButton1 did not receive keyboard focus", p.log);
            ...
            sr.IncCounters(edWfTextBox1.HasKeyboardFocus, "WFTextBox1 did not receive keyboard focus", p.log);
            //set focus to third av control
            edAvButton1.SetFocus();
            //shift-tab to the 'next' control - should skip AVTextBox2 and go to AVTextBox1
            edAvButton1.SendKeys("+{TAB}");
            sr.IncCounters(edAvTextBox1.HasKeyboardFocus, "AVTextBox1 did not receive keyboard focus", p.log);
        }
        catch (Exception ex)
        {
            p.log.WriteLine("Failed to Get Mita wrapper controls: " + ex.ToString());
    ...
    public ScenarioResult Scenario5(TParams p) {
        ...
        try
        {
            ...
            edAvTextBox1.SendKeys("^{TAB}");
            sr.IncCounters(edAvTextBox2.HasKeyboardFocus, "AVTextBox2 did not receive keyboard focus", p.log);
        }
        catch (Exception ex)
        {
            p.log.WriteLine("Failed to Get Mita wrapper controls: " + ex.ToString());
    ...
    public ScenarioResult Scenario8(TParams p) {
        ...
        try
        {
            ...
            //did we get focus?
            sr.IncCounters(uiAvTextBox1.HasKeyboardFocus, "AVTextBox1 did not receive keyboard focus", p.log);
        }
        catch (Exception ex)
        {
            p.log.WriteLine("Failed to Get Mita wrapper controls: " + ex.ToString());
    ...
    public ScenarioResult Scenario9(TParams p) {
        ...
        try
        {
            ...
            uiAvTextBox2.Click();
            Utilities.SleepDoEvents(2, 100);
            sr.IncCounters(uiAvTextBox2.HasKeyboardFocus, "AVTextBox2 did not receive keyboard focus", p.log);
            //click AVButton1, then see if we get focus
            uiAvButton1.Click();
            Utilities.SleepDoEvents(2, 100);
            sr.IncCounters(uiAvButton1.HasKeyboardFocus, "AVButton1 did not receive keyboard focus", p.log);
            //click AVButton2, then see if we get focus
            uiAvButton2.Click();
            Utilities.SleepDoEvents(2, 100);
            sr.IncCounters(uiAvButton2.HasKeyboardFocus, "AVButton2 did not receive keyboard focus", p.log);
            //click WFTextBox1, then see if we get focus
            uiWfTextBox1.Click();
            Utilities.SleepDoEvents(2, 100);
            sr.IncCounters(uiWfTextBox1.HasKeyboardFocus, "WFTextBox1 did not receive keyboard focus", p.log);
        }
        catch (Exception ex)
        {
            p.log.WriteLine("Failed to Get Mita wrapper controls: " + ex.ToString());
