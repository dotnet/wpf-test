...
namespace Microsoft.Test.Controls
{
    ...
    /// It covers some of following key types: all these should not cause directionalnavigation to work
    ...
    /// </summary>
    [Test(2, "KeyboardNavigation", "DirectionalNavigationTest")]
    public class DirectionalNavigationTest : DirectionalNavigationTestBase
    {
        ...
        public DirectionalNavigationTest(string fileName, FlowDirection rootElementFlowDirection, KeyboardNavigationMode keyboardNavigationMode, string from, string to, Key key)
