...
namespace WpfControlToolkit
{
    ...
    // 
    // This is probably the most useful Transition because it allows transitions to be fully specified in Xaml.
    // The most typical usage is to define an OpacityMask on one of the ContentPresenters via a Style and
    // animate it.
    //
