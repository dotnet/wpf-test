...
#region PrintDrtHost
    ...
    /// </summary>
    public abstract class PrintDrtHost
    {
        ...
        public void AddArgToSuite(String arg)
        {
            _suiteArgs.Add(arg);
        }

        public PrintDrtHost(string suiteName, string owner)
        {
        ...
        /// <code>
        ///     class DrtFixedPanel : PrintTestSuite {
        ///         public static int Main(String [] args) {
        ///             PrintDrtHost drt = new PrintDrtHost();
        ...
        /// <returns></returns>
        public virtual int LaunchDRT(String [] args)
        {
            if (ProcessCmdArgs(args))
            {
                ...
                if(_openWindow )
                {
                    ...
                    HwndSourceParameters param = new HwndSourceParameters("PrintDrtHost", windowWidth, windowHeight);
        ...
        {
            string file = PrintDrtFileDir + fileName;
        ...
        //---------------------------------------------------------------------
        public virtual bool ProcessCmdArgs(string [] args)
        {
        ...
        internal class Task
        {
            ...
            private Object                      _obj;
            private PrintDrtHost             _host;

            internal Task(PrintDrtHost host, DispatcherOperationCallback task, Object obj)
            {
                _task = task;
                _obj  = obj;
                _host = host;
    ...
    public abstract class PrintTestSuite : PrintDrtHost
    {
        public PrintTestSuite(string suiteName, string owner) : base(suiteName, owner)
        { }
