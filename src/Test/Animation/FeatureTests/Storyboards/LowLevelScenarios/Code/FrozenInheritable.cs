...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Storyboards.LowLevelScenarios.Regressions", "FrozenInheritableTest")]
    public class FrozenInheritableTest : XamlTest
    {

        #region Test case members

        private Run                 _animatedElement;
        ...
        /******************************************************************************
        * Function:          FrozenInheritableTest Constructor
        ******************************************************************************/
        public FrozenInheritableTest() : base(@"FrozenInheritable.xaml")
        {
        ...
        ******************************************************************************/
        ...
        {
            _animatedElement = (Run)LogicalTreeHelper.FindLogicalNode((Page)Window.Content,"run1");
