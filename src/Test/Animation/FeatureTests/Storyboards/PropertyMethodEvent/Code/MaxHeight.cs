...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Storyboards.PropertyMethodEvent.Regressions", "MaxHeightTest")]
    public class MaxHeightTest : XamlTest
    {

        #region Test case members

        private ListBoxItem         _animatedElement;
        ...
        /******************************************************************************
        * Function:          MaxHeightTest Constructor
        ******************************************************************************/
        public MaxHeightTest() : base(@"MaxHeight.xaml")
        {
        ...
        ******************************************************************************/
        ...
        {
            _animatedElement = (ListBoxItem)AnimationUtilities.FindElement(RootElement, "listboxitem1");
        ...
        {
            _resourceStoryboard = (Storyboard)RootElement.FindResource("EnterStoryboard");
