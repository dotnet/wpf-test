...
/* 
 * Description: Verify Pause/Seek/Resume on the same Tick - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBPauseSeekSlipExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBPauseSeekSlipExpect.txt file
...
{
    class SBPauseSeekSlip :ITimeBVT
    {
