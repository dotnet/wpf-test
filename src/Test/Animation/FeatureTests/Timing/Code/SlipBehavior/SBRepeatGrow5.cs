...
/* 
 * Description: Verify RepeatBehavior=Forever on the Sync Timeline having a NaturalDuration - Grow

*/

//Instructions:
//  1. Create a TimeManager
//  2. Create a Timeline tree, containing a parent Timeline and a child Timeline based on a Custom clock.
//  3. Create a Clock, associated with the parent Timeline
//  4. Start the TimeManager


//Pass Verification:
//  The output of this test should match the expected output in SBRepeatGrow5Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBRepeatGrow5Expect.txt file
    ...
    class SBRepeatGrow5 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            slipBegin           = 0d;
            slipDuration        = 0d;
            syncDurationTime    = TimeSpan.FromMilliseconds(5); //Simulating an implicit media Duration.
            ...
            syncTimeline.RepeatBehavior = RepeatBehavior.Forever;
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 101, 1, ref outString);
