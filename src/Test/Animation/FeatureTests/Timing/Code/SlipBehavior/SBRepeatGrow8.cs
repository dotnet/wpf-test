...
/* 
 * Description: Verify RepeatBehavior=Forever with a deeper level - sync also repeats - Grow
 */
...
//Pass Verification:
//  The output of this test should match the expected output in SBRepeatGrow8Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBRepeatGrow8Expect.txt file
    ...
    class SBRepeatGrow8 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            syncTimeline1.RepeatBehavior = new RepeatBehavior(2d);
