...
/* 
 * Description: Verify Pause() then Begin() inside a Slip interval - Grow
...
//Pass Verification:
//  The output of this test should match the expected output in SBMethodsGrow1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBMethodsGrow1Expect.txt file
    ...
    class SBMethodsGrow1 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 11, 1, ref outString);
