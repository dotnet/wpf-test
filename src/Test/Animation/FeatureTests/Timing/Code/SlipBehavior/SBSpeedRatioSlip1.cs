...
/* 
 * Description: Verify setting SpeedRatio = 2 on a Sync Timeline - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBSpeedRatioSlip1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSpeedRatioSlip1Expect.txt file
...
{
    class SBSpeedRatioSlip1 :ITimeBVT
    {
        /*
        *  Function:   Test
        *  Arguments:  Framework
