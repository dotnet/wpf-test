...
/* 
 * Description: Verify calling SeekAlignedToLastTick into a Slip interval - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBSeekAligned1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSeekAligned1Expect.txt file
    ...
    class SBSeekAligned1 :ITimeBVT
    {
        ...
        */
        ...
        public override void PreTick( int i )
        {
            if ( i == 8 )
            {
                _clock.Controller.SeekAlignedToLastTick( TimeSpan.FromMilliseconds(4), TimeSeekOrigin.BeginTime );
            }
        }
