...
/* 
 * Description: Verify setting SpeedRatio = 2 on the parent of a Sync Timeline - Grow
...
//Pass Verification:
//  The output of this test should match the expected output in SBSpeedRatioGrow2Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSpeedRatioGrow2Expect.txt file
...
{
    class SBSpeedRatioGrow2 :ITimeBVT
    {
        /*
        *  Function:   Test
        *  Arguments:  Framework
