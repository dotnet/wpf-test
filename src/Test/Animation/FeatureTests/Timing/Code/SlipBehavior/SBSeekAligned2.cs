...
/* 
 * Description: Verify calling SeekAlignedToLastTick after a Pause - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBSeekAligned2Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSeekAligned2Expect.txt file
        ...
        */
        ...
        public override void PreTick( int i )
        {
            if ( i == 5 )
            {
                ...
                _clock.Controller.SeekAlignedToLastTick( TimeSpan.FromMilliseconds(9), TimeSeekOrigin.BeginTime );
            }
        }
