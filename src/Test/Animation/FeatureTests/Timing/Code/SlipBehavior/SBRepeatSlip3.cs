...
/* 
 * Description: Verify setting RepeatBehavior=Duration on the Sync Timeline - Slip
 */
...
//Pass Verification:
//  The output of this test should match the expected output in SBRepeatSlip3Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBRepeatSlip3Expect.txt file
    ...
    class SBRepeatSlip3 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            syncTimeline.RepeatBehavior = new RepeatBehavior(TimeSpan.FromMilliseconds(25));
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 41, 1, ref outString);
