...
/* 
 * Description: Verify RepeatBehavior=Duration on the Parent Timeline - Grow
 */
...
//Pass Verification:
//  The output of this test should match the expected output in SBRepeatGrow4Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBRepeatGrow4Expect.txt file
    ...
    class SBRepeatGrow4 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            parent.RepeatBehavior       = new RepeatBehavior(TimeSpan.FromMilliseconds(45));
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 46, 1, ref outString);
