...
/* 
 * Description: Verify setting RepeatBehavior=Forever on the Sync Timeline - Slip
 */
...
//Pass Verification:
//  The output of this test should match the expected output in SBRepeatSlip1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBRepeatSlip1Expect.txt file
    ...
    class SBRepeatSlip1 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 35, 1, ref outString);
