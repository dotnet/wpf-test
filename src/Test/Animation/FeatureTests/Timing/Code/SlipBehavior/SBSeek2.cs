...
/* 
 * Description: Verify calling Seek() for a SyncTimeline with no parent
 */
...
//Pass Verification:
//  The output of this test should match the expected output in SBSeek2Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSeek2Expect.txt file
    ...
    class SBSeek2 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 21, 1, ref outString);
        ...
        public override void PreTick( int i )
        {
            if ( i == 4 )
            {
                _clock.Controller.Seek( TimeSpan.FromMilliseconds(6), TimeSeekOrigin.BeginTime );
            }
        }
