...
/* 
 * Description: Verify Pause/Seek/Resume on the same Tick - Grow
...
//Pass Verification:
//  The output of this test should match the expected output in SBPauseSeekGrowExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBPauseSeekGrowExpect.txt file
...
{
    class SBPauseSeekGrow :ITimeBVT
    {
        ...
        */
        ...
        public override void PreTick( int i )
        {
            if ( i == 2 )
            {
                ...
                _clock.Controller.Seek( TimeSpan.FromMilliseconds(4), TimeSeekOrigin.BeginTime );
