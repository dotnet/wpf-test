...
/* 
 * Description: Verify seeking to a time before a Slip interval, after it has completed - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBSeekBeforeExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSeekBeforeExpect.txt file
    ...
    class SBSeekBefore :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 36, 1, ref outString);
