...
/* 
 * Description: Verify setting no Duration on the Slipping Timeline - Grow
...
//Pass Verification:
//  The output of this test should match the expected output in SBDurationAuto2Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBDurationAuto2Expect.txt file
...
{
    class SBDurationAuto2 :ITimeBVT
    {
