...
/* 
 * Description: Verify SetDesiredFrameRate on a parent of a SyncTimeline - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBDFR1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBDFR1Expect.txt file
    ...
    class SBDFR1 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            Timeline.SetDesiredFrameRate(parent, 500);
