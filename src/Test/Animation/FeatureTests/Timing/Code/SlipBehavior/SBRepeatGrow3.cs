...
/* 
 * Description: Verify RepeatBehavior=Duration on the Sync Timeline - Grow
 */
...
//Pass Verification:
//  The output of this test should match the expected output in SBRepeatGrow3Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBRepeatGrow3Expect.txt file
    ...
    class SBRepeatGrow3 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 30, 1, ref outString);
