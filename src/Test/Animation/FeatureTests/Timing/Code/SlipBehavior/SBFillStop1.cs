...
/* 
 * Description: Verify setting FillBehavior=Stop on the Sync Timeline - Slip
 */
...
//Pass Verification:
//  The output of this test should match the expected output in SBFillStop1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBFillStop1Expect.txt file
    ...
    class SBFillStop1 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            syncTimeline.FillBehavior   = FillBehavior.Stop;
