...
/*
 * Description: Verify a Sync Timeline with a negative BeginTime - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBNegativeBegin1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBNegativeBegin1Expect.txt file
...
{
    class SBNegativeBegin1 :ITimeBVT
    {
