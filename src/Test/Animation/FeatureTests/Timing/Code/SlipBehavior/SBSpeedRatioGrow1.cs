...
/* 
 * Description: Verify setting SpeedRatio = 2 on a Sync Timeline - Grow
...
//Pass Verification:
//  The output of this test should match the expected output in SBSpeedRatioGrow1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSpeedRatioGrow1Expect.txt file
...
{
    class SBSpeedRatioGrow1 :ITimeBVT
    {
        /*
        *  Function:   Test
        *  Arguments:  Framework
