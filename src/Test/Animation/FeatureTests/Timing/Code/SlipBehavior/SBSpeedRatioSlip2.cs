...
/* 
 * Description: Verify setting SpeedRatio = 2 on the parent of a Sync Timeline - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBSpeedRatioSlip2Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSpeedRatioSlip2Expect.txt file
...
{
    class SBSpeedRatioSlip2 :ITimeBVT
    {
        /*
        *  Function:   Test
        *  Arguments:  Framework
