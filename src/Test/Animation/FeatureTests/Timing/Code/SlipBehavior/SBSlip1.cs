...
/* 
 * Description: Verify implementing a Slip interval with SlipBehavior=Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBSlip1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBSlip1Expect.txt file
    ...
    class SBSlip1 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, clock, tManager, 0, 25, 1, ref outString);
