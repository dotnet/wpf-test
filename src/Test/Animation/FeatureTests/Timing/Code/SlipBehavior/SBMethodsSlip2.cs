...
/* 
 * Description: Verify Pause() then Seek() and Resume inside a Slip interval - Slip
...
//Pass Verification:
//  The output of this test should match the expected output in SBMethodsSlip2Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected SBMethodsSlip2Expect.txt file
    ...
    class SBMethodsSlip2 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            // Run the Timer
            TimeGenericWrappers.EXECUTE( this, _clock, tManager, 0, 27, 1, ref outString);
        ...
        public override void PreTick( int i )
        {
            ...
            if ( i == 5 )
            {
                _clock.Controller.Seek( TimeSpan.FromMilliseconds(2), TimeSeekOrigin.BeginTime );
