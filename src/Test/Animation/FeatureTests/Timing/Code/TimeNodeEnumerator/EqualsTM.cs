...
/* 
 * Description: Verify the Equals API for the TimeManager's TimeNodeEnumerator.
 */

//Instructions:
//  1. Create a TimeManager
//  2. Create a TimeContainer and four Timelines added as Children.
//  3. Obtain two Enumerator objects and compare this with the earlier one using Equals method

//Pass Condition:
//   This test passes if only the comparison returns false.

//Pass Verification:
//   The output of this test should match the expected output in EqualsTMExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected EqualsTMExpect.txt file.
...
namespace Microsoft.Test.Animation
{
    class EqualsTM :ITimeBVT
    {
        ...
        public override string Test()
        {
            ...
            return Convert.ToString( E1.Equals(E2) ) ;
        }
    }
}
