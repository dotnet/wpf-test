...
/* 
 * Description: Verify creating a ParallelTimeline using a Constructor with one argument: Begin.
 */

//Instructions:
//  1. Create a ParallelTimeline with Begin specified via the Constructor
...
//Pass Verification:
//   The output of this test should match the expected output in ConstructorPTL1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected ConstructorPTL1Expect.txt file
...
{
    class ConstructorPTL1 :ITimeBVT
    {
        /*
         *  Function:    Test
         *  Arguments:   Framework
        ...
        public override string Test()
        {
            ...
            ParallelTimeline parallelTimeline = new ParallelTimeline(TimeSpan.FromMilliseconds(0));
            ...
            parallelTimeline.Duration       = new System.Windows.Duration(TimeSpan.FromMilliseconds(400));
            ...
            // Run the Timer         
            TimeGenericWrappers.EXECUTE( this, tClock, tMan, 0, 500, 100, ref outString);
