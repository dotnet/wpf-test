...
/* 
 * Description: Verify the Equals(ClockCollection,ClockCollection) method of a ClockCollection
 */
...
//Warnings:
//     Any changes made in the output should be reflected in EqualsCollectionTLCCExpect.txt file
...
{
    class EqualsCollectionTLCC :ITimeBVT
    {
        /*
        *  Function:  Test
        *  Arguments: Framework
        */
        public override string Test()
        {
            ...
            outString += Convert.ToString( ClockCollection.Equals(T1a,T1a) ) + "\n";
            outString += Convert.ToString( ClockCollection.Equals(T1a,T1b) ) + "\n";
            outString += Convert.ToString( ClockCollection.Equals(T1a,T2) ) + "\n";
