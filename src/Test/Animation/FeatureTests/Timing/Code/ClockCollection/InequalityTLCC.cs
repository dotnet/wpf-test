...
/* 
 * Description: Verify the Inequality operator for a ClockCollection
 */
...
//Warnings:
//     Any changes made in the output should be reflected in InequalityTLCCExpect.txt file
    ...
    class InequalityTLCC :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            outString += Convert.ToString( T1a == T1b ) + "\n";
            outString += Convert.ToString( T1a != T1b ) + "\n";
            outString += Convert.ToString( T1b == T2 ) + "\n";
            outString += Convert.ToString( T1b != T2 ) + "\n";
