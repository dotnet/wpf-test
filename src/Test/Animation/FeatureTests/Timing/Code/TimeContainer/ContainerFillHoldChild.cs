...
/* 
 * Description: Verify a Timeline's FillBehavior.HoldEnd property when its child does set it
 */

//Instructions:
//  1. Create a TimeNode with BeginTime=0 and Duration=10. Set HoldEnd property on the TimeNode
//  2. Create a TimeContainer with BeginTime=2 and Duration=4. Set HoldEnd property on the TimeNode
//  3. Attach TimeNode to the Container
//  4. Create a TimeManager with Start=0 and Step = 1
//  5. Check the state of timing engine ( Progress, CurrentState properties )

//Warnings:
//  Any changes made in the output should be reflected in ContainerFillHoldChildExpect.txt file
...
{
    class ContainerFillHoldChild :ITimeBVT
    {
        /*
         *  Function:  Test
         *  Arguments: Framework
