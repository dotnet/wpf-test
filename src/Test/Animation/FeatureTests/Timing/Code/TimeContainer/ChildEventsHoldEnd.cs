...
/* 
 * Description: Verify event firing for a Timeline's children (default FillBehavior)
 */
...
//Warnings:
//  Any changes made in the output should be reflected in ChildEventsHoldEndExpect.txt file
...
{
    class ChildEventsHoldEnd : ITimeBVT
    {
        /*
         *  Function: Test
         *  Arguments: Framework
