...
/* 
 * Description: Verify event firing for a Timeline's children (FillBehavior=Stop on the Children)
 */
...
//Warnings:
//  Any changes made in the output should be reflected in ChildEventsExpect.txt file
...
namespace Microsoft.Test.Animation
{
    class ChildEvents : ITimeBVT
    {
        ...
        public override string Test()
        {
            ...
            child1.FillBehavior     = FillBehavior.Stop;
            child1.Name             = "Child1";
