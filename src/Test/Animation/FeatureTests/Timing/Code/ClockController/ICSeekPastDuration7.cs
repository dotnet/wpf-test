...
/* 
 * Description: Verify Seeking when Duration = Forever (TimeSeekOrigin.BeginTime)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekPastDuration7Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekPastDuration7Expect.txt file
...
{
    class ICSeekPastDuration7 :ITimeBVT
    {
