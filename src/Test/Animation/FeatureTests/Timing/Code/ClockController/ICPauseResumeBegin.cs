...
/* 
 * Description: Verify calling Pause(), Resume, then Begin() on the ClockController
 */
...
//  5. Pause, Resume, Begin the Clock.

//Warnings:
//  Any changes made in the output should be reflected in ICPauseResumeBeginExpect.txt file
...
{
    class ICPauseResumeBegin :ITimeBVT
    {
        Clock _clock;
