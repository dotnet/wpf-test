...
/* 
 * Description: Verify Seeking into an AutoReverse period (TimeSeekOrigin.BeginTime)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekPastDuration1Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekPastDuration1Expect.txt file
...
{
    class ICSeekPastDuration1 :ITimeBVT
    {
