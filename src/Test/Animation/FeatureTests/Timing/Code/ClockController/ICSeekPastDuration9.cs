...
/* 
 * Description: Verify Seeking into an AutoReverse period (TimeSeekOrigin.Duration)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekPastDuration9Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekPastDuration9Expect.txt file
...
{
    class ICSeekPastDuration9 :ITimeBVT
    {
        ...
        public override void PostTick( int i )
        {
            if ( i == 12 )
            {
                _tClock.Controller.Seek( TimeSpan.FromMilliseconds(-10), TimeSeekOrigin.Duration );
            }
        }
