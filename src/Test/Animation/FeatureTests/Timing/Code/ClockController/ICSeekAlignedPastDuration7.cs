...
/* 
 * Description: Verify Seeking via SeekAlignedToLastTick when Duration = Forever (TimeSeekOrigin.BeginTime)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekAlignedPastDuration7Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekAlignedPastDuration7Expect.txt file
...
{
    class ICSeekAlignedPastDuration7 :ITimeBVT
    {
