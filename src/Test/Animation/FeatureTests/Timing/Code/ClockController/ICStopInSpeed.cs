...
/* 
 * Description: Verify the ClockController's Stop method, invoked via CurrentGlobalSpeedInvalidated
 */
...
//  4. Stop the Timeline in the CurrentGlobalSpeedInvalidated event handler
//  5. Check the CurrentProgress, CurrentGlobalSpeed and CurrentState properties after each Tick

//Pass Verification:
//   The output of this test should match the expected output in ICStopInSpeedExpect.txt

//Warnings:
//  Any changes made in the output should be reflected ICStopInSpeedExpect.txt file
