...
/* 
 * Description: Verify Seeking when Duration = 0 (TimeSeekOrigin.BeginTime)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekPastDuration14Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekPastDuration14Expect.txt file
...
{
    class ICSeekPastDuration14 :ITimeBVT
    {
