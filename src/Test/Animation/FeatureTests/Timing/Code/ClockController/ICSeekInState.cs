...
/* 
 * Description: Verify the ClockController's Seek method, invoked via CurrentStateInvalidated
 */
...
//  4. Seek the Timeline in the CurrentStateInvalidated event handler
//  5. Check the CurrentProgress, CurrentGlobalSpeed and CurrentState properties after each Tick

//Pass Verification:
//   The output of this test should match the expected output in ICSeekInStateExpect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekInStateExpect.txt file
