...
/* 
 * Description: Verify Seeking into a RepeatDuration period (TimeSeekOrigin.Duration)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekPastDuration13Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekPastDuration13Expect.txt file
...
{
    class ICSeekPastDuration13 :ITimeBVT
    {
        ...
        public override string Test()
        {
            ...
            //Run the Timer         
            TimeGenericWrappers.EXECUTE( this, _tClock, tManager, 0, 31, 1, ref outString);
        ...
        public override void PostTick( int i )
        {
            if ( i == 12 )
            {
                _tClock.Controller.Seek( TimeSpan.FromMilliseconds(-5), TimeSeekOrigin.Duration );
            }
        }
