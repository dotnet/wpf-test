...
/* 
 * Description: Verify calling Pause(), SkipToFill(), then Resume on the ClockController
 */
...
//  5. Pause, SkipToFill, then Resume the Clock.

//Warnings:
//  Any changes made in the output should be reflected in ICPauseSkipToFillResumeExpect.txt file
...
{
    class ICPauseSkipToFillResume :ITimeBVT
    {
        Clock _clock;
        ...
        public override string Test()
        {
            ...
            //Run the Timer         
            TimeGenericWrappers.EXECUTE( this, _clock, tMan, 0, 11, 1, ref outString);
