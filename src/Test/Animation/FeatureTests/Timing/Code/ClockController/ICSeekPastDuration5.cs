...
/* 
 * Description: Verify Seeking into a RepeatDuration period (TimeSeekOrigin.BeginTime)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekPastDuration5Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekPastDuration5Expect.txt file
...
{
    class ICSeekPastDuration5 :ITimeBVT
    {
        ...
        public override void PostTick( int i )
        {
            if ( i == 6 )
            {
                _tClock.Controller.Seek( TimeSpan.FromMilliseconds(13), TimeSeekOrigin.BeginTime );
            }
        }
