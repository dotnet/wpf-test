...
/* 
 * Description: Verify the ClockController's SkipToFill method, invoked via CurrentTimeInvalidated
 */
...
//  4. Invoke SkipToFill in the CurrentTimeInvalidated event handler
//  5. Check the CurrentProgress, CurrentGlobalSpeed and CurrentState properties after each Tick

//Pass Verification:
//   The output of this test should match the expected output in ICSkipToFillInTimeExpect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSkipToFillInTimeExpect.txt file
...
{
    class ICSkipToFillInTime :ITimeBVT
    {
