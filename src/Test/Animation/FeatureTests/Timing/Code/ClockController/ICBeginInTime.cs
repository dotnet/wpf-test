...
/* 
 * Description: Verify invoking Begin() via the CurrentTimeInvalidated event
 */
...
//Warnings:
//  Any changes made in the output should be reflected in ICBeginInTimeExpect.txt file
...
{
    class ICBeginInTime :ITimeBVT
    {
        private Clock         _clock;
        private int           _timeFired         = 0;
        ...
        public override void OnCurrentTimeInvalidated(object subject, EventArgs args)
        {
            ...
            if (_timeFired == 0)
            {
                outString += "-----CurrentTimeInvalidated-----Invoking Begin()" + "\n";
