...
/*
 * Description:  Verify SkipToFill when Duration=Automatic
...
//Pass Verification:
//   The output of this test should match the expected output in ICSkipToFillWhenAutomaticExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected in ICSkipToFillWhenAutomaticExpect.txt file
...
{
    class ICSkipToFillWhenAutomatic : ITimeBVT
    {
