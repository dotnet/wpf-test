...
/* 
 * Description: Verify the ClockController's Seek method, invoked via CurrentTimeInvalidated
 */
...
//  4. Seek the Timeline in the CurrentTimeInvalidated event handler
//  5. Check the CurrentProgress, CurrentGlobalSpeed and CurrentState properties after each Tick

//Pass Verification:
//   The output of this test should match the expected output in ICSeekInTimeExpect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekInTimeExpect.txt file
