...
//  5. Pause, Seek, Resume the Clock at tick = 5.

//Warnings:
//  Any changes made in the output should be reflected in ICPauseSeekResumeExpect.txt file
...
{
    class ICPauseSeekResume :ITimeBVT
    {
        Clock _clock;
        ...
        public override void PreTick( int i )
        {
            if ( i == 5 )
            {
                ...
                _clock.Controller.Seek( TimeSpan.FromMilliseconds(8), TimeSeekOrigin.BeginTime );
