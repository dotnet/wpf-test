...
/* 
 * Description: Verify Seeking past the Duration with FillBehavior=Stop (TimeSeekOrigin.BeginTime)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekPastDuration4Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekPastDuration4Expect.txt file
...
{
    class ICSeekPastDuration4 :ITimeBVT
    {
