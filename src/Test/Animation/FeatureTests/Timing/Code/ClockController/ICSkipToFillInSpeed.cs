...
/* 
 * Description: Verify the ClockController's SkipToFill method, invoked via CurrentGlobalSpeedInvalidated
 */
...
//  4. Invoke SkipToFill in the CurrentGlobalSpeedInvalidated event handler
//  5. Check the CurrentProgress, CurrentGlobalSpeed and CurrentState properties after each Tick

//Pass Verification:
//   The output of this test should match the expected output in ICSkipToFillInSpeedExpect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSkipToFillInSpeedExpect.txt file
...
{
    class ICSkipToFillInSpeed :ITimeBVT
    {
