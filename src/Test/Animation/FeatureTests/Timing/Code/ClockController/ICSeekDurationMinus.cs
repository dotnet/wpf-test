...
/* 
 * Description: Verify Seek - TimeSeekOrigin.Duration with a negative value
 */
...
//  4. Seek the Timeline with offset = 3 and origin = TimeSeekOrigin.Duration at Time = -4
//  5. Check the CurrentProgress and CurrentState  properties after each Tick
//  6. Check event firing

//Pass Verification:
//   The output of this test should match the expected output in ICSeekDurationMinusExpect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekDurationMinusExpect.txt file
...
{
    class ICSeekDurationMinus :ITimeBVT
    {
