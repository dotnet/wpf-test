...
/* 
 * Description: Verify Seeking a Timeline before it begins
 */
...
//  4. Seek the Timeline with offset = 3 and origin = TimeSeekOrigin.Begin at Time = 7
//  5. Check the CurrentProgress and CurrentState  properties after each Tick
//  6. Check event firing

//Pass Verification:
//   The output of this test should match the expected output in ICSeekBeforeBeginExpect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekBeforeBeginExpect.txt file
...
{
    class ICSeekBeforeBegin :ITimeBVT
    {
        ...
        public override void PostTick( int i )
        {
            if ( i == 3 )
            {
                _tClock.Controller.Seek( TimeSpan.FromMilliseconds(10), TimeSeekOrigin.BeginTime );
            }
        }
    }
}
