...
/* 
 * Description: Verify the ClockController's Begin method, invoked via CurrentTimeInvalidated
 */
...
//  4. Begin the clock in the CurrentTimeInvalidated event handler
//  5. Check the CurrentProgress, CurrentGlobalSpeed and CurrentState properties after each Tick

//Pass Verification:
//   The output of this test should match the expected output in ICBeginInTime2Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICBeginInTime2Expect.txt file
