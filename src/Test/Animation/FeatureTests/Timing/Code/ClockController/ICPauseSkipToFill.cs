...
/* 
 * Description: Verify calling Pause(), then SkipToFill() on the ClockController
 */
...
//  5. Pause, SkipToFill the Clock.

//Warnings:
//  Any changes made in the output should be reflected in ICPauseSkipToFillExpect.txt file
...
{
    class ICPauseSkipToFill :ITimeBVT
    {
        Clock _clock;
