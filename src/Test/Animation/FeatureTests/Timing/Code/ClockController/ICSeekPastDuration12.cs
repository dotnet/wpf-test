...
/* 
 * Description: Verify Seeking past the Duration with FillBehavior=Stop (TimeSeekOrigin.Duration)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekPastDuration12Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekPastDuration12Expect.txt file
...
{
    class ICSeekPastDuration12 :ITimeBVT
    {
        ...
        public override void PostTick( int i )
        {
            if ( i == 2 )
            {
                _tClock.Controller.Seek( TimeSpan.FromMilliseconds(-1), TimeSeekOrigin.Duration );
            }
        }
