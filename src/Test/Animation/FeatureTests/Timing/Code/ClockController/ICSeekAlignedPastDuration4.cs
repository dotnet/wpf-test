...
/* 
 * Description: Verify Seeking via SeekAlignedToLastTick past the Duration with FillBehavior=Stop (TimeSeekOrigin.BeginTime)
 */


//Pass Verification:
//   The output of this test should match the expected output in ICSeekAlignedPastDuration4Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICSeekAlignedPastDuration4Expect.txt file
...
{
    class ICSeekAlignedPastDuration4 :ITimeBVT
    {
        ...
        public override void PostTick( int i )
        {
            if ( i == 2 )
            {
                _tClock.Controller.SeekAlignedToLastTick( TimeSpan.FromMilliseconds(11), TimeSeekOrigin.BeginTime );
            }
        }
