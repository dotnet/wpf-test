...
/* 
 * Description: Verify the ClockController's Begin method, invoked via CurrentStateInvalidated
 */
...
//  4. Beging the clock in the CurrentStateInvalidated event handler
//  5. Check the CurrentProgress, CurrentGlobalSpeed and CurrentState properties after each Tick

//Pass Verification:
//   The output of this test should match the expected output in ICBeginInState2Expect.txt

//Warnings:
//  Any changes made in the output should be reflected ICBeginInState2Expect.txt file
...
{
    class ICBeginInState2 :ITimeBVT
    {
