...
/* 
 * Description: Verify the internal method IList.IndexOf within class TimelineCollection
...
//  4. Verify existing child in the Time Container using IList.IndexOf method within TimelineCollection class

//Pass Condition:
//  Test passes when Time Container contains child time node.

//Pass Verification:
//  The output of this test should match the expected output in TLCIndexOfExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected TLCIndexOfExpect.txt file
    ...
    class TLCIndexOf :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            DEBUG.LOGSTATUS("Test \'internal IndexOf\' method." );
            outString += "The last added child time node -> index = " + ((IList)_tc).IndexOf(tNode2)  + "\n";
