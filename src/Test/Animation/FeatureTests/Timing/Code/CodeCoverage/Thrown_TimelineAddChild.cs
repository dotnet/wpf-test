...
/* 
 * Description: Verify thrown exception for the internal method IAddChild.AddChild within class Timeline
...
{
    class Thrown_TimelineAddChild : ITimeBVT
    {
