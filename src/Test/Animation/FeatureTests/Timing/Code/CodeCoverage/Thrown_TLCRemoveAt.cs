...
/* 
 * Description: Verify thrown exception for the method RemoveAt(index) in TimelineCollection class          
...
{
    class Thrown_TLCRemoveAt :ITimeBVT
    {
        ...
        */
        ...
        public override void PostTick( int i )
        {
            if (i == 7)
            {
                ...
                outString += "Count Children after INVALID removing: " + _tc.Count + "\n";
            }
        }
