...
/* 
 * Description: Verify setting RepeatBehavior to 1
 */
...
//Pass Verification:
//  The output of this test should match the expected output in RepeatBehaviorOneExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected RepeatBehaviorOneExpect.txt file
...
{
    class RepeatBehaviorOne :ITimeBVT
    {
        /*
         *  Function:    Test
         *  Arguments:   Framework
