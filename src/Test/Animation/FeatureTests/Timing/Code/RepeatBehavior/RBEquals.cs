...
/* 
 * Description: Verify the Equals method for RepeatBehavior -- RB1.Equals(RB2) format
 */
...
//Pass Verification:
//  The output of this test should match the expected output in RBEqualsExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected RBEqualsExpect.txt file.
...
namespace Microsoft.Test.Animation
{
    class RBEquals :ITimeBVT
    {
        ...
        public override string Test()
        {
            ...
            outString += "---1 Equals 4--- " + Convert.ToString( RB1.Equals(RB4) ) + "\n";
