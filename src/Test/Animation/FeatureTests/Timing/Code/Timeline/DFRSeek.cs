...
/* 
 * Description: Verify calling Seek() given SetDesiredFrameRate()
 */
...
//Pass Verification:
//   The output of this test should match the expected output in DFRSeekExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected in DFRSeekExpect.txt file
...
namespace Microsoft.Test.Animation
{
    class DFRSeek : ITimeBVT
    {
        ...
        public override void PostTick( int i )
        {
            if ( i == 7 )
            {
                _tClock.Controller.Seek( TimeSpan.FromMilliseconds(12), TimeSeekOrigin.BeginTime );
            }
        }
