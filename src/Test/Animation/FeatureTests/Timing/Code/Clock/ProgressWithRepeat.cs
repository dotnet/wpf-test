...
/* 
 * Description: Verify reading the Progress property inside the Time loop with Repeat Property on a TimeNode.g.
 */

//Instructions:
//  1. Create a Timeline with Begin = 100, Duration = 400, RepeatCount = 2
...
//Pass Verification:
//   The output of this test should match the expected output in ProgressWithRepeatExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected ProgressWithRepeatExpect.txt file
...
{
    class ProgressWithRepeat :ITimeBVT
    {
        /*
         *  Function:    Test
         *  Arguments:   Framework
