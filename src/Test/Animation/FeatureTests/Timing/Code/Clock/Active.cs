...
/* 
 * Description: Verify reading the Clock's CurrentState property
 */

//Instructions:
//  1. Create a Timeline with Begin = 0, Duration = 50
//  2. Attach event handlers to the TimeNode
//  3. Create a TimeManager with Start=0 and Step = 100 and add the TimeNode

//Pass Condition:
//   This test passes if CurrentState returns the correct Clock state each time it is read.

//Pass Verification:
//   The output of this test should match the expected output in ActiveExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected ActiveExpect.txt file
