...
//Pass Verification:
//   The output of this test should match the expected output in ClockEventsExpect.txt.

//Warnings:
//  Any changes made in the output should be reflected ClockEventsExpect.txt file
