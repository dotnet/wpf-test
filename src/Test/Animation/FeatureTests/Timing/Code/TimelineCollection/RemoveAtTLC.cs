...
//     4. Remove the first Timeline from the TimelineCollection, using RemoveAt

//Warnings:
//     Any changes made in the output should be reflected in RemoveAtTLCExpect.txt file
