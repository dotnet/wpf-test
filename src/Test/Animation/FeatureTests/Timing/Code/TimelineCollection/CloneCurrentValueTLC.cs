...
/* 
 * Description: Verify the CloneCurrentValue() method for a TimelineCollection
  */

//Instructions:
//     1. Create three Timelines, a parent and two children
//     2. Obtain a TimelineCollection
//     5. Use CloneCurrentValue() to copy the TimelineCollection

//Warnings:
//     Any changes made in the output should be reflected in CloneCurrentValueTLCExpect.txt file
...
{
     class CloneCurrentValueTLC :ITimeBVT
     {
          /*
           *  Function:  Test
           *  Arguments: Framework
          ...
          public override string Test()
          {
               ...
               parent.Duration      = new Duration(TimeSpan.FromMilliseconds(0));
               parent.Name          = "Parent";
               ...
               //Create a new TimelineCollection using CloneCurrentValue()
               TimelineCollection TLC2 = TLC1.CloneCurrentValue();
