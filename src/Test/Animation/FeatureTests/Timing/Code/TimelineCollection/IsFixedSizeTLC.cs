...
/* 
 * Description: Verify reading a TimelineCollection's IsFixedSize property
 */
...
//Warnings:
//     Any changes made in the output should be reflected in IsFixedSizeTLCExpect.txt file
...
namespace Microsoft.Test.Animation
{
     class IsFixedSizeTLC :ITimeBVT
     {
          ...
          public override string Test()
          {
               ...
               outString += "----------IsFixedSize: " + ((IList)_TLC).IsFixedSize + "\n";
