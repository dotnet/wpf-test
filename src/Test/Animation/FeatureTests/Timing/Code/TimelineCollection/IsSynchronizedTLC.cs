...
/* 
 * Description: Verify reading a TimelineCollection's IsSynchronized property
 */
...
//Warnings:
//  Any changes made in the output should be reflected in IsSynchronizedTLCExpect.txt file
...
{
    class IsSynchronizedTLC :ITimeBVT
    {
        ...
        public override string Test()
        {
            ...
            _TLC = tContainer.Children;
               outString += "----------IsSynchronized: " + ((IList)_TLC).IsSynchronized + "\n";
