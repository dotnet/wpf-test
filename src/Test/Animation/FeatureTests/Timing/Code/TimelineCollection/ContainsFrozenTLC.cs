...
/* 
 * Description: Verify applying the Contains() method when a TimelineCollection contains a Frozen child
 */
...
//Warnings:
//     Any changes made in the output should be reflected in ContainsFrozenTLCExpect.txt file
...
{
     class ContainsFrozenTLC :ITimeBVT
     {
          ...
          public override string Test()
          {
               ...
               // Freeze the child Timeline, TimeNode 1
               _tNode1.Freeze();
