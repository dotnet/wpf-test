...
/* 
 * Description:  Verify invoking Pause from outside the Active period - Filling state after SkipToFill()

*/

//Pass Verification:
//  The output of this test should match the expected output in bug22Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug22Expect.txt file
