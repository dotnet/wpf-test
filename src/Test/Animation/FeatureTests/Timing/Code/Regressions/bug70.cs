...
/* 
 * Description:  Verify CurrentProgress on a child when the reversing parent has no duration

*/

//Pass Verification:
//  The output of this test should match the expected output in bug70Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug70Expect.txt file
