...
/* 
 * Description: Verify invoking Stop() when the Timeline's Duration is Forever
...
//Pass Condition:
//  This test passes if no exception is thrown and the ParallelTimeline is active.

//Pass Verification:
//  The output of this test should match the expected output in bug15Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected in the bug15Expect.txt file
...
namespace Microsoft.Test.Animation
{
    class bug15 :ITimeBVT
    {
        ...
        public override string Test()
        {
            ...
            //Run the Timer         
            TimeGenericWrappers.TESTSTATE( this, _tClock, tMan, 0, 8, 1, ref outString);
