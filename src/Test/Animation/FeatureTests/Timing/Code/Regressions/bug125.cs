...
/* 
 * Description:  Verify the Exception when setting Acceleration and Acceleration + Deceleration > 1 
...
//Pass Verification:
//  The output of this test should match the expected output in bug125Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug125Expect.txt file
     ...
     class bug125 :ITimeBVT
     {
          ...
          public override string Test()
          {
               ...
               try
               {
                    ...
                    timeline.DecelerationRatio = 0.7f;
                    timeline.AccelerationRatio = 0.35f;
