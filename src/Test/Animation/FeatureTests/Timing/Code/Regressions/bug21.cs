...
/* 
 * Description:  Verify invoking Pause from outside the Active period - Stopped state via FillBehavior.Stop

*/

//Pass Verification:
//  The output of this test should match the expected output in bug21Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug21Expect.txt file
