...
/* 
 * Description:  Verify calling Seek() before a Timeline begins

*/

//Pass Verification:
//  The output of this test should match the expected output in bug29Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug29Expect.txt file
    ...
    class bug29 :ITimeBVT
    {
        ...
        */
        ...
        public override void PreTick( int i )
        {
            if ( i == 0 )
            {
                _tClock.Controller.Seek( TimeSpan.FromMilliseconds(2), TimeSeekOrigin.BeginTime );
            }
        }
    }
}
