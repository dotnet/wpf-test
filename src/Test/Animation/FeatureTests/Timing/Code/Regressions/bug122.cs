...
/* 
 * Description:  Verify invoking Begin() when a Timeline ends [FillBehavior = Stop]

*/

//Pass Verification:
//  The output of this test should match the expected output in bug122Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug122Expect.txt file
    ...
    class bug122 :ITimeBVT
    {
        ...
        */
        ...
        public override void OnCurrentStateInvalidated(object subject, EventArgs args)
        {
            ...
            if ( ((Clock)subject).CurrentState == ClockState.Stopped )
            {
