...
/* 
 * Description: Verify invoking SkipToFill() when the Timeline's RepeatDuration is Forever with a Duration

*/

//Instructions:
//  1. Create a Timeline, in which Duration is set and RepeatDuration is Forever.
...
//Pass Verification:
//  The output of this test should match the expected output in bug13Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected in the bug13Expect.txt file
