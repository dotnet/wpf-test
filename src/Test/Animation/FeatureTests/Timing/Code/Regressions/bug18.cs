...
//Pass Verification:
//  The output of this test should match the expected output in bug18Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug18Expect.txt file
