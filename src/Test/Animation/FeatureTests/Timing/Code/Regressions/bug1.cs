...
/* 
 * Description:  Verify CurrentTimeInvalidated when Pause() is invoked

*/

//Pass Verification:
//  The output of this test should match the expected output in bug1Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug1Expect.txt file
    ...
    class bug1 :ITimeBVT
    {
        ...
        */
        ...
        {    
            ...
            outString += "  : Time     = " + subject.CurrentTime + "\n";
        }
    }
}
