...
/* 
 * Description:  Verify a child Timeline with a negative BeginTime and AutoReverse

*/

//Instructions:
//  1. Create a TimeManager
//  2. Create a Timeline with a negative BeginTime and AutoReverse
...
//Pass Verification:
//  The output of this test should match the expected output in bug47Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug47Expect.txt file
    ...
    class bug47 :ITimeBVT
    {
        ...
        */
        public override string Test()
        {
            ...
            AttachCurrentTimeInvalidatedTC(_tClockParent);
            AttachCurrentTimeInvalidatedTC(_tClockChild);

            // Run the Timer               
            TimeGenericWrappers.EXECUTE( this, _tClockParent, _tManager, 0, 16, 1, ref outString);
