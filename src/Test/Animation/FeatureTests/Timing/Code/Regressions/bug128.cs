...
/* 
 * Description:  Verify CurrentTimeInvalidated when Duration is 0 and FillBehavior is HoldEnd

*/

//Pass Verification:
//  The output of this test should match the expected output in bug128Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug128Expect.txt file
...
namespace Microsoft.Test.Animation
{
    class bug128 :ITimeBVT
    {
        ...
        */
        ...
        {
            outString += "----------CurrentTimeInvalidated fired --- CurrentState: " + ((Clock)subject).CurrentState  + "\n";
        }
    }
}
