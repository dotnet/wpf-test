...
/* 
 * Description:  Verify calling SeekAlignedToLastTick() using Duration before a Timeline begins

*/

//Pass Verification:
//  The output of this test should match the expected output in bug31Expect.txt.

//Warnings:
//  Any changes made in the output should be reflected bug31Expect.txt file
    ...
    class bug31 :ITimeBVT
    {
        ...
        */
        ...
        public override void PreTick( int i )
        {
            if ( i == 0 )
            {
                _tClock.Controller.SeekAlignedToLastTick( TimeSpan.FromMilliseconds(-4), TimeSeekOrigin.Duration );
            }
        }
    }
}
