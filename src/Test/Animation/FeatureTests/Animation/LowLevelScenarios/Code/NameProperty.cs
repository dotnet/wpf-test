...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Animation.LowLevelScenarios.Regressions", "NameProperty")]
    public class NamePropertyTest : XamlTest
    {
        ...
        /******************************************************************************
        * Function:          NamePropertyTest Constructor
        ******************************************************************************/
        public NamePropertyTest() : base(@"NameProperty.xaml")
        {
        ...
        ******************************************************************************/
        ...
        {
            _animatedElement = (TextBlock)AnimationUtilities.FindElement(RootElement, "textblock1");
