...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Animation.LowLevelScenarios.Regressions", "OpacityMaskExceptionTest")]
    public class OpacityMaskExceptionTest : XamlTest
    {

        #region Test case members

        private Page                _animatedElement;
        ...
        /******************************************************************************
        * Function:          OpacityMaskExceptionTest Constructor
        ******************************************************************************/
        public OpacityMaskExceptionTest() : base(@"OpacityMaskException.xaml")
        {
        ...
        ******************************************************************************/
        ...
        {
            _animatedElement = (Page)AnimationUtilities.FindElement(RootElement, "page1");
