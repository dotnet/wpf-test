...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Animation.LowLevelScenarios.Regressions", "SpeedRatioVideoAssertTest")]
    public class SpeedRatioVideoAssertTest : XamlTest
    {
        ...
        /******************************************************************************
        * Function:          SpeedRatioVideoAssertTest Constructor
        ******************************************************************************/
        public SpeedRatioVideoAssertTest() : base(@"SpeedRatioVideoAssert.xaml")
        {
