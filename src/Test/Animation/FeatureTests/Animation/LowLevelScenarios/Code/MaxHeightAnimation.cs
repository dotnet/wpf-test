...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Animation.LowLevelScenarios.Regressions", "MaxHeightAnimationTest")]
    public class MaxHeightAnimationTest : XamlTest
    {
        #region Test case members

        private Grid                _animatedElement;
        ...
        /******************************************************************************
        * Function:          MaxHeightAnimationTest Constructor
        ******************************************************************************/
        public MaxHeightAnimationTest() : base(@"MaxHeightAnimation.xaml")
        {
        ...
        ******************************************************************************/
        ...
        {
            _animatedElement = (Grid)AnimationUtilities.FindElement(RootElement, "grid1");
        ...
        ******************************************************************************/
        ...
        TestResult Verify()
        {
            ...
            double actValue = (double)_animatedElement.GetValue(Grid.MaxHeightProperty);
            double expValue = 350d;
