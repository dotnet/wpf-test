...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Animation.KeyFrames.Regressions", "KeyFrameForever3Test")]
    public class KeyFrameForever3Test : XamlTest
    {
        ...
        /******************************************************************************
        * Function:          KeyFrameForever3Test Constructor
        ******************************************************************************/
        public KeyFrameForever3Test() : base(@"KeyFrameForever3.xaml")
        {
        ...
        ******************************************************************************/
        ...
        {
            _animatedElement = (Button)RootElement.FindName("Animate");
        ...
        ******************************************************************************/
        ...
        TestResult Verify()
        {
            ...
            string actValue = (string)_animatedElement.GetValue(Button.ContentProperty);
            string expValue = "c";
