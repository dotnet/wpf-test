...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Animation.PropertyMethodEvent.Regressions", "AccelDecelAssertTest")]

    public class AccelDecelAssertTest : XamlTest
    {
        ...
        /******************************************************************************
        * Function:          AccelDecelAssertTest Constructor
        ******************************************************************************/
        public AccelDecelAssertTest() : base(@"AccelDecelAssert.xaml")
        {
        ...
        ******************************************************************************/
        ...
        {
            _animatedElement = (Rectangle)AnimationUtilities.FindElement(RootElement, "m1");
