...
namespace Microsoft.Test.Animation
{
    ...
    [Test(2, "Animation.PropertyMethodEvent.Regressions", "MissingEllipseWidthTest")]
    public class MissingEllipseWidthTest : XamlTest
    {
        ...
        /******************************************************************************
        * Function:          MissingEllipseWidthTest Constructor
        ******************************************************************************/
        public MissingEllipseWidthTest() : base(@"MissingEllipseWidth.xaml")
        {
