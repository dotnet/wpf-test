...
#region Constructors
        ...
        public object CallMethod(string name, BindingFlags flags, params object [] args) {
            ...
            if (mInfo == null)
                mInfo = InnerType.GetMethod(name, flags);
        ...
        public MethodInfo GetMethodInfoSW(string name)
        {
            if (name == null)
                return null;
        ...
        public MethodInfo GetMethodInfoSW(string name, Type[] typeArray)
        {
            if (name == null)
                return null;
        ...
        public static object Instantiate(string assemblyName, string typeName) 
        {
            ...
            if (assemblyName == null || assemblyName == String.Empty) {                
                ...
                {      
                    ...
                    try {
                        type = assembly.GetType(typeName, false, false); //this always throws even when told not to.  
                    }
                    catch(Exception e) {
