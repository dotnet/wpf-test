...
{
    /// <summary/>
    public static class StyleOverride01_Verify
    {
        /// <summary>
        ...
        public static bool Verify(UIElement rootElement)
        {
            ...
            CV01ValidateState(btnCtrl, btnExp, ref result);
            return result;
        }

        private static void CV01ValidateState(Button btnCtrl, Button btnExp, ref bool result)
        {
            ...
            GlobalLog.LogStatus("1. Yellow button background.");
            if (!(((SolidColorBrush) btnExp.Background).Color == Colors.Yellow))
            {
                GlobalLog.LogEvidence("!(((SolidColorBrush)btnExp.Background).Color == Colors.Yellow)");
                result = false;
            }
        }
    }
