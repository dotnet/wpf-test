...
{
    /// <summary/>
    public static class StyleOverride03_Verify
    {
        /// <summary>
        ...
        public static bool Verify(UIElement rootElement)
        {
            ...
            CV03ValidateState(btnCtrl, btnExp, ref result);
            return result;
        }

        private static void CV03ValidateState(Button btnCtrl, Button btnExp, ref bool result)
        {
