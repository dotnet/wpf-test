...
namespace Microsoft.Test.Xaml.Parser.MethodTests.Date_Time
{
    /// <summary>
    ...
    public class DateTimeMarkupTest
    {
        ...
        private void RunSingleErrorTest(ErrorTestObject testObject)
        {
            ...
            catch (XamlParseException xpe)
            {
                ...
                if (!(xpe.Message.Contains("DateTime")))
                {
                    throw new Microsoft.Test.TestValidationException("XamlParseException's message was expected to contain the string 'DateTime', but it doesn't");
                }
            }
        }
        ...
        string _xamlFooter = "\" xmlns=\"http://XamlTestTypes\" />";

        private readonly FunctionalTestObject[] _functionalTestObjects;
        private readonly ErrorTestObject[] _errorTestObjects;
