...
{
    /// <summary/>
    public static class StyleOverride02_Verify
    {
        /// <summary>
        ...
        public static bool Verify(UIElement rootElement)
        {
            ...
            CV02ValidateState(btnCtrl, btnExp, ref result);
            return result;
        }

        private static void CV02ValidateState(Button btnCtrl, Button btnExp, ref bool result)
        {
