...
namespace RegressionIssue65_DefaultStyleInMD_TenLevel
{
    /// <summary>
    ...
    /// This test case checks that default styles defined in ten level nested merged dictionaries are found.
    /// </summary>
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                Console.WriteLine("button.Content value. Expected=StyleValue. Got=" + button.Content);
