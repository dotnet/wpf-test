...
namespace Microsoft.Test.Xaml.Parser.Verifiers.IPVT
{
    ...
    /// \src\wpf\Test\XAML\FeatureTests\Data\Parser\IPVT\IPVT_TC.xaml
    /// </summary>
    public static class IPVT_TC_Verify
    {
        /// <summary>
        /// This method verifies that IPVT returns the right instance and type when used in a TypeConverter
        /// </summary>
