...
namespace Microsoft.Test.Baml.Utilities
{
    ...
    public class BamlDisassembler
    {
        ...
        public BamlDisassembler(BamlBinaryReader binaryReader, TextWriter textWriter, BamlDisassemblerSettings settings)
        {
        ...
        private string ReadString(string label, out TextLineSections[] textList)
        {
            ...
            {
                var textListCut = CutIntoLines(pos, bytes, val, label);
        ...
        private void OutputTextLine(TextLineSections text)
        {
            ...
            {
                _writer.WriteLine(outputLine + text.meaningStr);
            }
        }
