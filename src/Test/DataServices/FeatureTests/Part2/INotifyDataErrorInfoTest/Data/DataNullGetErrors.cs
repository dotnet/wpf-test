...
namespace Microsoft.Test.DataServices
{
    ...
    /// INotifyDataErrorInfo.GetErrors always returns null.
    /// </summary>
    public class DataNullErrors : INotifyDataErrorInfoObject<object>
    {
        #region Constructors

        public DataNullErrors(bool async)
            : base(async)
        {
            GetErrorsAlwaysNull = true;
        }
