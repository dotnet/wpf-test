...
namespace Microsoft.Test.DataServices
{
    ...
    [Test(2, "DataSources", "bookDataSrcTest")]
    public class bookDataSrcTest : XamlTest
    {
        ...
        public bookDataSrcTest() : base(@"Blank.xaml")
        {
        ...
        private TestResult InitialVerify()
        {
            ...
            result = CheckValues(true, "System.Collections.ObjectModel.ObservableCollection`1[Microsoft.Test.DataServices.BookSource]", "", "Initial Values");
        ...
        private TestResult MidVerify()
        {
            ...
            result = CheckValues(true, "System.Collections.ObjectModel.ObservableCollection`1[Microsoft.Test.DataServices.BookSource]", "Microsoft C# Language Specifications", "Mid Values");
