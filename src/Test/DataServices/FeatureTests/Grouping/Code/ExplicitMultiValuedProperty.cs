...
namespace Microsoft.Test.DataServices
{
    ...
    /// The main difference between this scenario and Scenario 6 (Categorize flat data imlpicitly by property value)
    /// is that here I listed some of the groups returned from the converter in the GroupNames property of
    /// PropertyGroupDescription. This allows control of Group order - the listed groups appear first.
    /// This test case covers both CLR object and XmlDataProvider.
    /// </description>
    /// </summary>
    [Test(2, "Grouping", "ExplicitMultiValuedProperty")]
    public class ExplicitMultiValuedProperty : XamlTest
    {
        ...
        public ExplicitMultiValuedProperty()
            : base(@"ExplicitMultiValuedProperty.xaml")
        {
        ...
        {
            ExpectedGroup group0 = new ExpectedGroup(BeenThere.NeverBeenThere, new object[] { list[4], list[7], list[8], list[9], list[14], list[15] });
            ExpectedGroup group1 = new ExpectedGroup(BeenThere.BeenThereIn2000s, new object[] { list[1], list[5], list[10] });
            ExpectedGroup group2 = new ExpectedGroup(BeenThere.BeenThereIn1990s, new object[] { list[1], list[10] });
            ExpectedGroup group3 = new ExpectedGroup(BeenThere.BeenThereIn1980s, new object[] { list[0], list[5], list[10] });
            ExpectedGroup group4 = new ExpectedGroup(null, new object[] { list[2], list[11] });
            ExpectedGroup group5 = new ExpectedGroup("San Marino", new object[] { list[3] });
        ...
        {
            ExpectedGroup group1 = new ExpectedGroup(BeenThere.BeenThereIn2000s, new object[] { list[1], list[5], list[10], list[16] });
            ExpectedGroup group2 = new ExpectedGroup(BeenThere.BeenThereIn1990s, new object[] { list[1], list[10], list[16] });
            ExpectedGroup group3 = new ExpectedGroup(BeenThere.BeenThereIn1980s, new object[] { list[0], list[5], list[10], list[16] });

            _expectedGroups[1] = group1;
            _expectedGroups[2] = group2;
            _expectedGroups[3] = group3;
